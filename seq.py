...
class SequentialPartition0(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_2, Linear), f'layers[Sequential/Linear[2]] is expected to be of type Linear but was of type {type(self.l_2)}'
    ...
    def forward(self, x0=None):
        ...
        if any(x is None for x in [x0]):
            assert all(x is None for x in [
                       x0]), 'all inputs must be given or none at all'
        if x0 is None:
            return None
...
class SequentialPartition1(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_0, Linear), f'layers[Sequential/Linear[3]] is expected to be of type Linear but was of type {type(self.l_0)}'
        # Sequential/Linear[4]
        ...
        assert isinstance(
            self.l_1, Linear), f'layers[Sequential/Linear[4]] is expected to be of type Linear but was of type {type(self.l_1)}'
...
class SequentialPartition3(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_0, Linear), f'layers[Sequential/Linear[7]] is expected to be of type Linear but was of type {type(self.l_0)}'
        # Sequential/Linear[8]
        ...
        assert isinstance(
            self.l_1, Linear), f'layers[Sequential/Linear[8]] is expected to be of type Linear but was of type {type(self.l_1)}'
        # Sequential/Linear[9]
        ...
        assert isinstance(
            self.l_2, Linear), f'layers[Sequential/Linear[9]] is expected to be of type Linear but was of type {type(self.l_2)}'
        ...
        assert all(isinstance(v, Tensor)
                   for v in parameters.values()), 'Tensor values are expected'
        self.lookup = lookup = {'l_0': '7', 'l_1': '8', 'l_2': '9'}
