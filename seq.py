...
def SequentialPipeline(model:nn.Module,output_device=None,DEBUG=False):
    ...
    layer_scopes = ['Sequential/Linear[3]',
        'Sequential/Linear[4]']
    buffer_scopes = []
    parameter_scopes = []
    layers = {l: layer_dict[l] for l in layer_scopes}
    ...
    layer_scopes = ['Sequential/Linear[7]',
        'Sequential/Linear[8]',
        'Sequential/Linear[9]']
    buffer_scopes = []
    parameter_scopes = []
    ...
    config = {0: {'inputs': OrderedSet(['input0']), 'outputs': OrderedSet(['Sequential/Linear[2]'])},
            1: {'inputs': OrderedSet(['Sequential/Linear[2]']), 'outputs': OrderedSet(['Sequential/Linear[4]'])},
            2: {'inputs': OrderedSet(['Sequential/Linear[4]']), 'outputs': OrderedSet(['Sequential/Linear[6]'])},
            3: {'inputs': OrderedSet(['Sequential/Linear[6]']), 'outputs': OrderedSet(['Sequential/Linear[9]'])}
            }
...
class SequentialPartition0(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(self.l_0,Linear) ,f'layers[Sequential/Linear[0]] is expected to be of type Linear but was of type {type(self.l_0)}'
        # Sequential/Linear[1]
        ...
        assert isinstance(self.l_1,Linear) ,f'layers[Sequential/Linear[1]] is expected to be of type Linear but was of type {type(self.l_1)}'
        # Sequential/Linear[2]
        assert 'Sequential/Linear[2]' in layers, 'layer Sequential/Linear[2] was expected but not given'
        self.l_2 = layers['Sequential/Linear[2]']
        assert isinstance(self.l_2,Linear) ,f'layers[Sequential/Linear[2]] is expected to be of type Linear but was of type {type(self.l_2)}'
...
class SequentialPartition1(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        self.l_0 = layers['Sequential/Linear[3]']
        assert isinstance(self.l_0,Linear) ,f'layers[Sequential/Linear[3]] is expected to be of type Linear but was of type {type(self.l_0)}'
        # Sequential/Linear[4]
        assert 'Sequential/Linear[4]' in layers, 'layer Sequential/Linear[4] was expected but not given'
        self.l_1 = layers['Sequential/Linear[4]']
        assert isinstance(self.l_1,Linear) ,f'layers[Sequential/Linear[4]] is expected to be of type Linear but was of type {type(self.l_1)}'
    ...
    def forward(self, x0 = None):
        # Sequential/Linear[3] <=> self.l_0
        # Sequential/Linear[4] <=> self.l_1
        # Sequential/Linear[2] <=> x0
...
class SequentialPartition2(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(self.l_0,Linear) ,f'layers[Sequential/Linear[5]] is expected to be of type Linear but was of type {type(self.l_0)}'
        # Sequential/Linear[6]
        ...
        assert isinstance(self.l_1,Linear) ,f'layers[Sequential/Linear[6]] is expected to be of type Linear but was of type {type(self.l_1)}'
...
class SequentialPartition3(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        self.l_0 = layers['Sequential/Linear[7]']
        assert isinstance(self.l_0,Linear) ,f'layers[Sequential/Linear[7]] is expected to be of type Linear but was of type {type(self.l_0)}'
        # Sequential/Linear[8]
        assert 'Sequential/Linear[8]' in layers, 'layer Sequential/Linear[8] was expected but not given'
        self.l_1 = layers['Sequential/Linear[8]']
        assert isinstance(self.l_1,Linear) ,f'layers[Sequential/Linear[8]] is expected to be of type Linear but was of type {type(self.l_1)}'
        # Sequential/Linear[9]
        assert 'Sequential/Linear[9]' in layers, 'layer Sequential/Linear[9] was expected but not given'
        self.l_2 = layers['Sequential/Linear[9]']
        assert isinstance(self.l_2,Linear) ,f'layers[Sequential/Linear[9]] is expected to be of type Linear but was of type {type(self.l_2)}'
    ...
    def forward(self, x0 = None):
        # Sequential/Linear[7] <=> self.l_0
        # Sequential/Linear[8] <=> self.l_1
        # Sequential/Linear[9] <=> self.l_2
        # Sequential/Linear[6] <=> x0
