...
class InceptionPartition0(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_0, Conv2d), f'layers[Inception/Sequential[b1]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        # Inception/Sequential[b3]/Conv2d[0]
        ...
        assert isinstance(
            self.l_1, Conv2d), f'layers[Inception/Sequential[b3]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_1)}'
        # Inception/Sequential[b3]/ReLU[1]
        ...
        assert isinstance(
            self.l_2, ReLU), f'layers[Inception/Sequential[b3]/ReLU[1]] is expected to be of type ReLU but was of type {type(self.l_2)}'
        # Inception/Sequential[b3]/Conv2d[2]
        ...
        assert isinstance(
            self.l_3, Conv2d), f'layers[Inception/Sequential[b3]/Conv2d[2]] is expected to be of type Conv2d but was of type {type(self.l_3)}'
...
class InceptionPartition1(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_0, Conv2d), f'layers[Inception/Sequential[b2]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        # Inception/Sequential[b2]/ReLU[1]
        ...
        assert isinstance(
            self.l_1, ReLU), f'layers[Inception/Sequential[b2]/ReLU[1]] is expected to be of type ReLU but was of type {type(self.l_1)}'
...
class InceptionPartition2(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_0, ReLU), f'layers[Inception/Sequential[b1]/ReLU[1]] is expected to be of type ReLU but was of type {type(self.l_0)}'
        # Inception/Sequential[b2]/ReLU[3]
        ...
        assert isinstance(
            self.l_1, ReLU), f'layers[Inception/Sequential[b2]/ReLU[3]] is expected to be of type ReLU but was of type {type(self.l_1)}'
        # Inception/Sequential[b3]/ReLU[3]
        ...
        assert isinstance(
            self.l_2, ReLU), f'layers[Inception/Sequential[b3]/ReLU[3]] is expected to be of type ReLU but was of type {type(self.l_2)}'
        # Inception/Sequential[b3]/Conv2d[4]
        ...
        assert isinstance(
            self.l_3, Conv2d), f'layers[Inception/Sequential[b3]/Conv2d[4]] is expected to be of type Conv2d but was of type {type(self.l_3)}'
        # Inception/Sequential[b3]/ReLU[5]
        ...
        assert isinstance(
            self.l_4, ReLU), f'layers[Inception/Sequential[b3]/ReLU[5]] is expected to be of type ReLU but was of type {type(self.l_4)}'
        # Inception/Sequential[b4]/MaxPool2d[0]
        ...
        assert isinstance(
            self.l_5, MaxPool2d), f'layers[Inception/Sequential[b4]/MaxPool2d[0]] is expected to be of type MaxPool2d but was of type {type(self.l_5)}'
        # Inception/Sequential[b4]/Conv2d[1]
        ...
        assert isinstance(
            self.l_6, Conv2d), f'layers[Inception/Sequential[b4]/Conv2d[1]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        # Inception/Sequential[b4]/ReLU[2]
        ...
        assert isinstance(
            self.l_7, ReLU), f'layers[Inception/Sequential[b4]/ReLU[2]] is expected to be of type ReLU but was of type {type(self.l_7)}'
        ...
        assert all(isinstance(v, Tensor)
                   for v in parameters.values()), 'Tensor values are expected'
        self.lookup = {'l_0': 'b1.1', 'l_1': 'b2.3', 'l_2': 'b3.3', 'l_3': 'b3.4',
                       'l_4': 'b3.5', 'l_5': 'b4.0', 'l_6': 'b4.1', 'l_7': 'b4.2'}
...
class InceptionPartition3(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(
            self.l_0, Conv2d), f'layers[Inception/Sequential[b2]/Conv2d[2]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
