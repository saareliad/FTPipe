...
# partition 6 {'inputs': {0, 5, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {7}}
# partition 7 {'inputs': {'lm_labels', 6, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=1):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (StatelessEmbedding,CrossEntropyLoss,Dropout,T5LayerNorm,Linear,T5Block),
        'model_inputs': {
            'attention_mask': {
...
forward {0: 32.93, 1: 26.92, 2: 26.99, 3: 27.01, 4: 27.04, 5: 26.97, 6: 27.44, 7: 31.33}
backward {0: 71.47, 1: 69.45, 2: 69.5, 3: 69.42, 4: 69.48, 5: 69.68, 6: 69.72, 7: 38.43}
...
6: input size:'2.17 MB', recieve_time:'0.18 ms', out:'3.24 MB', send time:'0.27 ms'
7: input size:'3.25 MB', recieve_time:'0.27 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.91, 1: 0.99, 2: 0.99, 3: 0.99, 4: 0.99, 5: 0.99, 6: 0.99, 7: 1.0} 
backward {0: 1.0, 1: 0.96, 2: 0.96, 3: 0.96, 4: 0.96, 5: 0.96, 6: 1.0, 7: 0.99}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 101.42,
                      ...
                      7: 69.49,
                      'worstcase': 101.42},
 'pipeline_vs_seq_no_comm': 5.64,
 'pipeline_with_non_parallel_comm': {0: 104.39,
                                     1: 96.37,
                                     2: 96.49,
                                     3: 96.44,
                                     4: 96.51,
...
forward {0: 0.91, 1: 0.81, 2: 0.81, 3: 0.81, 4: 0.81, 5: 0.81, 6: 0.82, 7: 0.95}
backward {0: 1.0, 1: 0.93, 2: 0.93, 3: 0.93, 4: 0.93, 5: 0.94, 6: 0.98, 7: 0.54}

worstcase: bwd: 71.468 fwd: 32.925
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.482
