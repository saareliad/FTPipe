...
from .parse_declarations import parse_functions, FunctionTypes
...
# TODO better support for positional and keyword arguments
# right now we do it by hand which is not scalable at all
