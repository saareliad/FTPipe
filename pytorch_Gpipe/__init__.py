...
def pipe_model(model: nn.Module, microbatch_size: int, sample_batch: Tensors, devices: Optional[Devices] = None, by_memory: bool = False, depth: int = 100, optimize_pipeline_wrappers: bool = True) -> nn.Module:
