...
class AmoebaNet(nn.Module):
    ...
    def forward(self, x):
        ...
        i = 0
        for cell_num in range(self.hparams.num_cells):
            stride = 1
...
class imagenet_stem(nn.Module):
    def __init__(self, inputs, hparams, stem_cell_factory: au.BaseCell, filter_scaling_rate):
        super().__init__()
