import experiments.amoebaNet as an
import torch
...
class hparams(object):
    def __init__(self):
        ...
        self.reduction_cell_hiddenstate_indices = [1, 0, 0, 2, 1, 0, 4, 0, 1, 0]
...
if __name__ == '__main__':
    ...
    hp = hparams()
    num_classes = 1001
    ann = an.AmoebaNet(inputs=x, num_classes=num_classes, is_training=True, hparams=hp)
    #ann(x)
