...
from pytorch_Gpipe import default_pipe, pipe_model
...
def train_with_stats_saved(model, input_device='cpu'):
    ...
    train_loader = DataLoader(fake_data, batch_size=batch_size, shuffle=True, num_workers=2)
...
def test(model, input_device='cpu'):
    ...
    test_loader = DataLoader(fake_data, batch_size=batch_size, shuffle=False, num_workers=2)
