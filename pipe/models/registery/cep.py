...
CEPModelHandler(
    normal_model_fn=functools.partial(register_cep_model, n=50, c=500, n_split=4)).register_autogenerated(
    generated_file_name_or_path="cep_netN50_C500_4p_bw12_metis")

CEPModelHandler(
    normal_model_fn=functools.partial(register_cep_model, n=50, c=20000, n_split=4)).register_autogenerated(
