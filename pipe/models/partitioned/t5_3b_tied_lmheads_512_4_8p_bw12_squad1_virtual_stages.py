"""AutoGenerated with:
python partition.py t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 512 --answer_max_seq_length 4 --basic_blocks T5Block --partitioning_method 2DBIN --n_clusters 2 --save_memory_mode --disable_op_profiling
"""
import torch
