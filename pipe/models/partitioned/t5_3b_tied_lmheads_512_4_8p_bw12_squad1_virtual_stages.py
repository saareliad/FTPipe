"""AutoGenerated with:
python partitioning_script.py t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 512 --answer_max_seq_length 4 --basic_blocks T5Block --partitioning_method 2DBIN --n_clusters 2 --save_memory_mode --disable_op_profiling
"""
import torch
...
# partition 0 {'inputs': {'attention_mask', 'input_ids'}, 'outputs': {1, 2, 3, 4, 5, 6, 7, 9}}
...
# partition 9 {'inputs': {0, 'inverted_encoder_attention_mask', 8, 'decoder_attention_mask', 'decoder_input_ids'}, 'outputs': {10, 11, 12, 13, 14, 15}}
# partition 10 {'inputs': {8, 9, 'inverted_encoder_attention_mask', 'decoder_attention_mask'}, 'outputs': {11}}
# partition 11 {'inputs': {'inverted_encoder_attention_mask', 8, 9, 10, 'decoder_attention_mask'}, 'outputs': {12}}
# partition 12 {'inputs': {'inverted_encoder_attention_mask', 8, 9, 11, 'decoder_attention_mask'}, 'outputs': {13}}
# partition 13 {'inputs': {'inverted_encoder_attention_mask', 8, 9, 12, 'decoder_attention_mask'}, 'outputs': {14}}
# partition 14 {'inputs': {'inverted_encoder_attention_mask', 8, 9, 13, 'decoder_attention_mask'}, 'outputs': {15}}
# partition 15 {'inputs': {'inverted_encoder_attention_mask', 8, 9, 'decoder_attention_mask', 14, 'lm_labels'}, 'outputs': {'output'}}
# model outputs {15}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (T5LayerNorm,CrossEntropyLoss,T5Block,Dropout,StatelessEmbedding,Linear),
        'model_inputs': {
            'attention_mask': {
...
unique_stages_on_same_gpu: [{7, 15}, {0, 8}, {1, 14}, {2, 12}, {11, 3}, {4, 13}, {10, 5}, {9, 6}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 0, 6, 5, 3, 2, 4, 1, 7],
...
forward {0: 101.64, 1: 102.95, 2: 102.98, 3: 103.07, 4: 103.08, 5: 103.02, 6: 94.81, 7: 83.51}
backward {0: 205.2, 1: 257.41, 2: 257.41, 3: 257.57, 4: 257.66, 5: 257.74, 6: 247.22, 7: 230.86}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'8.41 MB', recieve_time:'0.70 ms', out:'282.48 MB', send time:'23.54 ms'
1: input size:'152.13 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
2: input size:'152.13 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
3: input size:'152.13 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
4: input size:'152.13 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
5: input size:'152.13 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
6: input size:'282.49 MB', recieve_time:'23.54 ms', out:'152.12 MB', send time:'12.68 ms'
7: input size:'152.13 MB', recieve_time:'12.68 ms', out:'8.39 MB', send time:'0.70 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.77, 1: 0.88, 2: 0.88, 3: 0.88, 4: 0.88, 5: 0.88, 6: 0.87, 7: 0.99} 
backward {0: 1.0, 1: 0.95, 2: 0.95, 3: 0.95, 4: 0.95, 5: 0.95, 6: 0.9, 7: 0.95}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 306.84,
                                     1: 360.36,
                                     2: 360.39,
                                     3: 360.64,
                                     4: 360.74,
                                     ...
                                     7: 314.37,
                                     'worstcase': 360.76},
 'seq_no_comm_no_recomp': {0: 204.76,
                           1: 200.2,
                           2: 200.47,
                           3: 200.61,
                           4: 200.39,
...
forward {0: 0.76, 1: 0.88, 2: 0.88, 3: 0.88, 4: 0.88, 5: 0.88, 6: 0.8, 7: 0.8}
backward {0: 0.8, 1: 0.95, 2: 0.95, 3: 0.95, 4: 0.95, 5: 0.95, 6: 0.87, 7: 0.85}

worstcase: bwd: 257.735 fwd: 103.077
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.212
Expected speedup for 8 partitions is: 7.102
max cuda memory used 4.15GB
"""
