"""AutoGenerated with:
python partition.py t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 512 --answer_max_seq_length 4 --basic_blocks T5Block --save_memory_mode --partitioning_method ACYCLIC --constraint memory --objective stage_time --multilevel
"""
import math
...
# partition 1 {'inputs': {0, 'attention_mask'}, 'outputs': {2, 3}}
# partition 2 {'inputs': {0, 1, 'attention_mask'}, 'outputs': {3}}
# partition 3 {'inputs': {0, 1, 2, 'decoder_attention_mask', 'inverted_encoder_attention_mask', 'attention_mask'}, 'outputs': {4, 5, 6, 7}}
# partition 4 {'inputs': {'decoder_attention_mask', 'inverted_encoder_attention_mask', 3}, 'outputs': {5}}
# partition 5 {'inputs': {'decoder_attention_mask', 'inverted_encoder_attention_mask', 3, 4}, 'outputs': {6}}
# partition 6 {'inputs': {'decoder_attention_mask', 'inverted_encoder_attention_mask', 3, 5}, 'outputs': {7}}
# partition 7 {'inputs': {3, 'lm_labels', 6, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
forward {0: 191.77, 1: 186.57, 2: 186.75, 3: 91.32, 4: 21.1, 5: 21.09, 6: 21.07, 7: 20.66}
backward {0: 466.12, 1: 470.27, 2: 469.91, 3: 254.23, 4: 56.24, 5: 56.82, 6: 56.58, 7: 57.44}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.02 MB', recieve_time:'0.00 ms', out:'142.67 MB', send time:'11.89 ms'
1: input size:'142.68 MB', recieve_time:'11.89 ms', out:'142.67 MB', send time:'11.89 ms'
2: input size:'142.61 MB', recieve_time:'11.88 ms', out:'142.61 MB', send time:'11.88 ms'
3: input size:'142.69 MB', recieve_time:'11.89 ms', out:'9.51 MB', send time:'0.79 ms'
4: input size:'9.52 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
5: input size:'9.52 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
6: input size:'9.52 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
7: input size:'9.52 MB', recieve_time:'0.79 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.94, 1: 0.94, 2: 0.94, 3: 0.99, 4: 0.96, 5: 0.96, 6: 0.96, 7: 1.0} 
backward {0: 1.0, 1: 0.97, 2: 0.97, 3: 0.95, 4: 0.99, 5: 0.99, 6: 0.99, 7: 0.99}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 646.0,
                      ...
                      7: 77.31,
                      'worstcase': 646.0},
 'pipeline_vs_seq_no_comm': 2.91,
 'pipeline_with_non_parallel_comm': {0: 657.89,
                                     1: 656.83,
                                     2: 656.66,
                                     3: 345.55,
                                     4: 77.34,
                                     ...
                                     7: 78.11,
                                     'worstcase': 657.89},
 'seq_no_comm_no_recomp': {0: 474.04,
                           1: 462.52,
                           2: 462.0,
                           3: 244.66,
                           4: 59.18,
...
forward {0: 0.94, 1: 0.91, 2: 0.91, 3: 0.48, 4: 0.11, 5: 0.11, 6: 0.11, 7: 0.11}
backward {0: 0.99, 1: 0.97, 2: 0.97, 3: 0.51, 4: 0.12, 5: 0.12, 6: 0.12, 7: 0.12}

worstcase: bwd: 470.269 fwd: 191.770
expected_speedup_compared_to_seq_no_recomp_no_comm: 2.841
Expected speedup for 8 partitions is: 3.848
max cuda memory used 8.66GB
"""