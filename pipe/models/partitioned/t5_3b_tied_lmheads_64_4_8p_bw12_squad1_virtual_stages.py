"""AutoGenerated with:
python partition.py t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 32 --partitioning_batch_size 32 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 64 --answer_max_seq_length 4 --basic_blocks T5Block --partitioning_method 2DBIN --n_clusters 2 --save_memory_mode --disable_op_profiling
"""
import math
import torch
...
# partition 4 {'inputs': {3, 1, 'attention_mask'}, 'outputs': {5}}
...
# partition 9 {'inputs': {0, 8, 'decoder_input_ids', 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {10, 11, 12, 13, 14, 15}}
# partition 10 {'inputs': {8, 9, 'inverted_encoder_attention_mask', 'decoder_attention_mask'}, 'outputs': {11}}
# partition 11 {'inputs': {8, 9, 10, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {12}}
# partition 12 {'inputs': {8, 9, 11, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {13}}
# partition 13 {'inputs': {8, 9, 12, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {14}}
# partition 14 {'inputs': {8, 9, 13, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {15}}
# partition 15 {'inputs': {'lm_labels', 8, 9, 14, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {15}
...
def create_pipeline_configuration(DEBUG=False, batch_size=32):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (CrossEntropyLoss,Linear,Dropout,T5LayerNorm,T5Block,StatelessEmbedding),
        'model_inputs': {
            'attention_mask': {
...
unique_stages_on_same_gpu: [{6, 15}, {0, 8}, {1, 11}, {2, 14}, {3, 12}, {4, 13}, {10, 5}, {9, 7}]
...
forward {0: 69.51, 1: 80.65, 2: 79.88, 3: 80.0, 4: 80.1, 5: 80.13, 6: 70.15, 7: 69.85}
backward {0: 171.93, 1: 226.89, 2: 227.5, 3: 227.65, 4: 227.57, 5: 227.73, 6: 199.24, 7: 208.6}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'25.19 MB', recieve_time:'2.10 ms', out:'148.26 MB', send time:'12.35 ms'
1: input size:'18.43 MB', recieve_time:'1.54 ms', out:'35.19 MB', send time:'2.93 ms'
2: input size:'35.21 MB', recieve_time:'2.93 ms', out:'35.19 MB', send time:'2.93 ms'
3: input size:'35.21 MB', recieve_time:'2.93 ms', out:'35.19 MB', send time:'2.93 ms'
4: input size:'35.21 MB', recieve_time:'2.93 ms', out:'35.19 MB', send time:'2.93 ms'
5: input size:'35.21 MB', recieve_time:'2.93 ms', out:'35.19 MB', send time:'2.93 ms'
6: input size:'35.21 MB', recieve_time:'2.93 ms', out:'25.17 MB', send time:'2.10 ms'
7: input size:'165.06 MB', recieve_time:'13.75 ms', out:'35.19 MB', send time:'2.93 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.82, 1: 0.96, 2: 0.96, 3: 0.96, 4: 0.96, 5: 0.96, 6: 0.97, 7: 0.96} 
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 241.45,
                                     1: 307.54,
                                     2: 307.38,
                                     3: 307.64,
                                     4: 307.66,
...
forward {0: 0.71, 1: 0.96, 2: 0.95, 3: 0.95, 4: 0.95, 5: 0.95, 6: 0.84, 7: 0.83}
backward {0: 0.74, 1: 0.99, 2: 0.99, 3: 0.99, 4: 0.99, 5: 0.99, 6: 0.86, 7: 0.86}

worstcase: bwd: 227.732 fwd: 80.647
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.551
Expected speedup for 8 partitions is: 7.338
max cuda memory used 2.50GB
"""