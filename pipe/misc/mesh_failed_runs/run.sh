t5_mesh_transformer  \
  --model_dir="t5_3b_recompute_fp32" \
  ...
  --gin_param="serialize_num_microbatches.tokens_per_microbatch_per_replica = 320" \
  --gin_param="encoder/LayerStack.recompute_grads = True" \
  --gin_param="decoder/LayerStack.recompute_grads = True" \
...
#  --gin_param="get_variable_dtype.slice_dtype = 'float33'" \
