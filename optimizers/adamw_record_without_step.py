...
# NOTE: copy of https://raw.githubusercontent.com/pytorch/pytorch/v1.4.0/torch/optim/adamw.py
# Modified to record average step size.
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                state['exp_step_avg_sq'].mul_(beta2).addcmul_(
                    (1 - beta2), denom, denom)  # TODO: handle step size and bias correction in gap aware
