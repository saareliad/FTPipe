"""AutoGenerated with:
python partitioning_script.py --partitioning_task t5 --t5_task squad1 --lmhead --n_iter 10 --n_partitions 8 --analysis_batch_size 8 --partitioning_batch_size 8 --precompute_masks --stateless_tied --model_name_or_path t5-3b --save_memory_mode --max_seq_length 320 --answer_max_seq_length 8 --basic_blocks T5Block --constraint memory --objective stage_time --profiles_cache_name t5_3b_cache
"""
import math
...
# partition 3 {'inputs': {0, 2, 'decoder_attention_mask', 'attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {4, 5, 6, 7}}
...
# partition 7 {'inputs': {3, 'decoder_attention_mask', 6, 'lm_labels', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=8):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (T5Block,Linear,CrossEntropyLoss,StatelessEmbedding,T5LayerNorm,Dropout),
        'model_inputs': {
            'attention_mask': {
...
forward {0: 208.44, 1: 204.17, 2: 204.27, 3: 104.72, 4: 27.05, 5: 27.0, 6: 27.13, 7: 26.43}
backward {0: 536.31, 1: 543.48, 2: 543.68, 3: 296.92, 4: 75.18, 5: 75.38, 6: 75.27, 7: 76.72}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.03 MB', recieve_time:'0.00 ms', out:'115.61 MB', send time:'9.63 ms'
1: input size:'115.35 MB', recieve_time:'9.61 ms', out:'115.34 MB', send time:'9.61 ms'
2: input size:'115.62 MB', recieve_time:'9.63 ms', out:'115.61 MB', send time:'9.63 ms'
3: input size:'115.63 MB', recieve_time:'9.64 ms', out:'13.43 MB', send time:'1.12 ms'
4: input size:'13.45 MB', recieve_time:'1.12 ms', out:'13.43 MB', send time:'1.12 ms'
5: input size:'13.45 MB', recieve_time:'1.12 ms', out:'13.43 MB', send time:'1.12 ms'
6: input size:'13.45 MB', recieve_time:'1.12 ms', out:'13.43 MB', send time:'1.12 ms'
7: input size:'13.45 MB', recieve_time:'1.12 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.95, 1: 0.95, 2: 0.95, 3: 0.99, 4: 0.96, 5: 0.96, 6: 0.96, 7: 1.0} 
backward {0: 1.0, 1: 0.98, 2: 0.98, 3: 0.97, 4: 0.99, 5: 0.99, 6: 0.99, 7: 0.99}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 735.12,
                      ...
                      7: 102.04,
                      'worstcase': 735.12},
 'pipeline_vs_seq_no_comm': 3.02,
 'pipeline_with_non_parallel_comm': {0: 744.75,
                                     1: 747.65,
                                     2: 747.95,
                                     3: 401.64,
                                     4: 102.23,
                                     ...
                                     7: 103.16,
                                     'worstcase': 747.95},
 'seq_no_comm_no_recomp': {0: 545.09,
                           1: 539.72,
                           2: 539.57,
                           3: 289.56,
                           4: 76.2,
...
forward {0: 0.95, 1: 0.93, 2: 0.93, 3: 0.49, 4: 0.12, 5: 0.12, 6: 0.12, 7: 0.13}
backward {0: 0.99, 1: 0.98, 2: 0.98, 3: 0.53, 4: 0.14, 5: 0.14, 6: 0.14, 7: 0.14}

worstcase: bwd: 543.679 fwd: 208.441
expected_speedup_compared_to_seq_no_recomp_no_comm: 2.951
Expected speedup for 8 partitions is: 3.967
max cuda memory used 8.83GB
"""