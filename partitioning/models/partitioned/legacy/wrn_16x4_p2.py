...
def createConfig(model,DEBUG=False,partitions_only=False):
    ...
    config = {0: {'inputs': ['input0'], 'outputs': ['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/aten::add301']},
            1: {'inputs': ['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/aten::add301'], 'outputs': ['WideResNet/Linear[fc]']}
            }
...
class WideResNetPartition0(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        assert isinstance(self.l_10,Conv2d) ,f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]
        ...
        assert isinstance(self.l_11,BatchNorm2d) ,f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]
        ...
        assert isinstance(self.l_12,ReLU) ,f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_12)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]
        ...
        assert isinstance(self.l_13,Conv2d) ,f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_13)}'
    ...
    def forward(self, x0):
        ...
        return (torch.add(input=t_1, other=self.l_13(self.l_12(self.l_11(self.l_10(self.l_9(self.l_8(t_1))))))),)
...
class WideResNetPartition1(nn.Module):
    def __init__(self, layers, buffers, parameters):
        ...
        self.l_12 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]']
        assert isinstance(self.l_12,Conv2d) ,f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_12)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]
        ...
        self.l_13 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]']
        assert isinstance(self.l_13,BatchNorm2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_13)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]
        ...
        self.l_14 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]']
        assert isinstance(self.l_14,ReLU) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_14)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]
        ...
        self.l_15 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]']
        assert isinstance(self.l_15,Conv2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_15)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]
        ...
        self.l_16 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]']
        assert isinstance(self.l_16,BatchNorm2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_16)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]
        ...
        self.l_17 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]']
        assert isinstance(self.l_17,ReLU) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_17)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]
        ...
        self.l_18 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]']
        assert isinstance(self.l_18,Conv2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_18)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        ...
        self.l_19 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]']
        assert isinstance(self.l_19,Conv2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]] is expected to be of type Conv2d but was of type {type(self.l_19)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]
        ...
        self.l_20 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]']
        assert isinstance(self.l_20,BatchNorm2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_20)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]
        ...
        self.l_21 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]']
        assert isinstance(self.l_21,ReLU) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_21)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]
        ...
        self.l_22 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]']
        assert isinstance(self.l_22,Conv2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_22)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]
        ...
        self.l_23 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]']
        assert isinstance(self.l_23,BatchNorm2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_23)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]
        ...
        self.l_24 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]']
        assert isinstance(self.l_24,ReLU) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_24)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]
        ...
        self.l_25 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]']
        assert isinstance(self.l_25,Conv2d) ,f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_25)}'
        # WideResNet/BatchNorm2d[bn1]
        ...
        assert isinstance(self.l_26,BatchNorm2d) ,f'layers[WideResNet/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_26)}'
        # WideResNet/ReLU[relu]
        ...
        assert isinstance(self.l_27,ReLU) ,f'layers[WideResNet/ReLU[relu]] is expected to be of type ReLU but was of type {type(self.l_27)}'
        # WideResNet/AvgPool2d[avg_pool]
        ...
        assert isinstance(self.l_28,AvgPool2d) ,f'layers[WideResNet/AvgPool2d[avg_pool]] is expected to be of type AvgPool2d but was of type {type(self.l_28)}'
        # WideResNet/Linear[fc]
        ...
        assert isinstance(self.l_29,Linear) ,f'layers[WideResNet/Linear[fc]] is expected to be of type Linear but was of type {type(self.l_29)}'
    ...
    def forward(self, x0):
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]
        t_2 = self.l_14(self.l_13(torch.add(input=t_1, other=self.l_12(self.l_11(self.l_10(self.l_9(self.l_8(self.l_7(t_1)))))))))
        # calling torch.add with arguments:
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]
        t_3 = torch.add(input=self.l_19(t_2), other=self.l_18(self.l_17(self.l_16(self.l_15(t_2)))))
        # calling WideResNet/AvgPool2d[avg_pool] with arguments:
        # WideResNet/ReLU[relu]
        t_4 = self.l_28(self.l_27(self.l_26(torch.add(input=t_3, other=self.l_25(self.l_24(self.l_23(self.l_22(self.l_21(self.l_20(t_3))))))))))
        # returing:
        # WideResNet/Linear[fc]
