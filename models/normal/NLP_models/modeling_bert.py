...
from transformers.configuration_bert import BertConfig,PretrainedConfig
from transformers.file_utils import add_start_docstrings,is_remote_url,hf_bucket_url
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if from_tf:
            ...
            for key in state_dict.keys():
                ...
                # translating state dict to omit original moduleList
                if '.layer.' in new_key:	
                    new_key = new_key.replace('.layer.', '.')	
