"""AutoGenerated with:
python partitioning_script.py --partitioning_task t5 --bwd_to_fwd_ratio 1 --t5_task squad1 --lmhead --n_iter 20 --n_partitions 8 --analysis_batch_size 8 --partitioning_batch_size 8 --async_pipeline --multilevel --precompute_masks --stateless_tied --model_name_or_path t5-large --save_memory_mode --objective stage_time --basic_blocks T5Block --rounds 20 --allocated_seconds 30
"""
import torch
...
# partition 6 {'inputs': {'attention_mask', 0, 5, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {7}}
# partition 7 {'inputs': {'lm_labels', 'inverted_encoder_attention_mask', 6, 'decoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=8):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,StatelessEmbedding,T5Block,CrossEntropyLoss,Dropout,T5LayerNorm),
        'model_inputs': {
            'attention_mask': {
            ...
            'decoder_attention_mask': {
                'shape': torch.Size([8, 1, 32, 32]),
                'dtype': torch.float32,
                'is_batched': True,
                'used_by': [6, 7]},
            'decoder_input_ids': {
                'shape': torch.Size([8, 32]),
                'dtype': torch.int64,
                'is_batched': True,
                'used_by': [0]},
            'input_ids': {
...
class Partition1(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[4] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[5] <=> self.l_3
        # input0 <=> attention_mask
...
class Partition2(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[9] <=> self.l_3
        # input0 <=> attention_mask
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___22 <=> x0
...
class Partition3(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[12] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13] <=> self.l_3
        # input0 <=> attention_mask
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___22 <=> x0
...
class Partition5(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21] <=> self.l_3
        # input0 <=> attention_mask
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___22 <=> x0
...
class Partition6(nn.Module):
    ...
    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23] <=> self.l_1
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6] <=> self.l_11
        # input0 <=> attention_mask
        # input1 <=> decoder_attention_mask
        # input4 <=> inverted_encoder_attention_mask
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___22 <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21] <=> x1
...
class Partition7(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[14] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[18] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[19] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[20] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23] <=> self.l_16
        ...
        # T5ForConditionalGeneration/CrossEntropyLoss[lm_loss] <=> self.l_20
        # input1 <=> decoder_attention_mask
        # input4 <=> inverted_encoder_attention_mask
        # input5 <=> lm_labels
        ...
        t_0 = self.l_12(t_0, attention_mask=decoder_attention_mask, position_bias=x1, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x2)
        t_0 = self.l_13(t_0, attention_mask=decoder_attention_mask, position_bias=x1, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x2)
        t_0 = self.l_14(t_0, attention_mask=decoder_attention_mask, position_bias=x1, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x2)
        t_0 = self.l_15(t_0, attention_mask=decoder_attention_mask, position_bias=x1, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x2)
        t_0 = self.l_16(t_0, attention_mask=decoder_attention_mask, position_bias=x1, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x2)
        t_0 = self.l_17(t_0)
        t_0 = self.l_18(t_0)
        t_0 = t_0 * 0.03125
        t_0 = self.l_19(t_0)
...
model_args = {'model_name_or_path': 't5-large', 'max_seq_length': 384, 'answer_max_seq_length': 32, 'stateless_tied': True, 'lmhead': True, 'precompute_masks': True}
"""analysis summary
-I- Printing Report
warnings:
...
forward {0: 34.4, 1: 44.21, 2: 44.11, 3: 44.12, 4: 44.08, 5: 44.29, 6: 38.98, 7: 39.73}
backward {0: 63.47, 1: 118.67, 2: 118.62, 3: 118.58, 4: 118.59, 5: 118.5, 6: 111.84, 7: 79.3}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.04 MB', recieve_time:'0.00 ms', out:'89.13 MB', send time:'7.43 ms'
1: input size:'88.09 MB', recieve_time:'7.34 ms', out:'12.58 MB', send time:'1.05 ms'
2: input size:'88.09 MB', recieve_time:'7.34 ms', out:'12.58 MB', send time:'1.05 ms'
3: input size:'88.09 MB', recieve_time:'7.34 ms', out:'12.58 MB', send time:'1.05 ms'
4: input size:'88.09 MB', recieve_time:'7.34 ms', out:'12.58 MB', send time:'1.05 ms'
5: input size:'88.09 MB', recieve_time:'7.34 ms', out:'12.58 MB', send time:'1.05 ms'
6: input size:'89.19 MB', recieve_time:'7.43 ms', out:'20.45 MB', send time:'1.70 ms'
7: input size:'20.49 MB', recieve_time:'1.71 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.78, 1: 0.98, 2: 0.98, 3: 0.98, 4: 0.98, 5: 0.98, 6: 0.96, 7: 1.0} 
backward {0: 1.0, 1: 0.94, 2: 0.94, 3: 0.94, 4: 0.94, 5: 0.94, 6: 0.93, 7: 0.98}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 90.44,
                      ...
                      7: 117.33,
                      'worstcase': 154.49},
 'pipeline_vs_seq_no_comm': 5.49,
 'pipeline_with_non_parallel_comm': {0: 97.86,
                                     1: 162.88,
                                     2: 162.72,
                                     3: 162.7,
                                     4: 162.67,
...
forward {0: 0.61, 1: 0.98, 2: 0.98, 3: 0.98, 4: 0.98, 5: 0.98, 6: 0.84, 7: 0.9}
backward {0: 0.53, 1: 0.94, 2: 0.94, 3: 0.94, 4: 0.94, 5: 0.94, 6: 0.88, 7: 0.66}

worstcase: bwd: 118.669 fwd: 44.286
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.208
Expected speedup for 8 partitions is: 6.875
max cuda memory used 4.22GB
"""