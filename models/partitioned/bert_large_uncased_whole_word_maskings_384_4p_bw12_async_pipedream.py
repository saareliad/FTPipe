"""AutoGenerated with:
python -m autopipe.partition bert_squad --n_partitions 4 --partitioning_batch_size 12 --analysis_batch_size 12 --n_iter 10 --model_name_or_path bert-large-uncased-whole-word-masking --do_lower_case --train_file /home_local/saareliad/data/squad1/train-v1.1.json --max_seq_length 384 --doc_stride 128 --partitioning_method pipedream --preset ftpipe --precompute_attention_mask --save_memory_mode
"""
...
# partition 3 {'inputs': {'attention_mask', 2}, 'outputs': {'output'}}
# model outputs {3}


def create_pipeline_configuration(DEBUG=False, batch_size=12):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Tanh,LayerNorm,Dropout,Linear,Softmax,Embedding),
        'model_inputs': {
            'attention_mask': {
                'shape': torch.Size([12, 1, 1, 384]),
                'dtype': torch.float32,
                'is_batched': True,
                'used_by': [0, 1, 2, 3]},
            'input_ids': {
                'shape': torch.Size([12, 384]),
                'dtype': torch.int64,
                'is_batched': True,
                'used_by': [0]},
            'token_type_ids': {
            ...
            1: {
                ...
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm]': {
                        ...
                        'is_batched': True,
                        'used_by': [2]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1166': {
                        'shape': torch.Size([12, 16, 384, 64]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [2]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_1170': {
                        'shape': torch.Size([12, 16, 384, 384]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [2]}},
...
class Partition0(nn.Module):
    ...
    def forward(self, *args):
        ...
        t_3 = t_0[2]
        t_0 = t_0[3]
        t_0 = t_2.view(t_9, t_6, t_3, t_0)
        t_0 = t_0.permute(0, 2, 1, 3)
        t_4 = t_4.transpose(-1, -2)
        t_4 = torch.matmul(t_8, t_4)
        t_8 = math.sqrt(64)
        t_8 = t_4 / t_8
        t_8 = t_8 + attention_mask
        t_8 = self.l_68(t_8)
        t_8 = self.l_69(t_8)
...
class Partition1(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:1'):
        ...
        self.lookup = {'l_0': 'bert.encoder.5.intermediate.dense',
                        ...
                        'l_39': 'bert.encoder.8.output.LayerNorm',
                        'l_40': 'bert.encoder.9.attention.self.query',
                        'l_41': 'bert.encoder.9.attention.self.key',
                        'l_42': 'bert.encoder.9.attention.self.value',
                        'l_43': 'bert.encoder.9.attention.self.softmax',
                        'l_44': 'bert.encoder.9.attention.self.dropout',
                        'l_45': 'bert.encoder.9.attention.output.dense',
                        'l_46': 'bert.encoder.9.attention.output.dropout',
                        'l_47': 'bert.encoder.9.attention.output.LayerNorm',
                        'l_48': 'bert.encoder.9.intermediate.dense',
                        'l_49': 'bert.encoder.9.output.dense',
                        'l_50': 'bert.encoder.9.output.dropout',
                        'l_51': 'bert.encoder.9.output.LayerNorm',
                        'l_52': 'bert.encoder.10.attention.self.query',
                        'l_53': 'bert.encoder.10.attention.self.key',
                        'l_54': 'bert.encoder.10.attention.self.value',
                        'l_55': 'bert.encoder.10.attention.self.softmax',
                        'l_56': 'bert.encoder.10.attention.self.dropout',
                        'l_57': 'bert.encoder.10.attention.output.dense',
                        'l_58': 'bert.encoder.10.attention.output.dropout',
                        'l_59': 'bert.encoder.10.attention.output.LayerNorm',
                        'l_60': 'bert.encoder.10.intermediate.dense',
                        'l_61': 'bert.encoder.10.output.dense',
                        'l_62': 'bert.encoder.10.output.dropout',
                        'l_63': 'bert.encoder.10.output.LayerNorm',
                        'l_64': 'bert.encoder.11.attention.self.query',
                        'l_65': 'bert.encoder.11.attention.self.key',
                        'l_66': 'bert.encoder.11.attention.self.value'}
        self.to(self.device)

    def forward(self, *args):
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_0
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_39
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_40
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_41
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_42
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_43
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_44
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_45
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_46
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_47
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_48
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/Linear[dense] <=> self.l_49
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/Dropout[dropout] <=> self.l_50
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_51
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_52
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_53
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_54
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_55
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_56
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_57
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_58
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_59
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_60
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/Linear[dense] <=> self.l_61
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/Dropout[dropout] <=> self.l_62
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_63
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_64
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_65
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_66
        # input0 <=> attention_mask
...
class Partition2(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:2'):
        ...
        self.lookup = {'l_0': 'bert.encoder.11.attention.self.softmax',
                        ...
                        'l_6': 'bert.encoder.11.output.dense',
                        'l_7': 'bert.encoder.11.output.dropout',
                        'l_8': 'bert.encoder.11.output.LayerNorm',
                        'l_9': 'bert.encoder.12.attention.self.query',
                        'l_10': 'bert.encoder.12.attention.self.key',
                        'l_11': 'bert.encoder.12.attention.self.value',
                        'l_12': 'bert.encoder.12.attention.self.softmax',
                        'l_13': 'bert.encoder.12.attention.self.dropout',
                        'l_14': 'bert.encoder.12.attention.output.dense',
                        'l_15': 'bert.encoder.12.attention.output.dropout',
                        'l_16': 'bert.encoder.12.attention.output.LayerNorm',
                        'l_17': 'bert.encoder.12.intermediate.dense',
                        'l_18': 'bert.encoder.12.output.dense',
                        'l_19': 'bert.encoder.12.output.dropout',
                        'l_20': 'bert.encoder.12.output.LayerNorm',
                        'l_21': 'bert.encoder.13.attention.self.query',
                        'l_22': 'bert.encoder.13.attention.self.key',
                        'l_23': 'bert.encoder.13.attention.self.value',
                        'l_24': 'bert.encoder.13.attention.self.softmax',
                        'l_25': 'bert.encoder.13.attention.self.dropout',
                        'l_26': 'bert.encoder.13.attention.output.dense',
                        'l_27': 'bert.encoder.13.attention.output.dropout',
                        'l_28': 'bert.encoder.13.attention.output.LayerNorm',
                        'l_29': 'bert.encoder.13.intermediate.dense',
                        ...
                        'l_38': 'bert.encoder.14.attention.output.dense',
                        'l_39': 'bert.encoder.14.attention.output.dropout',
                        'l_40': 'bert.encoder.14.attention.output.LayerNorm',
                        'l_41': 'bert.encoder.14.intermediate.dense',
                        'l_42': 'bert.encoder.14.output.dense',
                        'l_43': 'bert.encoder.14.output.dropout',
                        'l_44': 'bert.encoder.14.output.LayerNorm',
                        'l_45': 'bert.encoder.15.attention.self.query',
                        'l_46': 'bert.encoder.15.attention.self.key',
                        'l_47': 'bert.encoder.15.attention.self.value',
                        'l_48': 'bert.encoder.15.attention.self.softmax',
                        'l_49': 'bert.encoder.15.attention.self.dropout',
                        'l_50': 'bert.encoder.15.attention.output.dense',
                        'l_51': 'bert.encoder.15.attention.output.dropout',
                        'l_52': 'bert.encoder.15.attention.output.LayerNorm',
                        'l_53': 'bert.encoder.15.intermediate.dense',
                        'l_54': 'bert.encoder.15.output.dense',
                        'l_55': 'bert.encoder.15.output.dropout',
                        'l_56': 'bert.encoder.15.output.LayerNorm',
                        'l_57': 'bert.encoder.16.attention.self.query',
                        'l_58': 'bert.encoder.16.attention.self.key',
                        'l_59': 'bert.encoder.16.attention.self.value',
                        'l_60': 'bert.encoder.16.attention.self.softmax',
                        'l_61': 'bert.encoder.16.attention.self.dropout',
                        'l_62': 'bert.encoder.16.attention.output.dense',
                        'l_63': 'bert.encoder.16.attention.output.dropout',
                        'l_64': 'bert.encoder.16.attention.output.LayerNorm',
                        'l_65': 'bert.encoder.16.intermediate.dense',
                        'l_66': 'bert.encoder.16.output.dense'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/Linear[dense] <=> self.l_6
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/Dropout[dropout] <=> self.l_7
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_8
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_9
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_10
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_11
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_12
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_13
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_14
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_15
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_16
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertOutput[output]/Linear[dense] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertOutput[output]/Dropout[dropout] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_29
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_38
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_39
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_40
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_41
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertOutput[output]/Linear[dense] <=> self.l_42
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertOutput[output]/Dropout[dropout] <=> self.l_43
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_44
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_45
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_46
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_47
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_48
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_49
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_50
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_51
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_52
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_53
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertOutput[output]/Linear[dense] <=> self.l_54
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertOutput[output]/Dropout[dropout] <=> self.l_55
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_56
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_57
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_58
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_59
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_60
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_61
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_62
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_63
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_64
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_65
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/Linear[dense] <=> self.l_66
        # input0 <=> attention_mask
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm] <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1166 <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_1170 <=> x2
        attention_mask, x0, x1, x2 = unflatten(args,self.input_structure)
        t_0 = math.sqrt(64)
        t_0 = x2 / t_0
        t_0 = t_0 + attention_mask
        t_0 = self.l_0(t_0)
        t_0 = self.l_1(t_0)
...
class Partition3(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:3'):
        ...
        self.lookup = {'l_0': 'bert.encoder.16.output.dropout',
                        ...
                        'l_11': 'bert.encoder.17.output.dense',
                        'l_12': 'bert.encoder.17.output.dropout',
                        'l_13': 'bert.encoder.17.output.LayerNorm',
                        'l_14': 'bert.encoder.18.attention.self.query',
                        'l_15': 'bert.encoder.18.attention.self.key',
                        'l_16': 'bert.encoder.18.attention.self.value',
                        'l_17': 'bert.encoder.18.attention.self.softmax',
                        'l_18': 'bert.encoder.18.attention.self.dropout',
                        'l_19': 'bert.encoder.18.attention.output.dense',
                        'l_20': 'bert.encoder.18.attention.output.dropout',
                        'l_21': 'bert.encoder.18.attention.output.LayerNorm',
                        'l_22': 'bert.encoder.18.intermediate.dense',
                        'l_23': 'bert.encoder.18.output.dense',
                        'l_24': 'bert.encoder.18.output.dropout',
                        'l_25': 'bert.encoder.18.output.LayerNorm',
                        'l_26': 'bert.encoder.19.attention.self.query',
                        'l_27': 'bert.encoder.19.attention.self.key',
                        'l_28': 'bert.encoder.19.attention.self.value',
                        'l_29': 'bert.encoder.19.attention.self.softmax',
                        'l_30': 'bert.encoder.19.attention.self.dropout',
                        'l_31': 'bert.encoder.19.attention.output.dense',
                        'l_32': 'bert.encoder.19.attention.output.dropout',
                        'l_33': 'bert.encoder.19.attention.output.LayerNorm',
                        'l_34': 'bert.encoder.19.intermediate.dense',
                        'l_35': 'bert.encoder.19.output.dense',
                        'l_36': 'bert.encoder.19.output.dropout',
                        'l_37': 'bert.encoder.19.output.LayerNorm',
                        'l_38': 'bert.encoder.20.attention.self.query',
                        'l_39': 'bert.encoder.20.attention.self.key',
                        'l_40': 'bert.encoder.20.attention.self.value',
                        'l_41': 'bert.encoder.20.attention.self.softmax',
                        'l_42': 'bert.encoder.20.attention.self.dropout',
                        'l_43': 'bert.encoder.20.attention.output.dense',
                        'l_44': 'bert.encoder.20.attention.output.dropout',
                        'l_45': 'bert.encoder.20.attention.output.LayerNorm',
                        'l_46': 'bert.encoder.20.intermediate.dense',
                        'l_47': 'bert.encoder.20.output.dense',
                        'l_48': 'bert.encoder.20.output.dropout',
                        'l_49': 'bert.encoder.20.output.LayerNorm',
                        'l_50': 'bert.encoder.21.attention.self.query',
                        'l_51': 'bert.encoder.21.attention.self.key',
                        'l_52': 'bert.encoder.21.attention.self.value',
                        'l_53': 'bert.encoder.21.attention.self.softmax',
                        'l_54': 'bert.encoder.21.attention.self.dropout',
                        'l_55': 'bert.encoder.21.attention.output.dense',
                        'l_56': 'bert.encoder.21.attention.output.dropout',
                        'l_57': 'bert.encoder.21.attention.output.LayerNorm',
                        'l_58': 'bert.encoder.21.intermediate.dense',
                        'l_59': 'bert.encoder.21.output.dense',
                        'l_60': 'bert.encoder.21.output.dropout',
                        'l_61': 'bert.encoder.21.output.LayerNorm',
                        'l_62': 'bert.encoder.22.attention.self.query',
                        'l_63': 'bert.encoder.22.attention.self.key',
                        'l_64': 'bert.encoder.22.attention.self.value',
                        'l_65': 'bert.encoder.22.attention.self.softmax',
                        'l_66': 'bert.encoder.22.attention.self.dropout',
                        'l_67': 'bert.encoder.22.attention.output.dense',
                        'l_68': 'bert.encoder.22.attention.output.dropout',
                        'l_69': 'bert.encoder.22.attention.output.LayerNorm',
                        'l_70': 'bert.encoder.22.intermediate.dense',
                        'l_71': 'bert.encoder.22.output.dense',
                        'l_72': 'bert.encoder.22.output.dropout',
                        'l_73': 'bert.encoder.22.output.LayerNorm',
                        'l_74': 'bert.encoder.23.attention.self.query',
                        'l_75': 'bert.encoder.23.attention.self.key',
                        'l_76': 'bert.encoder.23.attention.self.value',
                        'l_77': 'bert.encoder.23.attention.self.softmax',
                        'l_78': 'bert.encoder.23.attention.self.dropout',
                        'l_79': 'bert.encoder.23.attention.output.dense',
                        'l_80': 'bert.encoder.23.attention.output.dropout',
                        'l_81': 'bert.encoder.23.attention.output.LayerNorm',
                        'l_82': 'bert.encoder.23.intermediate.dense',
                        'l_83': 'bert.encoder.23.output.dense',
                        'l_84': 'bert.encoder.23.output.dropout',
                        'l_85': 'bert.encoder.23.output.LayerNorm',
                        'l_86': 'bert.pooler.dense',
                        'l_87': 'bert.pooler.activation',
                        'l_88': 'qa_outputs'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertOutput[output]/Linear[dense] <=> self.l_11
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertOutput[output]/Dropout[dropout] <=> self.l_12
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_13
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_14
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_15
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_16
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertOutput[output]/Linear[dense] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertOutput[output]/Dropout[dropout] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/Linear[dense] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/Dropout[dropout] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_38
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_39
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_40
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_41
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_42
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_43
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_44
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_45
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_46
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertOutput[output]/Linear[dense] <=> self.l_47
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertOutput[output]/Dropout[dropout] <=> self.l_48
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_49
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_50
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_51
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_52
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_53
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_54
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_55
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_56
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_57
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_58
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertOutput[output]/Linear[dense] <=> self.l_59
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertOutput[output]/Dropout[dropout] <=> self.l_60
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_61
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_62
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_63
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_64
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_65
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_66
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_67
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_68
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_69
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_70
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertOutput[output]/Linear[dense] <=> self.l_71
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertOutput[output]/Dropout[dropout] <=> self.l_72
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_73
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_74
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_75
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_76
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_77
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_78
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_79
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_80
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_81
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_82
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertOutput[output]/Linear[dense] <=> self.l_83
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertOutput[output]/Dropout[dropout] <=> self.l_84
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_85
        # BertForQuestionAnswering/BertModel[bert]/BertPooler[pooler]/Linear[dense] <=> self.l_86
        # BertForQuestionAnswering/BertModel[bert]/BertPooler[pooler]/Tanh[activation] <=> self.l_87
        # BertForQuestionAnswering/Linear[qa_outputs] <=> self.l_88
        # input0 <=> attention_mask
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/Linear[dense] <=> x1
...
-I- Printing Report
warnings:
Partition1 output:BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1166 is not contiguous!
...
Stage parameter count:
 {0: 98964480, 1: 74525696, 2: 72426496, 3: 89227266, 'total': 335143938}
...
forward {0: 78.25, 1: 91.75, 2: 80.55, 3: 96.37}
backward {0: 211.35, 1: 222.95, 2: 232.76, 3: 174.86}
...
forward {0: 0.79, 1: 0.82, 2: 0.81, 3: 1.0}
backward {0: 0.91, 1: 0.95, 2: 0.95, 3: 0.74}

worstcase: bwd: 232.756 fwd: 96.369
Expected speedup for 4 partitions is: 3.506
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'18.87 MB', send time:'1.57 ms'
1: input size:'18.87 MB', recieve_time:'1.57 ms', out:'150.99 MB', send time:'12.58 ms'
2: input size:'150.99 MB', recieve_time:'12.58 ms', out:'37.75 MB', send time:'3.15 ms'
3: input size:'37.75 MB', recieve_time:'3.15 ms', out:'0.04 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.98, 1: 0.86, 2: 0.96, 3: 1.0} 
backward {0: 1.0, 1: 0.99, 2: 0.95, 3: 0.98}
...
Analysis for T = fwd + bwd:
 {'expected_compute_utilization': {0: 0.96,
                                  ...
                                  3: 0.89,
                                  'worstcase_std': 0.0},
 'pipeline_no_comm': {0: 288.03,
                      1: 300.54,
                      2: 297.58,
                      3: 268.09,
                      'worstcase': 300.54,
                      'worstcase_std': 1.04},
 'pipeline_vs_seq_no_comm': 3.1,
 'pipeline_with_non_parallel_comm': {0: 289.6,
                                     1: 314.69,
                                     2: 313.31,
                                     3: 271.23,
                                     'worstcase': 314.69},
 'seq_no_comm_no_recomp': {0: 213.81, 1: 224.11, 2: 220.74, 3: 271.59}}

expected_speedup_compared_to_seq_no_recomp_no_comm: 2.826
Analysis max cuda memory used 5.29GB
"""