...
# partition 9 {'inputs': {0, 8, 'decoder_attention_mask', 'inverted_encoder_attention_mask', 'decoder_input_ids'}, 'outputs': {10, 11, 12, 13, 14}}
# partition 10 {'inputs': {'decoder_attention_mask', 9, 'inverted_encoder_attention_mask'}, 'outputs': {11, 12, 13, 14}}
# partition 11 {'inputs': {'decoder_attention_mask', 9, 10, 'inverted_encoder_attention_mask'}, 'outputs': {12}}
...
def create_pipeline_configuration(DEBUG=False, batch_size=8):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,StatelessEmbedding,T5Block,Dropout,CrossEntropyLoss,T5LayerNorm),
        'model_inputs': {
            'attention_mask': {
                'shape': torch.Size([8, 1, 1, 64]),
                'dtype': torch.float32,
                'is_batched': True,
                'used_by': [0, 1, 2, 3, 4, 5, 6, 7]},
            'decoder_attention_mask': {
                'shape': torch.Size([8, 1, 6, 6]),
                'dtype': torch.float32,
                'is_batched': True,
            ...
            0: {
                ...
                'outputs': {
                    ...
                    'T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___22_1': {
                        'shape': torch.Size([8, 32, 64, 64]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [1]},
                    'T5ForConditionalGeneration/T5Stack[encoder]/T5Block[2]': {
                        'shape': torch.Size([8, 64, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [1]}},
...
model_args = {'model_name_or_path': 't5-3b', 'max_seq_length': 64, 'answer_max_seq_length': 6, 'stateless_tied': True, 'lmhead': True, 'precompute_masks': True}
"""analysis summary
-I- Printing Report
warnings:
...
unique_stages_on_same_gpu: [{7, 15}, {0, 8}, {1, 11}, {2, 13}, {3, 14}, {4, 12}, {10, 5}, {9, 6}]
stage_to_device_map = [0, 1, 2, 3, 4, 5, 6, 7, 0, 6, 5, 1, 4, 2, 3, 7]
...
forward {0: 27.81, 1: 27.48, 2: 27.42, 3: 26.91, 4: 26.67, 5: 24.01, 6: 19.21, 7: 16.87}
backward {0: 43.8, 1: 70.94, 2: 70.32, 3: 70.24, 4: 70.55, 5: 60.98, 6: 62.1, 7: 43.25}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'2.10 MB', recieve_time:'0.18 ms', out:'139.87 MB', send time:'11.66 ms'
1: input size:'9.02 MB', recieve_time:'0.75 ms', out:'9.02 MB', send time:'0.75 ms'
2: input size:'9.02 MB', recieve_time:'0.75 ms', out:'9.02 MB', send time:'0.75 ms'
3: input size:'9.02 MB', recieve_time:'0.75 ms', out:'6.49 MB', send time:'0.54 ms'
4: input size:'9.02 MB', recieve_time:'0.75 ms', out:'9.02 MB', send time:'0.75 ms'
5: input size:'9.22 MB', recieve_time:'0.77 ms', out:'9.02 MB', send time:'0.75 ms'
6: input size:'139.88 MB', recieve_time:'11.66 ms', out:'9.21 MB', send time:'0.77 ms'
7: input size:'6.49 MB', recieve_time:'0.54 ms', out:'2.10 MB', send time:'0.17 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.58, 1: 0.97, 2: 0.97, 3: 0.98, 4: 0.97, 5: 0.97, 6: 0.96, 7: 0.99} 
backward {0: 1.0, 1: 0.99, 2: 0.99, 3: 0.99, 4: 0.99, 5: 0.99, 6: 0.81, 7: 0.99}

Analysis for T = fwd + bwd:
 {'expected_compute_utilization': {0: 0.62,
                                  1: 1.0,
                                  2: 0.99,
                                  3: 0.99,
                                  4: 0.99,
 ...
 'pipeline_no_comm': {0: 59.77,
                      ...
                      7: 59.4,
                      'worstcase': 96.92},
 'pipeline_vs_seq_no_comm': 5.37,
 'pipeline_with_non_parallel_comm': {0: 71.6,
                                     1: 98.42,
                                     2: 97.74,
                                     3: 97.15,
                                     4: 97.22,
...
forward {0: 0.58, 1: 0.96, 2: 0.96, 3: 0.95, 4: 0.93, 5: 0.83, 6: 0.66, 7: 0.6}
backward {0: 0.62, 1: 0.99, 2: 0.98, 3: 0.98, 4: 0.98, 5: 0.85, 6: 0.71, 7: 0.6}

worstcase: bwd: 70.944 fwd: 27.806
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.266
Expected speedup for 8 partitions is: 6.644
