    ...
    config = {
        ...
        "stages": {
            "0": {
                ...
                "stage_cls": "models.partitioned.wrn_16x4_p2.WideResNetPartition0",
            ...
            "1": {
                ...
                "stage_cls": "models.partitioned.wrn_16x4_p2.WideResNetPartition1",
...
class WideResNetPartition1(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_12, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, BatchNorm2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_13)}'
        ...
        assert isinstance(
            self.l_14, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_14)}'
        ...
        assert isinstance(
            self.l_15, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_15)}'
        ...
        assert isinstance(
            self.l_16, BatchNorm2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_16)}'
        ...
        assert isinstance(
            self.l_17, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_17)}'
        ...
        assert isinstance(
            self.l_18, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_18)}'
        ...
        assert isinstance(
            self.l_19, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]] is expected to be of type Conv2d but was of type {type(self.l_19)}'
        ...
        assert isinstance(
            self.l_20, BatchNorm2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_20)}'
        ...
        assert isinstance(
            self.l_21, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_21)}'
        ...
        assert isinstance(
            self.l_22, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_22)}'
        ...
        assert isinstance(
            self.l_23, BatchNorm2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_23)}'
        ...
        assert isinstance(
            self.l_24, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_24)}'
        ...
        assert isinstance(
            self.l_25, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_25)}'
        ...
        assert isinstance(
            self.l_26, BatchNorm2d), f'layers[WideResNet/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_26)}'
        ...
        assert isinstance(
            self.l_27, ReLU), f'layers[WideResNet/ReLU[relu]] is expected to be of type ReLU but was of type {type(self.l_27)}'
        ...
        assert isinstance(
            self.l_28, AvgPool2d), f'layers[WideResNet/AvgPool2d[avg_pool]] is expected to be of type AvgPool2d but was of type {type(self.l_28)}'
        # WideResNet/Linear[fc]
        ...
        assert isinstance(
            self.l_29, Linear), f'layers[WideResNet/Linear[fc]] is expected to be of type Linear but was of type {type(self.l_29)}'
    ...
    def forward(self, x0):
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]
        t_2 = self.l_14(self.l_13(torch.add(input=t_1, other=self.l_12(
            self.l_11(self.l_10(self.l_9(self.l_8(self.l_7(t_1)))))))))
        # calling torch.add with arguments:
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]
        t_3 = torch.add(input=self.l_19(t_2), other=self.l_18(
            self.l_17(self.l_16(self.l_15(t_2)))))
        # calling WideResNet/AvgPool2d[avg_pool] with arguments:
        # WideResNet/ReLU[relu]
        t_4 = self.l_28(self.l_27(self.l_26(torch.add(input=t_3, other=self.l_25(
            self.l_24(self.l_23(self.l_22(self.l_21(self.l_20(t_3))))))))))
        # returing:
        # WideResNet/Linear[fc]
