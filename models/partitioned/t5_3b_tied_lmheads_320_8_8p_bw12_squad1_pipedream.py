"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 320 --answer_max_seq_length 8 --basic_blocks T5Block --save_memory_mode --partitioning_method pipedream --disable_op_profiling
"""
import torch
...
# partition 0 {'inputs': {'decoder_input_ids', 'attention_mask', 'input_ids'}, 'outputs': {1, 2, 3, 4, 5}}
...
# partition 5 {'inputs': {0, 4, 'decoder_input_ids', 'decoder_attention_mask', 'inverted_encoder_attention_mask', 'attention_mask'}, 'outputs': {6, 7}}
# partition 6 {'inputs': {'inverted_encoder_attention_mask', 5, 'decoder_attention_mask'}, 'outputs': {7}}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,Dropout,T5Block,CrossEntropyLoss,T5LayerNorm,StatelessEmbedding),
        'model_inputs': {
            'attention_mask': {
...
class Partition0(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[3]
        return list(flatten((t_0, self.p_0, t_1, t_2)))
...
class Partition5(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0] <=> self.l_8
        # input0 <=> attention_mask
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___22 <=> x2
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19] <=> x3
...
class Partition6(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[8] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12] <=> self.l_11
        # input1 <=> decoder_attention_mask
        # input4 <=> inverted_encoder_attention_mask
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___128 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___130 <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___132 <=> x3
        decoder_attention_mask, inverted_encoder_attention_mask, x0, x1, x2, x3 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x1, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_1(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_2(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_3(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_4(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_5(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_6(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_7(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_8(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_9(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_10(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        t_0 = self.l_11(t_0, attention_mask=decoder_attention_mask, position_bias=x2, encoder_hidden_states=x0, encoder_attention_mask=inverted_encoder_attention_mask, encoder_decoder_position_bias=x3)
        # Returning:
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout]
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___130
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___132
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]
        return list(flatten((x0, x2, x3, t_0)))
...
class Partition7(nn.Module):
    ...
    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[14] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[18] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[19] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[20] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23] <=> self.l_10
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12] <=> x3
...
forward {0: 79.49, 1: 62.12, 2: 62.29, 3: 62.11, 4: 62.13, 5: 60.18, 6: 34.63, 7: 31.64}
backward {0: 162.14, 1: 161.02, 2: 161.22, 3: 161.05, 4: 160.94, 5: 182.86, 6: 99.64, 7: 93.56}
...
forward {0: 0.8, 1: 0.72, 2: 0.72, 3: 0.72, 4: 0.72, 5: 0.75, 6: 0.43, 7: 0.4}
backward {0: 0.89, 1: 0.85, 2: 0.85, 3: 0.85, 4: 0.85, 5: 0.91, 6: 0.54, 7: 0.51}

worstcase: bwd: 182.864 fwd: 79.493
Expected speedup for 8 partitions is: 5.926
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'189.15 MB', send time:'15.76 ms'
1: input size:'57.67 MB', recieve_time:'4.81 ms', out:'57.67 MB', send time:'4.81 ms'
2: input size:'57.67 MB', recieve_time:'4.81 ms', out:'57.67 MB', send time:'4.81 ms'
3: input size:'57.67 MB', recieve_time:'4.81 ms', out:'57.67 MB', send time:'4.81 ms'
4: input size:'57.67 MB', recieve_time:'4.81 ms', out:'57.67 MB', send time:'4.81 ms'
5: input size:'189.15 MB', recieve_time:'15.76 ms', out:'6.72 MB', send time:'0.56 ms'
6: input size:'6.72 MB', recieve_time:'0.56 ms', out:'6.72 MB', send time:'0.56 ms'
7: input size:'6.72 MB', recieve_time:'0.56 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.8, 1: 0.92, 2: 0.92, 3: 0.92, 4: 0.92, 5: 0.99, 6: 0.98, 7: 1.0} 
backward {0: 1.0, 1: 0.97, 2: 0.97, 3: 0.97, 4: 0.97, 5: 0.91, 6: 0.99, 7: 0.99}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 225.87,
                      ...
                      'worstcase': 226.72,
                      'worstcase_std': 0.92},
 'pipeline_vs_seq_no_comm': 5.06,
 'pipeline_with_non_parallel_comm': {0: 241.63,
                                     1: 223.14,
                                     2: 223.51,
                                     3: 223.16,
                                     4: 223.06,
                                     ...
                                     7: 125.2,
                                     'worstcase': 243.04},
 'seq_no_comm_no_recomp': {0: 164.46,
                           1: 156.0,
                           2: 156.05,
                           3: 155.85,
                           4: 155.93,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.372
