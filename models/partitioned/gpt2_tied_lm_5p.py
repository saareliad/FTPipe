"""AutoGenerated with:
python partition_gpt2_models.py --model_type gpt2 --model_name_or_path gpt2 --train_data_file wikitext-2-raw/wiki.train.raw --n_partitions 4 --partitioning_batch_size 4 --analysis_batch_size 4 --block_size -1 --save_memory_mode --stateless_tied -a --lm --output_file gpt2_tied_lm_5p
"""
import torch
...
# partition 4 {'inputs': {'input1', 0, 3}, 'outputs': {'output0'}}
# model outputs {4}


def create_pipeline_configuration(DEBUG=False):
    depth = 10000
    basic_blocks = (Embedding,Conv1D,LayerNorm,StatelessLinear,Dropout,StatelessEmbedding)
    ...
    stages = {0: {"inputs": {'input0': {'shape': [4, 1024], 'dtype': 'torch.int64', 'is_batched': True}},
        "outputs": {'GPT2LMHeadModel/GPT2Model[transformer]/Block[1]/aten::add5221': {'shape': [4, 1024, 768], 'dtype': 'torch.float32', 'is_batched': True}, 'GPT2LMHeadModel/GPT2Model[transformer]/Block[2]/Attention[attn]/aten::permute5357': {'shape': [4, 1024, 12, 64], 'dtype': 'torch.float32', 'is_batched': True}, 'GPT2LMHeadModel/Parameter[w_wte]': {'shape': [50257, 768], 'dtype': 'torch.float32', 'is_batched': False}}},
            1: {"inputs": {'GPT2LMHeadModel/GPT2Model[transformer]/Block[1]/aten::add5221': {'shape': [4, 1024, 768], 'dtype': 'torch.float32', 'is_batched': True}, 'GPT2LMHeadModel/GPT2Model[transformer]/Block[2]/Attention[attn]/aten::permute5357': {'shape': [4, 1024, 12, 64], 'dtype': 'torch.float32', 'is_batched': True}},
        "outputs": {'GPT2LMHeadModel/GPT2Model[transformer]/Block[5]/LayerNorm[ln_2]': {'shape': [4, 1024, 768], 'dtype': 'torch.float32', 'is_batched': True}, 'GPT2LMHeadModel/GPT2Model[transformer]/Block[5]/aten::add5933': {'shape': [4, 1024, 768], 'dtype': 'torch.float32', 'is_batched': True}}},
            2: {"inputs": {'GPT2LMHeadModel/GPT2Model[transformer]/Block[5]/LayerNorm[ln_2]': {'shape': [4, 1024, 768], 'dtype': 'torch.float32', 'is_batched': True}, 'GPT2LMHeadModel/GPT2Model[transformer]/Block[5]/aten::add5933': {'shape': [4, 1024, 768], 'dtype': 'torch.float32', 'is_batched': True}},
...
class Partition0(nn.Module):
    ...
    def forward(self, x0):
        ...
        t_8 = t_8.split(split_size=768, dim=2)
        t_3 = t_8[0]
        t_2 = t_8[1]
        t_8 = t_8[2]
        # calling Tensor.size with arguments:
...
class Partition1(nn.Module):
    ...
    def forward(self, x0, x1):
        ...
        # GPT2LMHeadModel/GPT2Model[transformer]/Block[2]/Attention[attn]/aten::permute5357 <=> x1
...
class Partition2(nn.Module):
    ...
    def forward(self, x0, x1):
        ...
        # GPT2LMHeadModel/GPT2Model[transformer]/Block[5]/aten::add5933 <=> x1
...
forward {0: 49.52, 1: 41.96, 2: 47.58, 3: 41.49, 4: 31.46}
backward {0: 88.45, 1: 104.59, 2: 110.57, 3: 109.45, 4: 219.76}
...
2: input size:'25.17 MB', recieve_time:'2.10 ms', out:'62.91 MB', send time:'5.24 ms'
...
forward {0: 0.7, 1: 0.95, 2: 0.89, 3: 0.97, 4: 1.0} 
backward {0: 1.0, 1: 0.98, 2: 0.98, 3: 0.95, 4: 0.94}
...
forward {0: 0.7, 1: 0.81, 2: 0.85, 3: 0.82, 4: 0.64}
backward {0: 0.4, 1: 0.47, 2: 0.49, 3: 0.48, 4: 0.94}

Expected speedup for 5 partitions is: 2.919
"""
