...
# generated with:
# python partition_vision_models.py --model wrn_28x10_c100_dr03 --batch_size 128 --n_partitions 2 --n_iter 300 --analysis_batch_size 128 --dataset cifar100
...
def create_pipeline_configuration(DEBUG=False):
    return {
        ...
        "basic_blocks": [
            ...
            "torch.nn.modules.conv.Conv2d", "torch.nn.modules.activation.ReLU",
        ...
        "stages": {
            "0": {
                ...
                "stage_cls":
                "models.partitioned.wrn_28x10_c100_dr03_p2.WideResNetPartition0",
            ...
            "1": {
                ...
                "stage_cls":
                "models.partitioned.wrn_28x10_c100_dr03_p2.WideResNetPartition1",
...
class WideResNetPartition0(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_18, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_18)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_19)}'
        ...
        assert isinstance(
            self.l_20, ReLU
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_20)}'
        ...
        assert isinstance(
            self.l_21, Dropout
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_21)}'
        ...
        assert isinstance(
            self.l_22, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_22)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_23)}'
        ...
        assert isinstance(
            self.l_24, ReLU
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_24)}'
        ...
        assert isinstance(
            self.l_25, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_25)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_26)}'
        ...
        assert isinstance(
            self.l_27, ReLU
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_27)}'
        ...
        assert isinstance(
            self.l_28, Dropout
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_28)}'
        ...
        assert isinstance(
            self.l_29, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_29)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_30)}'
        ...
        assert isinstance(
            self.l_31, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_31)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]
        ...
        assert isinstance(
            self.l_32, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_32)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        ...
        assert isinstance(
            self.l_33, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]] is expected to be of type Conv2d but was of type {type(self.l_33)}'
    ...
    def forward(self, x0):
        ...
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2] <=> self.l_19
        ...
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2] <=> self.l_22
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1] <=> self.l_23
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu1] <=> self.l_24
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1] <=> self.l_25
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2] <=> self.l_26
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu2] <=> self.l_27
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Dropout[dropout] <=> self.l_28
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2] <=> self.l_29
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1] <=> self.l_30
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/ReLU[relu1] <=> self.l_31
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1] <=> self.l_32
...
class WideResNetPartition1(nn.Module):
    def __init__(self, layers, tensors):
        ...
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Dropout
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, Dropout
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
        ...
        assert isinstance(
            self.l_12, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_13)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_14)}'
        ...
        assert isinstance(
            self.l_15, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_15)}'
        ...
        assert isinstance(
            self.l_16, Dropout
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_16)}'
        ...
        assert isinstance(
            self.l_17, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_17)}'
        ...
        self.l_18 = layers[
            'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1]']
        assert isinstance(
            self.l_18, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_18)}'
        ...
        assert isinstance(
            self.l_19, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_19)}'
        ...
        assert isinstance(
            self.l_20, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_20)}'
        ...
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_21)}'
        ...
        assert isinstance(
            self.l_22, ReLU
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_22)}'
        ...
        assert isinstance(
            self.l_23, Dropout
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_23)}'
        ...
        assert isinstance(
            self.l_24, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_24)}'
        ...
        self.l_25 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]']
        assert isinstance(
            self.l_25, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_25)}'
        ...
        assert isinstance(
            self.l_26, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_26)}'
        ...
        assert isinstance(
            self.l_27, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_27)}'
        ...
        self.l_28 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]']
        assert isinstance(
            self.l_28, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_28)}'
        ...
        assert isinstance(
            self.l_29, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_29)}'
        ...
        assert isinstance(
            self.l_30, Dropout
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_30)}'
        ...
        assert isinstance(
            self.l_31, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_31)}'
        ...
        assert isinstance(
            self.l_32, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]] is expected to be of type Conv2d but was of type {type(self.l_32)}'
        ...
        self.l_33 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]']
        assert isinstance(
            self.l_33, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_33)}'
        ...
        assert isinstance(
            self.l_34, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_34)}'
        ...
        assert isinstance(
            self.l_35, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_35)}'
        ...
        self.l_36 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]']
        assert isinstance(
            self.l_36, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_36)}'
        ...
        assert isinstance(
            self.l_37, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_37)}'
        ...
        assert isinstance(
            self.l_38, Dropout
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_38)}'
        ...
        assert isinstance(
            self.l_39, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_39)}'
        ...
        self.l_40 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn1]']
        assert isinstance(
            self.l_40, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_40)}'
        ...
        assert isinstance(
            self.l_41, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_41)}'
        ...
        assert isinstance(
            self.l_42, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_42)}'
        ...
        self.l_43 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2]']
        assert isinstance(
            self.l_43, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_43)}'
        ...
        assert isinstance(
            self.l_44, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_44)}'
        ...
        assert isinstance(
            self.l_45, Dropout
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_45)}'
        ...
        assert isinstance(
            self.l_46, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_46)}'
        ...
        self.l_47 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1]']
        assert isinstance(
            self.l_47, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_47)}'
        ...
        assert isinstance(
            self.l_48, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_48)}'
        ...
        assert isinstance(
            self.l_49, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_49)}'
        ...
        self.l_50 = layers[
            'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2]']
        assert isinstance(
            self.l_50, BatchNorm2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_50)}'
        ...
        assert isinstance(
            self.l_51, ReLU
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_51)}'
        ...
        assert isinstance(
            self.l_52, Dropout
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_52)}'
        ...
        assert isinstance(
            self.l_53, Conv2d
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_53)}'
        ...
        assert isinstance(
            self.l_54, BatchNorm2d
        ), f'layers[WideResNet/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_54)}'
        ...
        assert isinstance(
            self.l_55, ReLU
        ), f'layers[WideResNet/ReLU[relu]] is expected to be of type ReLU but was of type {type(self.l_55)}'
        ...
        assert isinstance(
            self.l_56, AvgPool2d
        ), f'layers[WideResNet/AvgPool2d[avg_pool]] is expected to be of type AvgPool2d but was of type {type(self.l_56)}'
        # WideResNet/Linear[fc]
        ...
        assert isinstance(
            self.l_57, Linear
        ), f'layers[WideResNet/Linear[fc]] is expected to be of type Linear but was of type {type(self.l_57)}'

        self.device = torch.device('cuda:1')
        self.lookup = {
            'l_0': 'block2.layer.0.bn2',
    ...
    def forward(self, x0, x1):
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/ReLU[relu2] <=> self.l_1
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Dropout[dropout] <=> self.l_2
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2] <=> self.l_3
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1] <=> self.l_4
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/ReLU[relu1] <=> self.l_5
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1] <=> self.l_6
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2] <=> self.l_7
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/ReLU[relu2] <=> self.l_8
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Dropout[dropout] <=> self.l_9
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2] <=> self.l_10
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn1] <=> self.l_11
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/ReLU[relu1] <=> self.l_12
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1] <=> self.l_13
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2] <=> self.l_14
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/ReLU[relu2] <=> self.l_15
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Dropout[dropout] <=> self.l_16
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2] <=> self.l_17
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1] <=> self.l_18
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/ReLU[relu1] <=> self.l_19
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1] <=> self.l_20
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2] <=> self.l_21
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/ReLU[relu2] <=> self.l_22
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Dropout[dropout] <=> self.l_23
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2] <=> self.l_24
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn1] <=> self.l_25
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1] <=> self.l_26
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1] <=> self.l_27
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/BatchNorm2d[bn2] <=> self.l_28
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2] <=> self.l_29
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Dropout[dropout] <=> self.l_30
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2] <=> self.l_31
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut] <=> self.l_32
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn1] <=> self.l_33
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1] <=> self.l_34
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1] <=> self.l_35
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/BatchNorm2d[bn2] <=> self.l_36
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2] <=> self.l_37
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Dropout[dropout] <=> self.l_38
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2] <=> self.l_39
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn1] <=> self.l_40
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/ReLU[relu1] <=> self.l_41
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1] <=> self.l_42
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/BatchNorm2d[bn2] <=> self.l_43
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/ReLU[relu2] <=> self.l_44
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Dropout[dropout] <=> self.l_45
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2] <=> self.l_46
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn1] <=> self.l_47
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/ReLU[relu1] <=> self.l_48
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1] <=> self.l_49
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/BatchNorm2d[bn2] <=> self.l_50
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/ReLU[relu2] <=> self.l_51
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Dropout[dropout] <=> self.l_52
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2] <=> self.l_53
        # WideResNet/BatchNorm2d[bn1] <=> self.l_54
        # WideResNet/ReLU[relu] <=> self.l_55
        # WideResNet/AvgPool2d[avg_pool] <=> self.l_56
        # WideResNet/Linear[fc] <=> self.l_57
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]
        t_0 = torch.add(input=x1,
                        other=self.l_3(self.l_2(self.l_1(self.l_0(x0)))))
        # calling torch.add with arguments:
        ...
        t_1 = torch.add(
            input=t_0,
            other=self.l_10(
                self.l_9(self.l_8(self.l_7(self.l_6(self.l_5(
                    self.l_4(t_0))))))))
        # calling torch.add with arguments:
        ...
        t_2 = torch.add(
            ...
            other=self.l_17(
                self.l_16(
                    self.l_15(self.l_14(self.l_13(self.l_12(
                        self.l_11(t_1))))))))
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]
        t_4 = torch.add(input=self.l_32(t_3),
                        other=self.l_31(
        ...
        t_5 = torch.add(
            ...
            other=self.l_39(
                self.l_38(
                    self.l_37(self.l_36(self.l_35(self.l_34(
                        self.l_33(t_4))))))))
        # calling torch.add with arguments:
        ...
        t_6 = torch.add(
            ...
            other=self.l_46(
                self.l_45(
                    self.l_44(self.l_43(self.l_42(self.l_41(
                        self.l_40(t_5))))))))
