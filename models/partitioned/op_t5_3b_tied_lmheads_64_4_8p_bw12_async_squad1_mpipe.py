...
# partition adjacency
# model inputs {0, 8, 15}
# partition 0 {'inputs': {'decoder_attention_mask', 'input_ids', 'attention_mask', 'decoder_input_ids'}, 'outputs': {8, 1}}
...
class Partition7(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:7'):
        ...
        self.lookup = {'l_0': 'encoder.block.21.layer.0.SelfAttention.q',
                        'l_1': 'encoder.block.21.layer.0.SelfAttention.k',
                        'l_2': 'encoder.block.21.layer.0.SelfAttention.v',
                        'l_3': 'encoder.block.21.layer.0.SelfAttention.o',
                        'l_4': 'encoder.block.21.layer.0.dropout',
                        'l_5': 'encoder.block.21.layer.1.layer_norm',
                        'l_6': 'encoder.block.21.layer.1.DenseReluDense.wi',
                        'l_7': 'encoder.block.21.layer.1.DenseReluDense.dropout',
                        'l_8': 'encoder.block.21.layer.1.DenseReluDense.wo',
                        'l_9': 'encoder.block.21.layer.1.dropout',
                        'l_10': 'encoder.block.22.layer.0.layer_norm',
                        'l_11': 'encoder.block.22.layer.0.SelfAttention.q',
                        'l_12': 'encoder.block.22.layer.0.SelfAttention.k',
                        'l_13': 'encoder.block.22.layer.0.SelfAttention.v',
                        'l_14': 'encoder.block.22.layer.0.SelfAttention.o',
                        'l_15': 'encoder.block.22.layer.0.dropout',
                        'l_16': 'encoder.block.22.layer.1.layer_norm',
                        'l_17': 'encoder.block.22.layer.1.DenseReluDense.wi',
                        'l_18': 'encoder.block.22.layer.1.DenseReluDense.dropout',
                        'l_19': 'encoder.block.22.layer.1.DenseReluDense.wo',
                        'l_20': 'encoder.block.22.layer.1.dropout',
                        'l_21': 'encoder.block.23.layer.0.layer_norm',
                        'l_22': 'encoder.block.23.layer.0.SelfAttention.q',
                        'l_23': 'encoder.block.23.layer.0.SelfAttention.k',
                        'l_24': 'encoder.block.23.layer.0.SelfAttention.v',
                        'l_25': 'encoder.block.23.layer.0.SelfAttention.o',
                        'l_26': 'encoder.block.23.layer.0.dropout',
                        'l_27': 'encoder.block.23.layer.1.layer_norm',
                        'l_28': 'encoder.block.23.layer.1.DenseReluDense.wi',
                        'l_29': 'encoder.block.23.layer.1.DenseReluDense.dropout',
                        'l_30': 'encoder.block.23.layer.1.DenseReluDense.wo',
                        'l_31': 'encoder.block.23.layer.1.dropout',
                        'l_32': 'encoder.final_layer_norm',
                        'l_33': 'encoder.dropout',
                        'l_34': 'decoder.block.21.layer.1.EncDecAttention.v'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/T5LayerNorm[final_layer_norm] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_34
...
class Partition8(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:8'):
        ...
        self.lookup = {'l_0': 'decoder.embed_tokens',
                        ...
                        'l_54': 'decoder.block.3.layer.0.layer_norm',
                        'l_55': 'decoder.block.3.layer.0.SelfAttention.q',
                        'l_56': 'decoder.block.3.layer.0.SelfAttention.k',
                        'l_57': 'decoder.block.3.layer.0.SelfAttention.v'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_54
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_55
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_56
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_57
        # input0 <=> attention_mask
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k]
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v]
        return list(flatten((x1, t_9, t_8, t_5, t_7, t_3, t_4, t_1)))
...
class Partition9(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:9'):
        ...
        self.lookup = {'l_0': 'decoder.block.3.layer.0.SelfAttention.o',
                        'l_1': 'decoder.block.3.layer.0.dropout',
                        'l_2': 'decoder.block.3.layer.1.layer_norm',
                        'l_3': 'decoder.block.3.layer.1.EncDecAttention.q',
                        'l_4': 'decoder.block.3.layer.1.EncDecAttention.k',
                        'l_5': 'decoder.block.3.layer.1.EncDecAttention.v',
                        ...
                        'l_13': 'decoder.block.4.layer.0.layer_norm',
                        'l_14': 'decoder.block.4.layer.0.SelfAttention.q',
                        'l_15': 'decoder.block.4.layer.0.SelfAttention.k',
                        'l_16': 'decoder.block.4.layer.0.SelfAttention.v',
                        'l_17': 'decoder.block.4.layer.0.SelfAttention.o',
                        'l_18': 'decoder.block.4.layer.0.dropout',
                        'l_19': 'decoder.block.4.layer.1.layer_norm',
                        'l_20': 'decoder.block.4.layer.1.EncDecAttention.q',
                        'l_21': 'decoder.block.4.layer.1.EncDecAttention.k',
                        'l_22': 'decoder.block.4.layer.1.EncDecAttention.v',
                        'l_23': 'decoder.block.4.layer.1.EncDecAttention.o',
                        'l_24': 'decoder.block.4.layer.1.dropout',
                        'l_25': 'decoder.block.4.layer.2.layer_norm',
                        'l_26': 'decoder.block.4.layer.2.DenseReluDense.wi',
                        'l_27': 'decoder.block.4.layer.2.DenseReluDense.dropout',
                        'l_28': 'decoder.block.4.layer.2.DenseReluDense.wo',
                        'l_29': 'decoder.block.4.layer.2.dropout',
                        'l_30': 'decoder.block.5.layer.0.layer_norm',
                        'l_31': 'decoder.block.5.layer.0.SelfAttention.q',
                        'l_32': 'decoder.block.5.layer.0.SelfAttention.k',
                        'l_33': 'decoder.block.5.layer.0.SelfAttention.v',
                        'l_34': 'decoder.block.5.layer.0.SelfAttention.o',
                        'l_35': 'decoder.block.5.layer.0.dropout',
                        'l_36': 'decoder.block.5.layer.1.layer_norm',
                        'l_37': 'decoder.block.5.layer.1.EncDecAttention.q',
                        'l_38': 'decoder.block.5.layer.1.EncDecAttention.k',
                        'l_39': 'decoder.block.5.layer.1.EncDecAttention.v',
                        'l_40': 'decoder.block.5.layer.1.EncDecAttention.o',
                        'l_41': 'decoder.block.5.layer.1.dropout',
                        'l_42': 'decoder.block.5.layer.2.layer_norm',
                        'l_43': 'decoder.block.5.layer.2.DenseReluDense.wi',
                        'l_44': 'decoder.block.5.layer.2.DenseReluDense.dropout',
                        'l_45': 'decoder.block.5.layer.2.DenseReluDense.wo',
                        'l_46': 'decoder.block.5.layer.2.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_5
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_46
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[3]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___2786 <=> x3
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___2788 <=> x4
...
class Partition15(nn.Module):
    ...
    def forward(self, *args):
        ...
        # input4 <=> labels
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> x1
...
unique_stages_on_same_gpu: [{0, 15}, {1, 11}, {8, 2}, {3, 14}, {10, 4}, {13, 5}, {12, 6}, {9, 7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 2, 7, 4, 1, 6, 5, 3, 0],
...
forward {0: 159.16, 1: 151.0, 2: 150.27, 3: 150.7, 4: 150.65, 5: 150.73, 6: 152.46, 7: 155.17}
backward {0: 398.66, 1: 426.09, 2: 438.86, 3: 427.05, 4: 426.16, 5: 427.67, 6: 428.44, 7: 436.47}
...
forward {0: 0.9, 1: 0.91, 2: 0.9, 3: 0.91, 4: 0.91, 5: 0.91, 6: 0.91, 7: 0.92}
backward {0: 0.89, 1: 0.96, 2: 0.96, 3: 0.96, 4: 0.96, 5: 0.96, 6: 0.97, 7: 0.97}

worstcase: bwd: 438.860 fwd: 159.157
Expected speedup for 8 partitions is: 7.532
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'87.16 MB', recieve_time:'7.26 ms', out:'181.82 MB', send time:'15.15 ms'
1: input size:'70.39 MB', recieve_time:'5.87 ms', out:'70.39 MB', send time:'5.87 ms'
2: input size:'198.60 MB', recieve_time:'16.55 ms', out:'84.02 MB', send time:'7.00 ms'
3: input size:'70.39 MB', recieve_time:'5.87 ms', out:'70.39 MB', send time:'5.87 ms'
4: input size:'70.39 MB', recieve_time:'5.87 ms', out:'70.39 MB', send time:'5.87 ms'
5: input size:'70.39 MB', recieve_time:'5.87 ms', out:'70.39 MB', send time:'5.87 ms'
6: input size:'70.39 MB', recieve_time:'5.87 ms', out:'87.16 MB', send time:'7.26 ms'
7: input size:'100.79 MB', recieve_time:'8.40 ms', out:'103.94 MB', send time:'8.66 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.9, 1: 0.96, 2: 0.95, 3: 0.96, 4: 0.96, 5: 0.96, 6: 0.95, 7: 0.94} 
backward {0: 0.98, 1: 0.99, 2: 0.96, 3: 0.99, 4: 0.99, 5: 0.99, 6: 0.99, 7: 0.98}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 535.4,
                      ...
                      7: 574.58,
                      'worstcase': 574.58},
 'pipeline_vs_seq_no_comm': 5.89,
 'pipeline_with_non_parallel_comm': {0: 557.82,
                                     1: 577.09,
                                     2: 589.13,
                                     3: 577.75,
                                     4: 576.81,
                                     ...
                                     7: 591.64,
                                     'worstcase': 591.64},
 'seq_no_comm_no_recomp': {0: 339.25,
                           1: 335.42,
                           2: 335.33,
                           3: 335.52,
                           4: 335.09,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.662
Analysis max cuda memory used 4.59GB
"""