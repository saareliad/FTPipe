"""AutoGenerated with:
python -m autopipe.partition new_t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 64 --partitioning_batch_size 64 --ct new_trace_cache_t53b_64_4_op --cp new_prof_cache_t53b_64_4_op_ftpipe --stateless_tied --lmhead --n_partitions 8 --L 8 16 24 --max_seq_length 64 --answer_max_seq_length 4 --partitioning_method mpipe --preset ftpipe --dont_use_async_meta_alg --save_memory_mode --special_blocks T5Block --output_file op_
"""
import math
import torch
...
# partition adjacency
# model inputs {0, 8, 15}
# partition 0 {'inputs': {'decoder_attention_mask', 'attention_mask', 'input_ids', 'decoder_input_ids'}, 'outputs': {8, 1}}
...
# partition 15 {'inputs': {8, 'labels', 14, 7}, 'outputs': {'output'}}
# model outputs {15}
...
def create_pipeline_configuration(DEBUG=False, batch_size=64):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (T5LayerNorm,Dropout,StatelessEmbedding,Embedding,Linear),
        'model_inputs': {
            'attention_mask': {
...
class Partition0(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:0'):
        ...
        self.lookup = {'l_0': 'encoder.embed_tokens',
                        ...
                        'l_38': 'decoder.block.0.layer.0.layer_norm',
                        'l_39': 'decoder.block.0.layer.0.SelfAttention.q',
                        'l_40': 'decoder.block.0.layer.0.SelfAttention.k',
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_40
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q]
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k]
        return list(flatten((t_3, t_2, t_1, t_6, t_0, t_4, t_9)))
...
class Partition1(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:1'):
        ...
        self.lookup = {'l_0': 'encoder.block.3.layer.0.layer_norm',
                        ...
                        'l_33': 'encoder.block.6.layer.0.layer_norm'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_33
...
class Partition2(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:2'):
        ...
        self.lookup = {'l_0': 'encoder.block.6.layer.0.SelfAttention.q',
                        'l_1': 'encoder.block.6.layer.0.SelfAttention.k',
                        'l_2': 'encoder.block.6.layer.0.SelfAttention.v',
                        'l_3': 'encoder.block.6.layer.0.SelfAttention.o',
                        'l_4': 'encoder.block.6.layer.0.dropout',
                        'l_5': 'encoder.block.6.layer.1.layer_norm',
                        'l_6': 'encoder.block.6.layer.1.DenseReluDense.wi',
                        'l_7': 'encoder.block.6.layer.1.DenseReluDense.dropout',
                        'l_8': 'encoder.block.6.layer.1.DenseReluDense.wo',
                        'l_9': 'encoder.block.6.layer.1.dropout',
                        'l_10': 'encoder.block.7.layer.0.layer_norm',
                        'l_11': 'encoder.block.7.layer.0.SelfAttention.q',
                        'l_12': 'encoder.block.7.layer.0.SelfAttention.k',
                        'l_13': 'encoder.block.7.layer.0.SelfAttention.v',
                        'l_14': 'encoder.block.7.layer.0.SelfAttention.o',
                        'l_15': 'encoder.block.7.layer.0.dropout',
                        'l_16': 'encoder.block.7.layer.1.layer_norm',
                        'l_17': 'encoder.block.7.layer.1.DenseReluDense.wi',
                        'l_18': 'encoder.block.7.layer.1.DenseReluDense.dropout',
                        'l_19': 'encoder.block.7.layer.1.DenseReluDense.wo',
                        'l_20': 'encoder.block.7.layer.1.dropout',
                        'l_21': 'encoder.block.8.layer.0.layer_norm',
                        'l_22': 'encoder.block.8.layer.0.SelfAttention.q',
                        'l_23': 'encoder.block.8.layer.0.SelfAttention.k',
                        'l_24': 'encoder.block.8.layer.0.SelfAttention.v',
                        'l_25': 'encoder.block.8.layer.0.SelfAttention.o',
                        'l_26': 'encoder.block.8.layer.0.dropout',
                        'l_27': 'encoder.block.8.layer.1.layer_norm',
                        'l_28': 'encoder.block.8.layer.1.DenseReluDense.wi',
                        'l_29': 'encoder.block.8.layer.1.DenseReluDense.dropout',
                        'l_30': 'encoder.block.8.layer.1.DenseReluDense.wo',
                        'l_31': 'encoder.block.8.layer.1.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___600 <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x1
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___602 <=> x2
...
class Partition3(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:3'):
        ...
        self.lookup = {'l_0': 'encoder.block.9.layer.0.layer_norm',
                        ...
                        'l_33': 'encoder.block.12.layer.0.layer_norm'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_33
...
class Partition4(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:4'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1, 1]
        self.lookup = {'l_0': 'encoder.block.12.layer.0.SelfAttention.q',
                        'l_1': 'encoder.block.12.layer.0.SelfAttention.k',
                        'l_2': 'encoder.block.12.layer.0.SelfAttention.v',
                        'l_3': 'encoder.block.12.layer.0.SelfAttention.o',
                        'l_4': 'encoder.block.12.layer.0.dropout',
                        'l_5': 'encoder.block.12.layer.1.layer_norm',
                        'l_6': 'encoder.block.12.layer.1.DenseReluDense.wi',
                        'l_7': 'encoder.block.12.layer.1.DenseReluDense.dropout',
                        'l_8': 'encoder.block.12.layer.1.DenseReluDense.wo',
                        'l_9': 'encoder.block.12.layer.1.dropout',
                        'l_10': 'encoder.block.13.layer.0.layer_norm',
                        'l_11': 'encoder.block.13.layer.0.SelfAttention.q',
                        'l_12': 'encoder.block.13.layer.0.SelfAttention.k',
                        'l_13': 'encoder.block.13.layer.0.SelfAttention.v',
                        'l_14': 'encoder.block.13.layer.0.SelfAttention.o',
                        'l_15': 'encoder.block.13.layer.0.dropout',
                        'l_16': 'encoder.block.13.layer.1.layer_norm',
                        'l_17': 'encoder.block.13.layer.1.DenseReluDense.wi',
                        'l_18': 'encoder.block.13.layer.1.DenseReluDense.dropout',
                        'l_19': 'encoder.block.13.layer.1.DenseReluDense.wo',
                        'l_20': 'encoder.block.13.layer.1.dropout',
                        'l_21': 'encoder.block.14.layer.0.layer_norm',
                        'l_22': 'encoder.block.14.layer.0.SelfAttention.q',
                        'l_23': 'encoder.block.14.layer.0.SelfAttention.k',
                        'l_24': 'encoder.block.14.layer.0.SelfAttention.v',
                        'l_25': 'encoder.block.14.layer.0.SelfAttention.o',
                        'l_26': 'encoder.block.14.layer.0.dropout',
                        'l_27': 'encoder.block.14.layer.1.layer_norm',
                        'l_28': 'encoder.block.14.layer.1.DenseReluDense.wi',
                        'l_29': 'encoder.block.14.layer.1.DenseReluDense.dropout',
                        'l_30': 'encoder.block.14.layer.1.DenseReluDense.wo',
                        'l_31': 'encoder.block.14.layer.1.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[13]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[14]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___1134 <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[12]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x1
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___1136 <=> x2
        x0, x1, x2 = unflatten(args, self.input_structure)
        t_0 = self.l_0(x1)
        t_1 = self.l_1(x1)
        t_2 = self.l_2(x1)
...
class Partition5(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:5'):
        ...
        self.lookup = {'l_0': 'encoder.block.15.layer.0.layer_norm',
                        ...
                        'l_33': 'encoder.block.18.layer.0.layer_norm'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_33
...
class Partition6(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:6'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1, 1]
        self.lookup = {'l_0': 'encoder.block.18.layer.0.SelfAttention.q',
                        'l_1': 'encoder.block.18.layer.0.SelfAttention.k',
                        'l_2': 'encoder.block.18.layer.0.SelfAttention.v',
                        'l_3': 'encoder.block.18.layer.0.SelfAttention.o',
                        'l_4': 'encoder.block.18.layer.0.dropout',
                        'l_5': 'encoder.block.18.layer.1.layer_norm',
                        'l_6': 'encoder.block.18.layer.1.DenseReluDense.wi',
                        'l_7': 'encoder.block.18.layer.1.DenseReluDense.dropout',
                        'l_8': 'encoder.block.18.layer.1.DenseReluDense.wo',
                        'l_9': 'encoder.block.18.layer.1.dropout',
                        'l_10': 'encoder.block.19.layer.0.layer_norm',
                        'l_11': 'encoder.block.19.layer.0.SelfAttention.q',
                        'l_12': 'encoder.block.19.layer.0.SelfAttention.k',
                        'l_13': 'encoder.block.19.layer.0.SelfAttention.v',
                        'l_14': 'encoder.block.19.layer.0.SelfAttention.o',
                        'l_15': 'encoder.block.19.layer.0.dropout',
                        'l_16': 'encoder.block.19.layer.1.layer_norm',
                        'l_17': 'encoder.block.19.layer.1.DenseReluDense.wi',
                        'l_18': 'encoder.block.19.layer.1.DenseReluDense.dropout',
                        'l_19': 'encoder.block.19.layer.1.DenseReluDense.wo',
                        'l_20': 'encoder.block.19.layer.1.dropout',
                        'l_21': 'encoder.block.20.layer.0.layer_norm',
                        'l_22': 'encoder.block.20.layer.0.SelfAttention.q',
                        'l_23': 'encoder.block.20.layer.0.SelfAttention.k',
                        'l_24': 'encoder.block.20.layer.0.SelfAttention.v',
                        'l_25': 'encoder.block.20.layer.0.SelfAttention.o',
                        'l_26': 'encoder.block.20.layer.0.dropout',
                        'l_27': 'encoder.block.20.layer.1.layer_norm',
                        'l_28': 'encoder.block.20.layer.1.DenseReluDense.wi',
                        'l_29': 'encoder.block.20.layer.1.DenseReluDense.dropout',
                        'l_30': 'encoder.block.20.layer.1.DenseReluDense.wo',
                        'l_31': 'encoder.block.20.layer.1.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[19]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[20]/ModuleList[layer]/T5LayerFF[1]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___1668 <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[18]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x1
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___1670 <=> x2
        x0, x1, x2 = unflatten(args, self.input_structure)
        t_0 = self.l_0(x1)
        t_1 = self.l_1(x1)
        t_2 = self.l_2(x1)
...
class Partition8(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:8'):
        ...
        self.lookup = {'l_0': 'decoder.block.0.layer.0.SelfAttention.v',
                        'l_1': 'decoder.block.0.layer.0.SelfAttention.relative_attention_bias',
                        'l_2': 'decoder.block.0.layer.0.SelfAttention.o',
                        'l_3': 'decoder.block.0.layer.0.dropout',
                        'l_4': 'decoder.block.0.layer.1.layer_norm',
                        'l_5': 'decoder.block.0.layer.1.EncDecAttention.q',
                        'l_6': 'decoder.block.0.layer.1.EncDecAttention.k',
                        'l_7': 'decoder.block.0.layer.1.EncDecAttention.v',
                        'l_8': 'decoder.block.0.layer.1.EncDecAttention.o',
                        'l_9': 'decoder.block.0.layer.1.dropout',
                        'l_10': 'decoder.block.0.layer.2.layer_norm',
                        'l_11': 'decoder.block.0.layer.2.DenseReluDense.wi',
                        'l_12': 'decoder.block.0.layer.2.DenseReluDense.dropout',
                        'l_13': 'decoder.block.0.layer.2.DenseReluDense.wo',
                        'l_14': 'decoder.block.0.layer.2.dropout',
                        'l_15': 'decoder.block.1.layer.0.layer_norm',
                        'l_16': 'decoder.block.1.layer.0.SelfAttention.q',
                        'l_17': 'decoder.block.1.layer.0.SelfAttention.k',
                        'l_18': 'decoder.block.1.layer.0.SelfAttention.v',
                        'l_19': 'decoder.block.1.layer.0.SelfAttention.o',
                        'l_20': 'decoder.block.1.layer.0.dropout',
                        'l_21': 'decoder.block.1.layer.1.layer_norm',
                        'l_22': 'decoder.block.1.layer.1.EncDecAttention.q',
                        'l_23': 'decoder.block.1.layer.1.EncDecAttention.k',
                        'l_24': 'decoder.block.1.layer.1.EncDecAttention.v',
                        'l_25': 'decoder.block.1.layer.1.EncDecAttention.o',
                        'l_26': 'decoder.block.1.layer.1.dropout',
                        'l_27': 'decoder.block.1.layer.2.layer_norm',
                        'l_28': 'decoder.block.1.layer.2.DenseReluDense.wi',
                        'l_29': 'decoder.block.1.layer.2.DenseReluDense.dropout',
                        'l_30': 'decoder.block.1.layer.2.DenseReluDense.wo',
                        'l_31': 'decoder.block.1.layer.2.dropout',
                        'l_32': 'decoder.block.2.layer.0.layer_norm',
                        'l_33': 'decoder.block.2.layer.0.SelfAttention.q',
                        'l_34': 'decoder.block.2.layer.0.SelfAttention.k',
                        'l_35': 'decoder.block.2.layer.0.SelfAttention.v',
                        'l_36': 'decoder.block.2.layer.0.SelfAttention.o',
                        'l_37': 'decoder.block.2.layer.0.dropout',
                        'l_38': 'decoder.block.2.layer.1.layer_norm',
                        'l_39': 'decoder.block.2.layer.1.EncDecAttention.q',
                        'l_40': 'decoder.block.2.layer.1.EncDecAttention.k',
                        'l_41': 'decoder.block.2.layer.1.EncDecAttention.v',
                        'l_42': 'decoder.block.2.layer.1.EncDecAttention.o',
                        'l_43': 'decoder.block.2.layer.1.dropout',
                        'l_44': 'decoder.block.2.layer.2.layer_norm',
                        'l_45': 'decoder.block.2.layer.2.DenseReluDense.wi',
                        'l_46': 'decoder.block.2.layer.2.DenseReluDense.dropout',
                        'l_47': 'decoder.block.2.layer.2.DenseReluDense.wo',
                        'l_48': 'decoder.block.2.layer.2.dropout',
                        'l_49': 'decoder.block.21.layer.1.EncDecAttention.k'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Embedding[relative_attention_bias] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_49
        # input0 <=> attention_mask
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x3
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> x4
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> x5
        ...
        t_11 = t_9 - t_11
        t_9 = torch.zeros_like(t_11, device=self.device)
        t_9 = torch.min(t_11, t_9)
        t_9 = -t_9
        t_11 = t_9.float()
        t_13 = t_9 < 16
        t_11 = t_11 / 16
        ...
        t_14 = 16 + t_14
        t_11 = torch.full_like(t_14, 31, device=self.device)
        t_11 = torch.min(t_14, t_11)
        t_11 = torch.where(t_13, t_9, t_11)
        t_11 = 0 + t_11
        ...
        t_12 = t_9.type_as(t_12)
        t_12 = torch.nn.functional.dropout(t_12, p=0.1, training=True, inplace=False)
        t_8 = torch.matmul(t_12, t_8)
        t_8 = t_8.transpose(1, 2)
        t_8 = t_8.contiguous()
        t_10 = t_8.view(t_10, -1, 4096)
        t_10 = self.l_2(t_10)
        t_8 = self.l_3(t_10)
        t_8 = x1 + t_8
        t_11 = (t_10, None, t_11)
        t_10 = t_11[0]
        t_8 = (t_8,)
        t_11 = t_11[slice(1, None, None)]
        t_11 = t_8 + t_11
        t_8 = t_11[slice(None, 2, None)]
        t_12 = t_8[0]
        t_9 = self.l_4(t_12)
        t_8 = t_8[1]
        t_11 = t_11[slice(2, None, None)]
        t_13 = self.l_5(t_9)
        t_9 = t_9.shape
        t_9 = t_9[slice(None, 2, None)]
        t_14 = t_9[0]
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___2786
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___2788
        return list(flatten((x0, t_6, t_11, t_13, t_7)))
...
class Partition9(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:9'):
        ...
        self.lookup = {'l_0': 'decoder.block.3.layer.0.layer_norm',
                        ...
                        'l_51': 'decoder.block.6.layer.0.layer_norm'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
...
class Partition10(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:10'):
        ...
        self.lookup = {'l_0': 'decoder.block.6.layer.0.SelfAttention.q',
                        'l_1': 'decoder.block.6.layer.0.SelfAttention.k',
                        'l_2': 'decoder.block.6.layer.0.SelfAttention.v',
                        'l_3': 'decoder.block.6.layer.0.SelfAttention.o',
                        'l_4': 'decoder.block.6.layer.0.dropout',
                        'l_5': 'decoder.block.6.layer.1.layer_norm',
                        'l_6': 'decoder.block.6.layer.1.EncDecAttention.q',
                        'l_7': 'decoder.block.6.layer.1.EncDecAttention.k',
                        'l_8': 'decoder.block.6.layer.1.EncDecAttention.v',
                        'l_9': 'decoder.block.6.layer.1.EncDecAttention.o',
                        'l_10': 'decoder.block.6.layer.1.dropout',
                        'l_11': 'decoder.block.6.layer.2.layer_norm',
                        'l_12': 'decoder.block.6.layer.2.DenseReluDense.wi',
                        'l_13': 'decoder.block.6.layer.2.DenseReluDense.dropout',
                        'l_14': 'decoder.block.6.layer.2.DenseReluDense.wo',
                        'l_15': 'decoder.block.6.layer.2.dropout',
                        'l_16': 'decoder.block.7.layer.0.layer_norm',
                        'l_17': 'decoder.block.7.layer.0.SelfAttention.q',
                        'l_18': 'decoder.block.7.layer.0.SelfAttention.k',
                        'l_19': 'decoder.block.7.layer.0.SelfAttention.v',
                        'l_20': 'decoder.block.7.layer.0.SelfAttention.o',
                        'l_21': 'decoder.block.7.layer.0.dropout',
                        'l_22': 'decoder.block.7.layer.1.layer_norm',
                        'l_23': 'decoder.block.7.layer.1.EncDecAttention.q',
                        'l_24': 'decoder.block.7.layer.1.EncDecAttention.k',
                        'l_25': 'decoder.block.7.layer.1.EncDecAttention.v',
                        'l_26': 'decoder.block.7.layer.1.EncDecAttention.o',
                        'l_27': 'decoder.block.7.layer.1.dropout',
                        'l_28': 'decoder.block.7.layer.2.layer_norm',
                        'l_29': 'decoder.block.7.layer.2.DenseReluDense.wi',
                        'l_30': 'decoder.block.7.layer.2.DenseReluDense.dropout',
                        'l_31': 'decoder.block.7.layer.2.DenseReluDense.wo',
                        'l_32': 'decoder.block.7.layer.2.dropout',
                        'l_33': 'decoder.block.8.layer.0.layer_norm',
                        'l_34': 'decoder.block.8.layer.0.SelfAttention.q',
                        'l_35': 'decoder.block.8.layer.0.SelfAttention.k',
                        'l_36': 'decoder.block.8.layer.0.SelfAttention.v',
                        'l_37': 'decoder.block.8.layer.0.SelfAttention.o',
                        'l_38': 'decoder.block.8.layer.0.dropout',
                        'l_39': 'decoder.block.8.layer.1.layer_norm',
                        'l_40': 'decoder.block.8.layer.1.EncDecAttention.q',
                        'l_41': 'decoder.block.8.layer.1.EncDecAttention.k',
                        'l_42': 'decoder.block.8.layer.1.EncDecAttention.v',
                        'l_43': 'decoder.block.8.layer.1.EncDecAttention.o',
                        'l_44': 'decoder.block.8.layer.1.dropout',
                        'l_45': 'decoder.block.8.layer.2.layer_norm',
                        'l_46': 'decoder.block.8.layer.2.DenseReluDense.wi',
                        'l_47': 'decoder.block.8.layer.2.DenseReluDense.dropout',
                        'l_48': 'decoder.block.8.layer.2.DenseReluDense.wo',
                        'l_49': 'decoder.block.8.layer.2.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[7]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[8]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___3267 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[6]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___3269 <=> x3
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___3271 <=> x4
...
unique_stages_on_same_gpu: [{0, 13}, {1, 11}, {8, 2}, {9, 3}, {4, 14}, {10, 5}, {12, 6}, {15, 7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 2, 3, 5, 1, 6, 0, 4, 7],
...
forward {0: 153.69, 1: 152.43, 2: 158.07, 3: 152.43, 4: 150.16, 5: 152.22, 6: 149.66, 7: 143.66}
backward {0: 425.88, 1: 426.66, 2: 434.89, 3: 427.27, 4: 427.29, 5: 427.7, 6: 427.79, 7: 400.87}
...
forward {0: 0.93, 1: 0.91, 2: 0.93, 3: 0.91, 4: 0.91, 5: 0.91, 6: 0.91, 7: 0.9}
backward {0: 0.98, 1: 0.97, 2: 0.98, 3: 0.97, 4: 0.96, 5: 0.97, 6: 0.96, 7: 0.89}

worstcase: bwd: 434.886 fwd: 158.069
Expected speedup for 8 partitions is: 7.593
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'20.05 MB', recieve_time:'1.67 ms', out:'80.88 MB', send time:'6.74 ms'
1: input size:'70.39 MB', recieve_time:'5.87 ms', out:'88.21 MB', send time:'7.35 ms'
2: input size:'94.38 MB', recieve_time:'7.86 ms', out:'137.49 MB', send time:'11.46 ms'
3: input size:'70.39 MB', recieve_time:'5.87 ms', out:'88.21 MB', send time:'7.35 ms'
4: input size:'87.16 MB', recieve_time:'7.26 ms', out:'70.39 MB', send time:'5.87 ms'
5: input size:'71.43 MB', recieve_time:'5.95 ms', out:'87.16 MB', send time:'7.26 ms'
6: input size:'88.21 MB', recieve_time:'7.35 ms', out:'70.39 MB', send time:'5.87 ms'
7: input size:'137.49 MB', recieve_time:'11.46 ms', out:'16.78 MB', send time:'1.40 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.96, 1: 0.95, 2: 0.93, 3: 0.95, 4: 0.96, 5: 0.95, 6: 0.96, 7: 0.99} 
backward {0: 1.0, 1: 0.99, 2: 0.98, 3: 0.99, 4: 0.98, 5: 0.99, 6: 0.98, 7: 0.97}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 579.56,
                                     1: 579.09,
                                     2: 592.95,
                                     3: 579.71,
                                     4: 577.45,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.728
