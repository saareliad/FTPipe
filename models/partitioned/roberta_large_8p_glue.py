...
def create_pipeline_configuration(DEBUG=False):
    basic_blocks = (Embedding,Softmax,Dropout,Tanh,LayerNorm,Linear)
    module_path = os.path.relpath(__file__).replace("/",".")[:-3]
    
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': ['torch.nn.modules.sparse.Embedding', 'torch.nn.modules.activation.Softmax', 'torch.nn.modules.dropout.Dropout', 'torch.nn.modules.activation.Tanh', 'torch.nn.modules.normalization.LayerNorm', 'torch.nn.modules.linear.Linear'],
        'model_inputs': {
            'input0': {
            ...
            2: {
                ...
                'outputs': {
                    'RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/tuple::__getitem___1016': {
                        ...
                        'dtype': torch.float32,
                        'is_batched': True},
                    'RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/Tensor::__add___1133': {
                        'shape': torch.Size([32, 128, 1024]),
                        'dtype': torch.float32,
                        'is_batched': True}}},
            3: {
...
class Partition3(nn.Module):
    ...
    def __init__(self, layers, tensors):
        ...
        self.lookup = { 'l_0': 'roberta.encoder.8.output.LayerNorm',
                        'l_1': 'roberta.encoder.9.attention.self.query',
                        'l_2': 'roberta.encoder.9.attention.self.key',
                        'l_3': 'roberta.encoder.9.attention.self.value',
                        'l_4': 'roberta.encoder.9.attention.self.softmax',
                        'l_5': 'roberta.encoder.9.attention.self.dropout',
                        'l_6': 'roberta.encoder.9.attention.output.dense',
                        'l_7': 'roberta.encoder.9.attention.output.dropout',
                        'l_8': 'roberta.encoder.9.attention.output.LayerNorm',
                        'l_9': 'roberta.encoder.9.intermediate.dense',
                        'l_10': 'roberta.encoder.9.output.dense',
                        'l_11': 'roberta.encoder.9.output.dropout',
                        'l_12': 'roberta.encoder.9.output.LayerNorm',
                        'l_13': 'roberta.encoder.10.attention.self.query',
                        'l_14': 'roberta.encoder.10.attention.self.key',
                        'l_15': 'roberta.encoder.10.attention.self.value',
                        'l_16': 'roberta.encoder.10.attention.self.softmax',
                        'l_17': 'roberta.encoder.10.attention.self.dropout',
                        ...
                        'l_24': 'roberta.encoder.10.output.LayerNorm',
                        'l_25': 'roberta.encoder.11.attention.self.query',
                        'l_26': 'roberta.encoder.11.attention.self.key',
                        'l_27': 'roberta.encoder.11.attention.self.value',
                        'l_28': 'roberta.encoder.11.attention.self.softmax',
                        'l_29': 'roberta.encoder.11.attention.self.dropout',
                        'l_30': 'roberta.encoder.11.attention.output.dense',
                        'l_31': 'roberta.encoder.11.attention.output.dropout',
                        'l_32': 'roberta.encoder.11.attention.output.LayerNorm',
                        'l_33': 'roberta.encoder.11.intermediate.dense',
                        'l_34': 'roberta.encoder.11.output.dense',
                        'l_35': 'roberta.encoder.11.output.dropout',
                        'l_36': 'roberta.encoder.11.output.LayerNorm',
                        'l_37': 'roberta.encoder.12.attention.self.key'}

    def forward(self, x0, x1):
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_0
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_1
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_2
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_3
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_4
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_5
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_6
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_7
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_8
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_9
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/Linear[dense] <=> self.l_10
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/Dropout[dropout] <=> self.l_11
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_12
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_13
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_14
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_15
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_16
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_17
        ...
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_24
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_25
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_26
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_27
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_28
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_29
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_30
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_31
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_32
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_33
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/Linear[dense] <=> self.l_34
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/Dropout[dropout] <=> self.l_35
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_36
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_37
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/tuple::__getitem___1016 <=> x0
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/Tensor::__add___1133 <=> x1
...
class Partition4(nn.Module):
    ...
    def __init__(self, layers, tensors):
        ...
        self.lookup = { 'l_0': 'roberta.encoder.12.attention.self.query',
    ...
    def forward(self, x0, x1, x2):
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_0
        ...
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[12]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> x2
...
class Partition5(nn.Module):
    ...
    def __init__(self, layers, tensors):
        ...
        self.lookup = { 'l_0': 'roberta.encoder.15.attention.self.query',
                        'l_1': 'roberta.encoder.15.attention.self.key',
    ...
    def forward(self, x0, x1, x2):
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_0
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_1
        ...
        # RobertaForSequenceClassification/RobertaModel[roberta]/BertEncoder[encoder]/BertLayer[15]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> x2
...
forward {0: 36.96, 1: 35.7, 2: 34.4, 3: 37.14, 4: 35.81, 5: 35.77, 6: 35.74, 7: 31.28}
backward {0: 96.71, 1: 98.59, 2: 98.69, 3: 99.75, 4: 98.41, 5: 98.4, 6: 98.27, 7: 95.02}
...
forward {0: 0.92, 1: 0.91, 2: 0.96, 3: 0.92, 4: 0.91, 5: 0.91, 6: 0.91, 7: 1.0} 
...
forward {0: 0.92, 1: 0.88, 2: 0.89, 3: 0.92, 4: 0.88, 5: 0.88, 6: 0.88, 7: 0.84}
backward {0: 0.97, 1: 0.96, 2: 0.96, 3: 0.98, 4: 0.96, 5: 0.96, 6: 0.96, 7: 0.92}

worstcase: bwd: 99.751 fwd: 37.138
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.602
Expected speedup for 8 partitions is: 7.493
"""