...
# partition 4 {'inputs': {'decoder_attention_mask', 3, 'inverted_encoder_attention_mask'}, 'outputs': {5}}
# partition 5 {'inputs': {'decoder_attention_mask', 3, 'inverted_encoder_attention_mask', 4}, 'outputs': {6}}
# partition 6 {'inputs': {'decoder_attention_mask', 3, 'inverted_encoder_attention_mask', 5}, 'outputs': {7}}
# partition 7 {'inputs': {3, 6, 'lm_labels', 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=32):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (CrossEntropyLoss,T5LayerNorm,Linear,StatelessEmbedding,Dropout,T5Block),
        'model_inputs': {
            'attention_mask': {
...
forward {0: 135.95, 1: 134.96, 2: 134.98, 3: 77.83, 4: 25.6, 5: 25.62, 6: 25.66, 7: 25.64}
backward {0: 388.79, 1: 387.81, 2: 387.98, 3: 226.76, 4: 72.57, 5: 72.51, 6: 72.81, 7: 75.18}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 524.74,
                                     1: 522.77,
                                     2: 522.96,
                                     3: 304.59,
                                     4: 98.17,
                                     ...
                                     7: 100.81,
                                     'worstcase': 524.74},
 'seq_no_comm_no_recomp': {0: 394.01,
                           1: 390.76,
                           2: 390.94,
                           3: 226.98,
                           4: 74.3,
...
worstcase: bwd: 388.790 fwd: 135.951
expected_speedup_compared_to_seq_no_recomp_no_comm: 3.246
