...
def create_pipeline_configuration(model,DEBUG=False,partitions_only=False):
    ...
    layer_scopes = ['GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_fc]',
    ...
    config = {0: {'inputs': ['input0'], 'outputs': ['GPT2Model/Block[2]/LayerNorm[ln_2]', 'GPT2Model/Block[2]/aten::add5567']},
            1: {'inputs': ['GPT2Model/Block[2]/LayerNorm[ln_2]', 'GPT2Model/Block[2]/aten::add5567'], 'outputs': ['GPT2Model/Block[5]/MLP[mlp]/aten::mul6485', 'GPT2Model/Block[5]/aten::add6437']},
            2: {'inputs': ['GPT2Model/Block[5]/MLP[mlp]/aten::mul6485', 'GPT2Model/Block[5]/aten::add6437'], 'outputs': ['GPT2Model/Block[8]/aten::add7383']},
            3: {'inputs': ['GPT2Model/Block[8]/aten::add7383'], 'outputs': ['GPT2Model/prim::TupleConstruct4140']}
            }
...
class Partition1(nn.Module):
    def __init__(self, layers, tensors):
        ...
        self.l_0 = layers['GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_fc]']
        assert isinstance(self.l_0,Conv1D) ,f'layers[GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_fc]] is expected to be of type Conv1D but was of type {type(self.l_0)}'
        # GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_proj]
        self.l_1 = layers['GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_proj]']
        assert isinstance(self.l_1,Conv1D) ,f'layers[GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_1)}'
        # GPT2Model/Block[2]/MLP[mlp]/Dropout[dropout]
        self.l_2 = layers['GPT2Model/Block[2]/MLP[mlp]/Dropout[dropout]']
        assert isinstance(self.l_2,Dropout) ,f'layers[GPT2Model/Block[2]/MLP[mlp]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_2)}'
        # GPT2Model/Block[3]/LayerNorm[ln_1]
        self.l_3 = layers['GPT2Model/Block[3]/LayerNorm[ln_1]']
        assert isinstance(self.l_3,LayerNorm) ,f'layers[GPT2Model/Block[3]/LayerNorm[ln_1]] is expected to be of type LayerNorm but was of type {type(self.l_3)}'
        # GPT2Model/Block[3]/Attention[attn]/Conv1D[c_attn]
        self.l_4 = layers['GPT2Model/Block[3]/Attention[attn]/Conv1D[c_attn]']
        assert isinstance(self.l_4,Conv1D) ,f'layers[GPT2Model/Block[3]/Attention[attn]/Conv1D[c_attn]] is expected to be of type Conv1D but was of type {type(self.l_4)}'
        # GPT2Model/Block[3]/Attention[attn]/Dropout[attn_dropout]
        self.l_5 = layers['GPT2Model/Block[3]/Attention[attn]/Dropout[attn_dropout]']
        assert isinstance(self.l_5,Dropout) ,f'layers[GPT2Model/Block[3]/Attention[attn]/Dropout[attn_dropout]] is expected to be of type Dropout but was of type {type(self.l_5)}'
        # GPT2Model/Block[3]/Attention[attn]/Conv1D[c_proj]
        self.l_6 = layers['GPT2Model/Block[3]/Attention[attn]/Conv1D[c_proj]']
        assert isinstance(self.l_6,Conv1D) ,f'layers[GPT2Model/Block[3]/Attention[attn]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_6)}'
        # GPT2Model/Block[3]/Attention[attn]/Dropout[resid_dropout]
        self.l_7 = layers['GPT2Model/Block[3]/Attention[attn]/Dropout[resid_dropout]']
        assert isinstance(self.l_7,Dropout) ,f'layers[GPT2Model/Block[3]/Attention[attn]/Dropout[resid_dropout]] is expected to be of type Dropout but was of type {type(self.l_7)}'
        # GPT2Model/Block[3]/LayerNorm[ln_2]
        self.l_8 = layers['GPT2Model/Block[3]/LayerNorm[ln_2]']
        assert isinstance(self.l_8,LayerNorm) ,f'layers[GPT2Model/Block[3]/LayerNorm[ln_2]] is expected to be of type LayerNorm but was of type {type(self.l_8)}'
        # GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_fc]
        self.l_9 = layers['GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_fc]']
        assert isinstance(self.l_9,Conv1D) ,f'layers[GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_fc]] is expected to be of type Conv1D but was of type {type(self.l_9)}'
        # GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_proj]
        self.l_10 = layers['GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_proj]']
        assert isinstance(self.l_10,Conv1D) ,f'layers[GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_10)}'
        # GPT2Model/Block[3]/MLP[mlp]/Dropout[dropout]
        self.l_11 = layers['GPT2Model/Block[3]/MLP[mlp]/Dropout[dropout]']
        assert isinstance(self.l_11,Dropout) ,f'layers[GPT2Model/Block[3]/MLP[mlp]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_11)}'
        # GPT2Model/Block[4]/LayerNorm[ln_1]
        self.l_12 = layers['GPT2Model/Block[4]/LayerNorm[ln_1]']
        assert isinstance(self.l_12,LayerNorm) ,f'layers[GPT2Model/Block[4]/LayerNorm[ln_1]] is expected to be of type LayerNorm but was of type {type(self.l_12)}'
        # GPT2Model/Block[4]/Attention[attn]/Conv1D[c_attn]
        self.l_13 = layers['GPT2Model/Block[4]/Attention[attn]/Conv1D[c_attn]']
        assert isinstance(self.l_13,Conv1D) ,f'layers[GPT2Model/Block[4]/Attention[attn]/Conv1D[c_attn]] is expected to be of type Conv1D but was of type {type(self.l_13)}'
        # GPT2Model/Block[4]/Attention[attn]/Dropout[attn_dropout]
        self.l_14 = layers['GPT2Model/Block[4]/Attention[attn]/Dropout[attn_dropout]']
        assert isinstance(self.l_14,Dropout) ,f'layers[GPT2Model/Block[4]/Attention[attn]/Dropout[attn_dropout]] is expected to be of type Dropout but was of type {type(self.l_14)}'
        # GPT2Model/Block[4]/Attention[attn]/Conv1D[c_proj]
        self.l_15 = layers['GPT2Model/Block[4]/Attention[attn]/Conv1D[c_proj]']
        assert isinstance(self.l_15,Conv1D) ,f'layers[GPT2Model/Block[4]/Attention[attn]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_15)}'
        # GPT2Model/Block[4]/Attention[attn]/Dropout[resid_dropout]
        self.l_16 = layers['GPT2Model/Block[4]/Attention[attn]/Dropout[resid_dropout]']
        assert isinstance(self.l_16,Dropout) ,f'layers[GPT2Model/Block[4]/Attention[attn]/Dropout[resid_dropout]] is expected to be of type Dropout but was of type {type(self.l_16)}'
        # GPT2Model/Block[4]/LayerNorm[ln_2]
        self.l_17 = layers['GPT2Model/Block[4]/LayerNorm[ln_2]']
        assert isinstance(self.l_17,LayerNorm) ,f'layers[GPT2Model/Block[4]/LayerNorm[ln_2]] is expected to be of type LayerNorm but was of type {type(self.l_17)}'
        # GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_fc]
        self.l_18 = layers['GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_fc]']
        assert isinstance(self.l_18,Conv1D) ,f'layers[GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_fc]] is expected to be of type Conv1D but was of type {type(self.l_18)}'
        # GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_proj]
        self.l_19 = layers['GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_proj]']
        assert isinstance(self.l_19,Conv1D) ,f'layers[GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_19)}'
        # GPT2Model/Block[4]/MLP[mlp]/Dropout[dropout]
        self.l_20 = layers['GPT2Model/Block[4]/MLP[mlp]/Dropout[dropout]']
        assert isinstance(self.l_20,Dropout) ,f'layers[GPT2Model/Block[4]/MLP[mlp]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_20)}'
        # GPT2Model/Block[5]/LayerNorm[ln_1]
        self.l_21 = layers['GPT2Model/Block[5]/LayerNorm[ln_1]']
        assert isinstance(self.l_21,LayerNorm) ,f'layers[GPT2Model/Block[5]/LayerNorm[ln_1]] is expected to be of type LayerNorm but was of type {type(self.l_21)}'
        # GPT2Model/Block[5]/Attention[attn]/Conv1D[c_attn]
        self.l_22 = layers['GPT2Model/Block[5]/Attention[attn]/Conv1D[c_attn]']
        assert isinstance(self.l_22,Conv1D) ,f'layers[GPT2Model/Block[5]/Attention[attn]/Conv1D[c_attn]] is expected to be of type Conv1D but was of type {type(self.l_22)}'
        # GPT2Model/Block[5]/Attention[attn]/Dropout[attn_dropout]
        self.l_23 = layers['GPT2Model/Block[5]/Attention[attn]/Dropout[attn_dropout]']
        assert isinstance(self.l_23,Dropout) ,f'layers[GPT2Model/Block[5]/Attention[attn]/Dropout[attn_dropout]] is expected to be of type Dropout but was of type {type(self.l_23)}'
        # GPT2Model/Block[5]/Attention[attn]/Conv1D[c_proj]
        self.l_24 = layers['GPT2Model/Block[5]/Attention[attn]/Conv1D[c_proj]']
        assert isinstance(self.l_24,Conv1D) ,f'layers[GPT2Model/Block[5]/Attention[attn]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_24)}'
        # GPT2Model/Block[5]/Attention[attn]/Dropout[resid_dropout]
        self.l_25 = layers['GPT2Model/Block[5]/Attention[attn]/Dropout[resid_dropout]']
        assert isinstance(self.l_25,Dropout) ,f'layers[GPT2Model/Block[5]/Attention[attn]/Dropout[resid_dropout]] is expected to be of type Dropout but was of type {type(self.l_25)}'
        # GPT2Model/Block[5]/LayerNorm[ln_2]
        self.l_26 = layers['GPT2Model/Block[5]/LayerNorm[ln_2]']
        assert isinstance(self.l_26,LayerNorm) ,f'layers[GPT2Model/Block[5]/LayerNorm[ln_2]] is expected to be of type LayerNorm but was of type {type(self.l_26)}'
        # GPT2Model/Block[5]/MLP[mlp]/Conv1D[c_fc]
        self.l_27 = layers['GPT2Model/Block[5]/MLP[mlp]/Conv1D[c_fc]']
        assert isinstance(self.l_27,Conv1D) ,f'layers[GPT2Model/Block[5]/MLP[mlp]/Conv1D[c_fc]] is expected to be of type Conv1D but was of type {type(self.l_27)}'
        ...
        self.lookup = { 'l_0': '2.mlp.c_fc',
                        'l_1': '2.mlp.c_proj',
                        'l_2': '2.mlp.dropout',
                        'l_3': '3.ln_1',
                        'l_4': '3.attn.c_attn',
                        'l_5': '3.attn.attn_dropout',
                        'l_6': '3.attn.c_proj',
                        'l_7': '3.attn.resid_dropout',
                        'l_8': '3.ln_2',
                        'l_9': '3.mlp.c_fc',
                        'l_10': '3.mlp.c_proj',
                        'l_11': '3.mlp.dropout',
                        'l_12': '4.ln_1',
                        'l_13': '4.attn.c_attn',
                        'l_14': '4.attn.attn_dropout',
                        'l_15': '4.attn.c_proj',
                        'l_16': '4.attn.resid_dropout',
                        'l_17': '4.ln_2',
                        'l_18': '4.mlp.c_fc',
                        'l_19': '4.mlp.c_proj',
                        'l_20': '4.mlp.dropout',
                        'l_21': '5.ln_1',
                        'l_22': '5.attn.c_attn',
                        'l_23': '5.attn.attn_dropout',
                        'l_24': '5.attn.c_proj',
                        'l_25': '5.attn.resid_dropout',
                        'l_26': '5.ln_2',
                        'l_27': '5.mlp.c_fc',
                        'b_0': '3.attn.bias',
                        'b_1': '4.attn.bias',
    ...
    def forward(self, x0, x1):
        # GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_fc] <=> self.l_0
        # GPT2Model/Block[2]/MLP[mlp]/Conv1D[c_proj] <=> self.l_1
        # GPT2Model/Block[2]/MLP[mlp]/Dropout[dropout] <=> self.l_2
        # GPT2Model/Block[3]/LayerNorm[ln_1] <=> self.l_3
        # GPT2Model/Block[3]/Attention[attn]/Conv1D[c_attn] <=> self.l_4
        # GPT2Model/Block[3]/Attention[attn]/Dropout[attn_dropout] <=> self.l_5
        # GPT2Model/Block[3]/Attention[attn]/Conv1D[c_proj] <=> self.l_6
        # GPT2Model/Block[3]/Attention[attn]/Dropout[resid_dropout] <=> self.l_7
        # GPT2Model/Block[3]/LayerNorm[ln_2] <=> self.l_8
        # GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_fc] <=> self.l_9
        # GPT2Model/Block[3]/MLP[mlp]/Conv1D[c_proj] <=> self.l_10
        # GPT2Model/Block[3]/MLP[mlp]/Dropout[dropout] <=> self.l_11
        # GPT2Model/Block[4]/LayerNorm[ln_1] <=> self.l_12
        # GPT2Model/Block[4]/Attention[attn]/Conv1D[c_attn] <=> self.l_13
        # GPT2Model/Block[4]/Attention[attn]/Dropout[attn_dropout] <=> self.l_14
        # GPT2Model/Block[4]/Attention[attn]/Conv1D[c_proj] <=> self.l_15
        # GPT2Model/Block[4]/Attention[attn]/Dropout[resid_dropout] <=> self.l_16
        # GPT2Model/Block[4]/LayerNorm[ln_2] <=> self.l_17
        # GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_fc] <=> self.l_18
        # GPT2Model/Block[4]/MLP[mlp]/Conv1D[c_proj] <=> self.l_19
        # GPT2Model/Block[4]/MLP[mlp]/Dropout[dropout] <=> self.l_20
        # GPT2Model/Block[5]/LayerNorm[ln_1] <=> self.l_21
        # GPT2Model/Block[5]/Attention[attn]/Conv1D[c_attn] <=> self.l_22
        # GPT2Model/Block[5]/Attention[attn]/Dropout[attn_dropout] <=> self.l_23
        # GPT2Model/Block[5]/Attention[attn]/Conv1D[c_proj] <=> self.l_24
        # GPT2Model/Block[5]/Attention[attn]/Dropout[resid_dropout] <=> self.l_25
        # GPT2Model/Block[5]/LayerNorm[ln_2] <=> self.l_26
        # GPT2Model/Block[5]/MLP[mlp]/Conv1D[c_fc] <=> self.l_27
        ...
        # GPT2Model/Block[2]/LayerNorm[ln_2] <=> x0
...
class Partition2(nn.Module):
    def __init__(self, layers, tensors):
        ...
        # GPT2Model/Block[8]/LayerNorm[ln_2]
        self.l_25 = layers['GPT2Model/Block[8]/LayerNorm[ln_2]']
        assert isinstance(self.l_25,LayerNorm) ,f'layers[GPT2Model/Block[8]/LayerNorm[ln_2]] is expected to be of type LayerNorm but was of type {type(self.l_25)}'
        # GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_fc]
        self.l_26 = layers['GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_fc]']
        assert isinstance(self.l_26,Conv1D) ,f'layers[GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_fc]] is expected to be of type Conv1D but was of type {type(self.l_26)}'
        # GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_proj]
        self.l_27 = layers['GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_proj]']
        assert isinstance(self.l_27,Conv1D) ,f'layers[GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_proj]] is expected to be of type Conv1D but was of type {type(self.l_27)}'
        # GPT2Model/Block[8]/MLP[mlp]/Dropout[dropout]
        self.l_28 = layers['GPT2Model/Block[8]/MLP[mlp]/Dropout[dropout]']
        assert isinstance(self.l_28,Dropout) ,f'layers[GPT2Model/Block[8]/MLP[mlp]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_28)}'
    ...
    def forward(self, x0, x1):
        ...
        # GPT2Model/Block[8]/LayerNorm[ln_2] <=> self.l_25
        # GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_fc] <=> self.l_26
        # GPT2Model/Block[8]/MLP[mlp]/Conv1D[c_proj] <=> self.l_27
        # GPT2Model/Block[8]/MLP[mlp]/Dropout[dropout] <=> self.l_28
...
class Partition3(nn.Module):
    ...
    def forward(self, x0):
        ...
        t_22 = Tensor.split(self.l_19(self.l_18(t_21)), split_size=768, dim=2)
        t_23 = t_22[0]
        t_24 = t_22[1]
        t_25 = t_22[2]
        # calling torch.div with arguments:
        ...
        t_29 = Tensor.contiguous(Tensor.permute(Tensor.matmul(self.l_20(Tensor.softmax(torch.sub(input=torch.mul(input=t_26, other=t_28), other=torch.mul(input=torch.rsub(t_28, other=1, alpha=1), other=10000.0)), dim=-1, dtype=None)), other=Tensor.permute(Tensor.view(t_25, size=[Tensor.size(t_25, dim=0), Tensor.size(t_25, dim=1), 12, torch.div(input=Tensor.size(t_25, dim=-1), other=12)]), dims=[0, 2, 1, 3])), dims=[0, 2, 1, 3]))
        # calling torch.add with arguments:
