"""AutoGenerated with:
python /home/saareliad/workspace/FTPipe/autopipe/partition.py bert_squad --n_partitions 8 --partitioning_batch_size 24 --analysis_batch_size 24 --n_iter 10 --model_name_or_path bert-large-uncased-whole-word-masking --do_lower_case --train_file /home_local/saareliad/data/squad1/train-v1.1.json --max_seq_length 384 --doc_stride 128 --partitioning_method pipedream --preset ftpipe
"""
...
# partition adjacency
# model inputs {0}
# partition 0 {'inputs': {'attention_mask', 'token_type_ids', 'input_ids'}, 'outputs': {1, 2, 3, 4, 5, 6, 7}}
...
# partition 7 {'inputs': {0, 6}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=24):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Dropout,Linear,LayerNorm,Tanh,Softmax,Embedding,Gelu),
        'model_inputs': {
            'attention_mask': {
            ...
            0: {
                ...
                'inputs': {
                    ...
                    'token_type_ids': {
                        ...
                        'created_by': -1}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_1': {
            ...
            1: {
                ...
                'inputs': {
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[2]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn]': {
                        ...
                        'created_by': 0}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_2': {
                        'shape': torch.Size([24, 1, 1, 384]),
                        'dtype': torch.float32,
                        'req_grad': False,
                        'is_batched': True,
            ...
            2: {
                ...
                'inputs': {
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn]': {
                        ...
                        'created_by': 1}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_3': {
                        'shape': torch.Size([24, 1, 1, 384]),
                        'dtype': torch.float32,
                        'req_grad': False,
                        'is_batched': True,
            ...
            3: {
                ...
                'inputs': {
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertIntermediate[intermediate]/Linear[dense]': {
                        ...
                        'created_by': 2}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_4': {
                        'shape': torch.Size([24, 1, 1, 384]),
                        'dtype': torch.float32,
                        'req_grad': False,
                        'is_batched': True,
            ...
            4: {
                ...
                'inputs': {
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense]': {
                        ...
                        'created_by': 3}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_5': {
                        'shape': torch.Size([24, 1, 1, 384]),
                        'dtype': torch.float32,
                        'req_grad': False,
                        'is_batched': True,
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertOutput[output]/LayerNorm[LayerNorm]': {
                        ...
                        'is_batched': True,
                        'used_by': [5]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_1484': {
            ...
            5: {
                ...
                'inputs': {
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_1484': {
                        ...
                        'created_by': 4}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_6': {
                        'shape': torch.Size([24, 1, 1, 384]),
                        'dtype': torch.float32,
                        'req_grad': False,
                        'is_batched': True,
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/LayerNorm[LayerNorm]': {
                        ...
                        'is_batched': True,
                        'used_by': [6]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1770': {
                        'shape': torch.Size([24, 16, 384, 64]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
            ...
            6: {
                ...
                'inputs': {
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax]': {
                        ...
                        'created_by': 5}},
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12_7': {
                        'shape': torch.Size([24, 1, 1, 384]),
                        'dtype': torch.float32,
                        'req_grad': False,
                        'is_batched': True,
                    ...
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/LayerNorm[LayerNorm]': {
                        ...
                        'is_batched': True,
                        'used_by': [7]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_2067': {
                        'shape': torch.Size([24, 16, 384, 64]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [7]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_2071': {
                        'shape': torch.Size([24, 16, 384, 384]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
...
class Partition1(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:1'):
        ...
        self.lookup = {'l_0': 'bert.encoder.2.output.dense',
                        ...
                        'l_12': 'bert.encoder.3.intermediate.intermediate_act_fn',
                        'l_13': 'bert.encoder.3.output.dense',
                        'l_14': 'bert.encoder.3.output.dropout',
                        'l_15': 'bert.encoder.3.output.LayerNorm',
                        'l_16': 'bert.encoder.4.attention.self.query',
                        'l_17': 'bert.encoder.4.attention.self.key',
                        'l_18': 'bert.encoder.4.attention.self.value',
                        'l_19': 'bert.encoder.4.attention.self.softmax',
                        'l_20': 'bert.encoder.4.attention.self.dropout',
                        'l_21': 'bert.encoder.4.attention.output.dense',
                        'l_22': 'bert.encoder.4.attention.output.dropout',
                        'l_23': 'bert.encoder.4.attention.output.LayerNorm',
                        'l_24': 'bert.encoder.4.intermediate.dense',
                        'l_25': 'bert.encoder.4.intermediate.intermediate_act_fn',
                        ...
                        'l_38': 'bert.encoder.5.intermediate.intermediate_act_fn'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[3]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_12
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[3]/BertOutput[output]/Linear[dense] <=> self.l_13
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[3]/BertOutput[output]/Dropout[dropout] <=> self.l_14
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[3]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_15
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_16
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertOutput[output]/Linear[dense] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertOutput[output]/Dropout[dropout] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[4]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_38
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[2]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[2]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> x2
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm]
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn]
        return list(flatten((x0, t_0, t_7)))
...
class Partition2(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:2'):
        ...
        self.lookup = {'l_0': 'bert.encoder.5.output.dense',
                        ...
                        'l_12': 'bert.encoder.6.intermediate.intermediate_act_fn',
                        'l_13': 'bert.encoder.6.output.dense',
                        'l_14': 'bert.encoder.6.output.dropout',
                        'l_15': 'bert.encoder.6.output.LayerNorm',
                        'l_16': 'bert.encoder.7.attention.self.query',
                        'l_17': 'bert.encoder.7.attention.self.key',
                        'l_18': 'bert.encoder.7.attention.self.value',
                        'l_19': 'bert.encoder.7.attention.self.softmax',
                        'l_20': 'bert.encoder.7.attention.self.dropout',
                        'l_21': 'bert.encoder.7.attention.output.dense',
                        'l_22': 'bert.encoder.7.attention.output.dropout',
                        'l_23': 'bert.encoder.7.attention.output.LayerNorm',
                        'l_24': 'bert.encoder.7.intermediate.dense',
                        'l_25': 'bert.encoder.7.intermediate.intermediate_act_fn',
                        'l_26': 'bert.encoder.7.output.dense',
                        'l_27': 'bert.encoder.7.output.dropout',
                        'l_28': 'bert.encoder.7.output.LayerNorm',
                        'l_29': 'bert.encoder.8.attention.self.query',
                        'l_30': 'bert.encoder.8.attention.self.key',
                        'l_31': 'bert.encoder.8.attention.self.value',
                        'l_32': 'bert.encoder.8.attention.self.softmax',
                        'l_33': 'bert.encoder.8.attention.self.dropout',
                        'l_34': 'bert.encoder.8.attention.output.dense',
                        'l_35': 'bert.encoder.8.attention.output.dropout',
                        'l_36': 'bert.encoder.8.attention.output.LayerNorm',
                        'l_37': 'bert.encoder.8.intermediate.dense'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[6]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_12
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[6]/BertOutput[output]/Linear[dense] <=> self.l_13
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[6]/BertOutput[output]/Dropout[dropout] <=> self.l_14
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[6]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_15
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_16
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertOutput[output]/Linear[dense] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertOutput[output]/Dropout[dropout] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[7]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> x2
        x0, x1, x2 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x2)
        t_0 = self.l_1(t_0)
        t_0 = t_0 + x1
...
class Partition3(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:3'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1, 1]
        self.lookup = {'l_0': 'bert.encoder.8.intermediate.intermediate_act_fn',
                        'l_1': 'bert.encoder.8.output.dense',
                        'l_2': 'bert.encoder.8.output.dropout',
                        'l_3': 'bert.encoder.8.output.LayerNorm',
                        'l_4': 'bert.encoder.9.attention.self.query',
                        'l_5': 'bert.encoder.9.attention.self.key',
                        'l_6': 'bert.encoder.9.attention.self.value',
                        'l_7': 'bert.encoder.9.attention.self.softmax',
                        'l_8': 'bert.encoder.9.attention.self.dropout',
                        'l_9': 'bert.encoder.9.attention.output.dense',
                        'l_10': 'bert.encoder.9.attention.output.dropout',
                        'l_11': 'bert.encoder.9.attention.output.LayerNorm',
                        'l_12': 'bert.encoder.9.intermediate.dense',
                        'l_13': 'bert.encoder.9.intermediate.intermediate_act_fn',
                        ...
                        'l_26': 'bert.encoder.10.intermediate.intermediate_act_fn',
                        'l_27': 'bert.encoder.10.output.dense',
                        'l_28': 'bert.encoder.10.output.dropout',
                        'l_29': 'bert.encoder.10.output.LayerNorm',
                        'l_30': 'bert.encoder.11.attention.self.query',
                        'l_31': 'bert.encoder.11.attention.self.key',
                        'l_32': 'bert.encoder.11.attention.self.value',
                        'l_33': 'bert.encoder.11.attention.self.softmax',
                        'l_34': 'bert.encoder.11.attention.self.dropout',
                        'l_35': 'bert.encoder.11.attention.output.dense'}
        self.to(self.device)

    def forward(self, *args):
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/Linear[dense] <=> self.l_1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/Dropout[dropout] <=> self.l_2
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_3
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_4
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_5
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_6
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_7
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_8
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_9
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_10
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_11
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_12
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_13
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/Linear[dense] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/Dropout[dropout] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[8]/BertIntermediate[intermediate]/Linear[dense] <=> x2
        x0, x1, x2 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x2)
        t_0 = self.l_1(t_0)
        t_0 = self.l_2(t_0)
...
class Partition4(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:4'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1, 1]
        self.lookup = {'l_0': 'bert.encoder.11.attention.output.dropout',
                        'l_1': 'bert.encoder.11.attention.output.LayerNorm',
                        'l_2': 'bert.encoder.11.intermediate.dense',
                        'l_3': 'bert.encoder.11.intermediate.intermediate_act_fn',
                        ...
                        'l_16': 'bert.encoder.12.intermediate.intermediate_act_fn',
                        'l_17': 'bert.encoder.12.output.dense',
                        'l_18': 'bert.encoder.12.output.dropout',
                        'l_19': 'bert.encoder.12.output.LayerNorm',
                        'l_20': 'bert.encoder.13.attention.self.query',
                        'l_21': 'bert.encoder.13.attention.self.key',
                        'l_22': 'bert.encoder.13.attention.self.value',
                        'l_23': 'bert.encoder.13.attention.self.softmax',
                        'l_24': 'bert.encoder.13.attention.self.dropout',
                        'l_25': 'bert.encoder.13.attention.output.dense',
                        'l_26': 'bert.encoder.13.attention.output.dropout',
                        'l_27': 'bert.encoder.13.attention.output.LayerNorm',
                        'l_28': 'bert.encoder.13.intermediate.dense',
                        'l_29': 'bert.encoder.13.intermediate.intermediate_act_fn',
                        'l_30': 'bert.encoder.13.output.dense',
                        'l_31': 'bert.encoder.13.output.dropout',
                        'l_32': 'bert.encoder.13.output.LayerNorm',
                        'l_33': 'bert.encoder.14.attention.self.query',
                        'l_34': 'bert.encoder.14.attention.self.key',
                        'l_35': 'bert.encoder.14.attention.self.value',
                        'l_36': 'bert.encoder.14.attention.self.softmax',
                        'l_37': 'bert.encoder.14.attention.self.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_2
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_3
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_16
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertOutput[output]/Linear[dense] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertOutput[output]/Dropout[dropout] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[12]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertOutput[output]/Linear[dense] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertOutput[output]/Dropout[dropout] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm] <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> x2
        x0, x1, x2 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x2)
        t_0 = t_0 + x1
        t_0 = self.l_1(t_0)
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertOutput[output]/LayerNorm[LayerNorm]
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_1484
        return list(flatten((x0, t_0, t_3)))
...
class Partition5(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:5'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1, 1]
        self.lookup = {'l_0': 'bert.encoder.14.attention.output.dense',
                        'l_1': 'bert.encoder.14.attention.output.dropout',
                        'l_2': 'bert.encoder.14.attention.output.LayerNorm',
                        'l_3': 'bert.encoder.14.intermediate.dense',
                        'l_4': 'bert.encoder.14.intermediate.intermediate_act_fn',
                        ...
                        'l_17': 'bert.encoder.15.intermediate.intermediate_act_fn',
                        'l_18': 'bert.encoder.15.output.dense',
                        'l_19': 'bert.encoder.15.output.dropout',
                        'l_20': 'bert.encoder.15.output.LayerNorm',
                        'l_21': 'bert.encoder.16.attention.self.query',
                        'l_22': 'bert.encoder.16.attention.self.key',
                        'l_23': 'bert.encoder.16.attention.self.value',
                        'l_24': 'bert.encoder.16.attention.self.softmax',
                        'l_25': 'bert.encoder.16.attention.self.dropout',
                        'l_26': 'bert.encoder.16.attention.output.dense',
                        'l_27': 'bert.encoder.16.attention.output.dropout',
                        'l_28': 'bert.encoder.16.attention.output.LayerNorm',
                        'l_29': 'bert.encoder.16.intermediate.dense',
                        'l_30': 'bert.encoder.16.intermediate.intermediate_act_fn',
                        'l_31': 'bert.encoder.16.output.dense',
                        'l_32': 'bert.encoder.16.output.dropout',
                        'l_33': 'bert.encoder.16.output.LayerNorm',
                        'l_34': 'bert.encoder.17.attention.self.query',
                        'l_35': 'bert.encoder.17.attention.self.key',
                        'l_36': 'bert.encoder.17.attention.self.value',
                        'l_37': 'bert.encoder.17.attention.self.softmax'}
        self.to(self.device)

    def forward(self, *args):
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_2
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_3
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_4
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertOutput[output]/Linear[dense] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertOutput[output]/Dropout[dropout] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[15]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/Linear[dense] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/Dropout[dropout] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[13]/BertOutput[output]/LayerNorm[LayerNorm] <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[14]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_1484 <=> x2
        x0, x1, x2 = unflatten(args,self.input_structure)
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1770
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax]
        return list(flatten((x0, t_1, t_0, t_7)))
...
class Partition6(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:6'):
        ...
        self.lookup = {'l_0': 'bert.encoder.17.attention.self.dropout',
                        'l_1': 'bert.encoder.17.attention.output.dense',
                        'l_2': 'bert.encoder.17.attention.output.dropout',
                        'l_3': 'bert.encoder.17.attention.output.LayerNorm',
                        'l_4': 'bert.encoder.17.intermediate.dense',
                        'l_5': 'bert.encoder.17.intermediate.intermediate_act_fn',
                        ...
                        'l_18': 'bert.encoder.18.intermediate.intermediate_act_fn',
                        'l_19': 'bert.encoder.18.output.dense',
                        'l_20': 'bert.encoder.18.output.dropout',
                        'l_21': 'bert.encoder.18.output.LayerNorm',
                        'l_22': 'bert.encoder.19.attention.self.query',
                        'l_23': 'bert.encoder.19.attention.self.key',
                        'l_24': 'bert.encoder.19.attention.self.value',
                        'l_25': 'bert.encoder.19.attention.self.softmax',
                        'l_26': 'bert.encoder.19.attention.self.dropout',
                        'l_27': 'bert.encoder.19.attention.output.dense',
                        'l_28': 'bert.encoder.19.attention.output.dropout',
                        'l_29': 'bert.encoder.19.attention.output.LayerNorm',
                        'l_30': 'bert.encoder.19.intermediate.dense',
                        'l_31': 'bert.encoder.19.intermediate.intermediate_act_fn',
                        'l_32': 'bert.encoder.19.output.dense',
                        'l_33': 'bert.encoder.19.output.dropout',
                        'l_34': 'bert.encoder.19.output.LayerNorm',
                        'l_35': 'bert.encoder.20.attention.self.query',
                        'l_36': 'bert.encoder.20.attention.self.key',
                        'l_37': 'bert.encoder.20.attention.self.value'}
        self.to(self.device)

    def forward(self, *args):
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_2
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_3
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_4
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_5
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertOutput[output]/Linear[dense] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertOutput[output]/Dropout[dropout] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[18]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/Linear[dense] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/Dropout[dropout] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[16]/BertOutput[output]/LayerNorm[LayerNorm] <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1770 <=> x2
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> x3
...
class Partition7(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:7'):
        ...
        self.lookup = {'l_0': 'bert.encoder.20.attention.self.softmax',
                        ...
                        'l_6': 'bert.encoder.20.intermediate.intermediate_act_fn',
                        'l_7': 'bert.encoder.20.output.dense',
                        'l_8': 'bert.encoder.20.output.dropout',
                        'l_9': 'bert.encoder.20.output.LayerNorm',
                        'l_10': 'bert.encoder.21.attention.self.query',
                        'l_11': 'bert.encoder.21.attention.self.key',
                        'l_12': 'bert.encoder.21.attention.self.value',
                        'l_13': 'bert.encoder.21.attention.self.softmax',
                        'l_14': 'bert.encoder.21.attention.self.dropout',
                        'l_15': 'bert.encoder.21.attention.output.dense',
                        'l_16': 'bert.encoder.21.attention.output.dropout',
                        'l_17': 'bert.encoder.21.attention.output.LayerNorm',
                        'l_18': 'bert.encoder.21.intermediate.dense',
                        'l_19': 'bert.encoder.21.intermediate.intermediate_act_fn',
                        ...
                        'l_32': 'bert.encoder.22.intermediate.intermediate_act_fn',
                        'l_33': 'bert.encoder.22.output.dense',
                        'l_34': 'bert.encoder.22.output.dropout',
                        'l_35': 'bert.encoder.22.output.LayerNorm',
                        'l_36': 'bert.encoder.23.attention.self.query',
                        'l_37': 'bert.encoder.23.attention.self.key',
                        'l_38': 'bert.encoder.23.attention.self.value',
                        'l_39': 'bert.encoder.23.attention.self.softmax',
                        'l_40': 'bert.encoder.23.attention.self.dropout',
                        'l_41': 'bert.encoder.23.attention.output.dense',
                        'l_42': 'bert.encoder.23.attention.output.dropout',
                        'l_43': 'bert.encoder.23.attention.output.LayerNorm',
                        'l_44': 'bert.encoder.23.intermediate.dense',
                        'l_45': 'bert.encoder.23.intermediate.intermediate_act_fn',
                        'l_46': 'bert.encoder.23.output.dense',
                        'l_47': 'bert.encoder.23.output.dropout',
                        'l_48': 'bert.encoder.23.output.LayerNorm',
                        'l_49': 'bert.pooler.dense',
                        'l_50': 'bert.pooler.activation',
                        'l_51': 'qa_outputs'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_6
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertOutput[output]/Linear[dense] <=> self.l_7
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertOutput[output]/Dropout[dropout] <=> self.l_8
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_9
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_10
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_11
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_12
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_13
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_14
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_15
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_16
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_17
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_18
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_19
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertOutput[output]/Linear[dense] <=> self.l_20
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertOutput[output]/Dropout[dropout] <=> self.l_21
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[21]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_22
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_23
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_24
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_25
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_26
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_27
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_28
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_29
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_30
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_31
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_32
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertOutput[output]/Linear[dense] <=> self.l_33
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertOutput[output]/Dropout[dropout] <=> self.l_34
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[22]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_35
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_36
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_37
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_38
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_39
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_40
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_41
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_42
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_43
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_44
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_45
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertOutput[output]/Linear[dense] <=> self.l_46
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertOutput[output]/Dropout[dropout] <=> self.l_47
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[23]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_48
        # BertForQuestionAnswering/BertModel[bert]/BertPooler[pooler]/Linear[dense] <=> self.l_49
        # BertForQuestionAnswering/BertModel[bert]/BertPooler[pooler]/Tanh[activation] <=> self.l_50
        # BertForQuestionAnswering/Linear[qa_outputs] <=> self.l_51
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[19]/BertOutput[output]/LayerNorm[LayerNorm] <=> x1
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_2067 <=> x2
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/torch::matmul_2071 <=> x3
        x0, x1, x2, x3 = unflatten(args,self.input_structure)
        t_0 = math.sqrt(64)
        t_0 = x3 / t_0
        t_0 = t_0 + x0
...
-I- Printing Report
warnings:
Partition5 output:BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[17]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_1770 is not contiguous!
Partition6 output:BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[20]/BertAttention[attention]/BertSelfAttention[self]/Tensor::permute_2067 is not contiguous!
...
forward {0: 97.46, 1: 100.93, 2: 97.73, 3: 84.55, 4: 90.26, 5: 108.87, 6: 107.72, 7: 108.75}
backward {0: 229.5, 1: 260.51, 2: 252.36, 3: 241.34, 4: 247.03, 5: 247.05, 6: 266.3, 7: 225.55}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'188.78 MB', send time:'15.73 ms'
1: input size:'188.78 MB', recieve_time:'15.73 ms', out:'188.78 MB', send time:'15.73 ms'
2: input size:'188.78 MB', recieve_time:'15.73 ms', out:'188.78 MB', send time:'15.73 ms'
3: input size:'188.78 MB', recieve_time:'15.73 ms', out:'75.53 MB', send time:'6.29 ms'
4: input size:'75.53 MB', recieve_time:'6.29 ms', out:'75.53 MB', send time:'6.29 ms'
5: input size:'75.53 MB', recieve_time:'6.29 ms', out:'302.03 MB', send time:'25.17 ms'
6: input size:'302.03 MB', recieve_time:'25.17 ms', out:'302.03 MB', send time:'25.17 ms'
7: input size:'302.03 MB', recieve_time:'25.17 ms', out:'0.07 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.84, 1: 0.84, 2: 0.84, 3: 0.93, 4: 0.93, 5: 0.77, 6: 0.77, 7: 1.0} 
backward {0: 1.0, 1: 0.94, 2: 0.94, 3: 0.93, 4: 0.97, 5: 0.97, 6: 0.91, 7: 0.89}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 326.96,
                                     1: 361.44,
                                     2: 350.09,
                                     3: 325.89,
                                     4: 337.29,
                                     ...
                                     7: 334.31,
                                     'worstcase': 374.02},
 'seq_no_comm_no_recomp': {0: 234.06,
                           1: 248.52,
                           2: 239.92,
                           3: 228.52,
                           4: 244.5,
...
forward {0: 0.75, 1: 0.79, 2: 0.76, 3: 0.72, 4: 0.77, 5: 0.77, 6: 0.76, 7: 1.0}
backward {0: 0.86, 1: 0.92, 2: 0.89, 3: 0.85, 4: 0.91, 5: 0.91, 6: 0.91, 7: 0.76}

worstcase: bwd: 266.302 fwd: 108.871
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.331
Expected speedup for 8 partitions is: 6.771
Analysis max cuda memory used 7.64GB
"""