"""AutoGenerated with:
python -m autopipe.partition new_t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 8 --partitioning_batch_size 8 --ct new_trace_cache_t53b_320_8_op --cp new_prof_cache_t53b_320_8_op_ftpipe --stateless_tied --lmhead --n_partitions 8 --L 8 16 24 --max_seq_length 320 --answer_max_seq_length 8 --partitioning_method mpipe --preset ftpipe --dont_use_async_meta_alg --save_memory_mode --special_blocks T5Block --output_file op_
"""
import torch
import math
...
def create_pipeline_configuration(DEBUG=False, batch_size=8):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Dropout,StatelessEmbedding,T5LayerNorm,Embedding,Linear),
        'model_inputs': {
            'attention_mask': {
            ...
            0: {
                ...
                'outputs': {
                    ...
                    'T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___335': {
                        ...
                        'is_batched': True,
                        'used_by': [1]},
                    'T5ForConditionalGeneration/T5Stack[decoder]/Tensor::view_2211': {
                        'shape': torch.Size([8, 8]),
                        'dtype': torch.int64,
                        'req_grad': False,
                        'is_batched': True,
...
class Partition0(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/Tensor::view_2211
        # T5ForConditionalGeneration/T5Stack[decoder]/Tensor::__mul___2239
        return list(flatten((self.p_0, t_3, t_2, t_1, t_6)))
...
class Partition8(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:8'):
        ...
        self.lookup = {'l_0': 'decoder.embed_tokens',
                        ...
                        'l_7': 'decoder.block.0.layer.0.SelfAttention.o',
                        'l_8': 'decoder.block.0.layer.0.dropout',
                        'l_9': 'decoder.block.0.layer.1.layer_norm',
                        'l_10': 'decoder.block.0.layer.1.EncDecAttention.q',
                        'l_11': 'decoder.block.0.layer.1.EncDecAttention.k',
                        'l_12': 'decoder.block.0.layer.1.EncDecAttention.v',
                        'l_13': 'decoder.block.0.layer.1.EncDecAttention.o',
                        'l_14': 'decoder.block.0.layer.1.dropout',
                        'l_15': 'decoder.block.0.layer.2.layer_norm',
                        'l_16': 'decoder.block.0.layer.2.DenseReluDense.wi',
                        'l_17': 'decoder.block.0.layer.2.DenseReluDense.dropout',
                        'l_18': 'decoder.block.0.layer.2.DenseReluDense.wo',
                        'l_19': 'decoder.block.0.layer.2.dropout',
                        'l_20': 'decoder.block.1.layer.0.layer_norm',
                        'l_21': 'decoder.block.1.layer.0.SelfAttention.q',
                        'l_22': 'decoder.block.1.layer.0.SelfAttention.k',
                        'l_23': 'decoder.block.1.layer.0.SelfAttention.v',
                        'l_24': 'decoder.block.1.layer.0.SelfAttention.o',
                        'l_25': 'decoder.block.1.layer.0.dropout',
                        'l_26': 'decoder.block.1.layer.1.layer_norm',
                        'l_27': 'decoder.block.1.layer.1.EncDecAttention.q',
                        'l_28': 'decoder.block.1.layer.1.EncDecAttention.k',
                        'l_29': 'decoder.block.1.layer.1.EncDecAttention.v',
                        'l_30': 'decoder.block.1.layer.1.EncDecAttention.o',
                        'l_31': 'decoder.block.1.layer.1.dropout',
                        'l_32': 'decoder.block.1.layer.2.layer_norm',
                        'l_33': 'decoder.block.1.layer.2.DenseReluDense.wi',
                        'l_34': 'decoder.block.1.layer.2.DenseReluDense.dropout',
                        'l_35': 'decoder.block.1.layer.2.DenseReluDense.wo',
                        'l_36': 'decoder.block.1.layer.2.dropout',
                        'l_37': 'decoder.block.2.layer.0.layer_norm',
                        'l_38': 'decoder.block.2.layer.0.SelfAttention.q',
                        'l_39': 'decoder.block.2.layer.0.SelfAttention.k',
                        'l_40': 'decoder.block.2.layer.0.SelfAttention.v',
                        'l_41': 'decoder.block.2.layer.0.SelfAttention.o',
                        'l_42': 'decoder.block.2.layer.0.dropout',
                        'l_43': 'decoder.block.2.layer.1.layer_norm',
                        'l_44': 'decoder.block.2.layer.1.EncDecAttention.q',
                        'l_45': 'decoder.block.2.layer.1.EncDecAttention.k',
                        'l_46': 'decoder.block.2.layer.1.EncDecAttention.v',
                        'l_47': 'decoder.block.2.layer.1.EncDecAttention.o',
                        'l_48': 'decoder.block.2.layer.1.dropout',
                        'l_49': 'decoder.block.2.layer.2.layer_norm',
                        'l_50': 'decoder.block.2.layer.2.DenseReluDense.wi',
                        'l_51': 'decoder.block.2.layer.2.DenseReluDense.dropout',
                        'l_52': 'decoder.block.2.layer.2.DenseReluDense.wo',
                        'l_53': 'decoder.block.2.layer.2.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[0]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[1]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[2]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_53
        # input0 <=> attention_mask
        # T5ForConditionalGeneration/Parameter[shared_embed_weight] <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/Tensor::view_2211 <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/Tensor::__mul___2239 <=> x3
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___2786
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___2788
        return list(flatten((x1, t_9, t_8, t_7)))
...
class Partition14(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:14'):
        ...
        self.lookup = {'l_0': 'decoder.block.18.layer.0.SelfAttention.k',
                        ...
                        'l_49': 'decoder.block.21.layer.0.layer_norm',
                        'l_50': 'decoder.block.21.layer.0.SelfAttention.q',
                        'l_51': 'decoder.block.21.layer.0.SelfAttention.k'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q]
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k]
        return list(flatten((x0, t_8, t_12, t_5, t_10, t_3, t_4)))
...
class Partition15(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:15'):
        ...
        self.lookup = {'l_0': 'decoder.block.21.layer.0.SelfAttention.v',
                        ...
                        'l_7': 'decoder.block.21.layer.1.EncDecAttention.o',
                        'l_8': 'decoder.block.21.layer.1.dropout',
                        'l_9': 'decoder.block.21.layer.2.layer_norm',
                        'l_10': 'decoder.block.21.layer.2.DenseReluDense.wi',
                        'l_11': 'decoder.block.21.layer.2.DenseReluDense.dropout',
                        'l_12': 'decoder.block.21.layer.2.DenseReluDense.wo',
                        'l_13': 'decoder.block.21.layer.2.dropout',
                        'l_14': 'decoder.block.22.layer.0.layer_norm',
                        'l_15': 'decoder.block.22.layer.0.SelfAttention.q',
                        'l_16': 'decoder.block.22.layer.0.SelfAttention.k',
                        'l_17': 'decoder.block.22.layer.0.SelfAttention.v',
                        'l_18': 'decoder.block.22.layer.0.SelfAttention.o',
                        'l_19': 'decoder.block.22.layer.0.dropout',
                        'l_20': 'decoder.block.22.layer.1.layer_norm',
                        'l_21': 'decoder.block.22.layer.1.EncDecAttention.q',
                        'l_22': 'decoder.block.22.layer.1.EncDecAttention.k',
                        'l_23': 'decoder.block.22.layer.1.EncDecAttention.v',
                        'l_24': 'decoder.block.22.layer.1.EncDecAttention.o',
                        'l_25': 'decoder.block.22.layer.1.dropout',
                        'l_26': 'decoder.block.22.layer.2.layer_norm',
                        'l_27': 'decoder.block.22.layer.2.DenseReluDense.wi',
                        'l_28': 'decoder.block.22.layer.2.DenseReluDense.dropout',
                        'l_29': 'decoder.block.22.layer.2.DenseReluDense.wo',
                        'l_30': 'decoder.block.22.layer.2.dropout',
                        'l_31': 'decoder.block.23.layer.0.layer_norm',
                        'l_32': 'decoder.block.23.layer.0.SelfAttention.q',
                        'l_33': 'decoder.block.23.layer.0.SelfAttention.k',
                        'l_34': 'decoder.block.23.layer.0.SelfAttention.v',
                        'l_35': 'decoder.block.23.layer.0.SelfAttention.o',
                        'l_36': 'decoder.block.23.layer.0.dropout',
                        'l_37': 'decoder.block.23.layer.1.layer_norm',
                        'l_38': 'decoder.block.23.layer.1.EncDecAttention.q',
                        'l_39': 'decoder.block.23.layer.1.EncDecAttention.k',
                        'l_40': 'decoder.block.23.layer.1.EncDecAttention.v',
                        'l_41': 'decoder.block.23.layer.1.EncDecAttention.o',
                        'l_42': 'decoder.block.23.layer.1.dropout',
                        'l_43': 'decoder.block.23.layer.2.layer_norm',
                        'l_44': 'decoder.block.23.layer.2.DenseReluDense.wi',
                        'l_45': 'decoder.block.23.layer.2.DenseReluDense.dropout',
                        'l_46': 'decoder.block.23.layer.2.DenseReluDense.wo',
                        'l_47': 'decoder.block.23.layer.2.dropout',
                        'l_48': 'decoder.final_layer_norm',
                        'l_49': 'decoder.dropout',
                        'l_50': 'lm_head'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_0
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/T5LayerNorm[final_layer_norm] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/Linear[lm_head] <=> self.l_50
        # input4 <=> labels
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___5682 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x2
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> x5
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> x6
        labels, x0, x1, x2, x3, x4, x5, x6 = unflatten(args, self.input_structure)
        t_0 = self.l_5(x0)
        t_1 = self.l_6(x0)
        t_2 = self.l_22(x0)
        t_3 = self.l_23(x0)
        ...
        t_7 = t_7[slice(None, 2, None)]
        t_7 = t_7[0]
        t_8 = x5.view(t_7, -1, 32, 128)
        t_8 = t_8.transpose(1, 2)
        t_9 = x6.view(t_7, -1, 32, 128)
        t_9 = t_9.transpose(1, 2)
        t_6 = t_6.view(t_7, -1, 32, 128)
        t_6 = t_6.transpose(1, 2)
        ...
        t_8 = torch.nn.functional.softmax(t_8, dim=-1, _stacklevel=3, dtype=None)
        t_9 = t_8.type_as(t_9)
        t_9 = torch.nn.functional.dropout(t_9, p=0.1, training=True, inplace=False)
        t_6 = torch.matmul(t_9, t_6)
        t_6 = t_6.transpose(1, 2)
        t_6 = t_6.contiguous()
        t_7 = t_6.view(t_7, -1, 4096)
        ...
        t_12 = t_12.transpose(1, 2)
        t_11 = t_11.transpose(3, 2)
        t_11 = torch.matmul(t_7, t_11)
        t_11 += t_1
        t_7 = t_11.float()
        t_7 = torch.nn.functional.softmax(t_7, dim=-1, _stacklevel=3, dtype=None)
        t_11 = t_7.type_as(t_11)
        t_11 = torch.nn.functional.dropout(t_11, p=0.1, training=True, inplace=False)
        t_12 = torch.matmul(t_11, t_12)
        t_12 = t_12.transpose(1, 2)
        t_12 = t_12.contiguous()
        ...
        t_5 = t_7.view(-1, t_5)
        t_7 = labels.view(-1)
        t_7 = torch.nn.functional.cross_entropy(t_5, t_7, weight=None, size_average=None, ignore_index=-100, reduce=None, reduction='mean')
        # Returning:
        # T5ForConditionalGeneration/torch.nn.functional::cross_entropy_6186
        return (t_7,)
...
unique_stages_on_same_gpu: [{0, 15}, {1, 13}, {2, 11}, {8, 3}, {10, 4}, {9, 5}, {12, 6}, {14, 7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 3, 5, 4, 2, 6, 1, 7, 0],
...
forward {0: 121.87, 1: 109.46, 2: 109.77, 3: 108.49, 4: 109.69, 5: 110.46, 6: 109.63, 7: 101.38}
backward {0: 267.89, 1: 282.78, 2: 282.53, 3: 293.09, 4: 282.58, 5: 282.09, 6: 282.43, 7: 283.59}
...
forward {0: 0.83, 1: 0.81, 2: 0.81, 3: 0.8, 4: 0.81, 5: 0.82, 6: 0.81, 7: 0.81}
backward {0: 0.91, 1: 0.92, 2: 0.92, 3: 0.93, 4: 0.92, 5: 0.92, 6: 0.92, 7: 0.93}

worstcase: bwd: 293.093 fwd: 121.869
Expected speedup for 8 partitions is: 7.117
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'15.79 MB', recieve_time:'1.32 ms', out:'246.83 MB', send time:'20.57 ms'
...
7: input size:'130.09 MB', recieve_time:'10.84 ms', out:'26.28 MB', send time:'2.19 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.83, 1: 0.9, 2: 0.9, 3: 0.9, 4: 0.9, 5: 0.9, 6: 0.9, 7: 0.98} 
backward {0: 1.0, 1: 0.96, 2: 0.96, 3: 0.93, 4: 0.96, 5: 0.96, 6: 0.96, 7: 0.96}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 367.87,
                      ...
                      7: 371.94,
                      'worstcase': 371.94},
 'pipeline_vs_seq_no_comm': 6.01,
 'pipeline_with_non_parallel_comm': {0: 389.76,
                                     1: 392.24,
                                     2: 392.29,
                                     3: 401.58,
                                     4: 392.27,
                                     ...
                                     7: 384.97,
                                     'worstcase': 401.58},
 'seq_no_comm_no_recomp': {0: 236.83,
                           1: 229.7,
                           2: 229.64,
                           3: 229.7,
                           4: 230.34,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.390
