"""AutoGenerated with:
python /home/saareliad/workspace/FTPipe/autopipe/partition.py vision --model vit_large_patch32_384_in21k_imagenet_384 --crop 384 --n_partitions 8 --partitioning_batch_size 128 --analysis_batch_size 128 --n_iter 10 -ctmp_profiles3 --save_memory_mode --bwd_to_fwd_ratio 1 --trace_on_gpu --partitioning_method ACYCLIC --multilevel --async_pipeline
"""
            ...
            4: {
                ...
                'inputs': {
                    ...
                    'VisionTransformer/ModuleList[blocks]/Block[11]/LayerNorm[norm2]': {
                        ...
                        'created_by': 3}},
                'outputs': {
                    'VisionTransformer/ModuleList[blocks]/Block[13]/Tensor::__add___762': {
                        'shape': torch.Size([128, 145, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
            ...
            6: {
                ...
                'outputs': {
                    'VisionTransformer/ModuleList[blocks]/Block[19]/Tensor::__add___1080': {
                        ...
                        'is_batched': True,
                        'used_by': [7]},
                    'VisionTransformer/ModuleList[blocks]/Block[20]/Attention[attn]/Tensor::__getattribute___1083': {
                        'shape': torch.Size([3]),
                        'dtype': torch.Size,
                        'req_grad': False,
                        'is_batched': False,
...
class Partition1(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:1'):
        ...
        self.lookup = {'l_0': 'blocks.2.mlp.fc2',
                        'l_1': 'blocks.2.mlp.drop',
                        'l_2': 'blocks.2.drop_path',
                        'l_3': 'blocks.3.norm1',
                        'l_4': 'blocks.3.attn.qkv',
                        'l_5': 'blocks.3.attn.attn_drop',
                        'l_6': 'blocks.3.attn.proj',
                        'l_7': 'blocks.3.attn.proj_drop',
                        'l_8': 'blocks.3.drop_path',
                        'l_9': 'blocks.3.norm2',
                        'l_10': 'blocks.3.mlp.fc1',
                        'l_11': 'blocks.3.mlp.act',
                        'l_12': 'blocks.3.mlp.drop',
                        'l_13': 'blocks.3.mlp.fc2',
                        'l_14': 'blocks.3.mlp.drop',
                        'l_15': 'blocks.3.drop_path',
                        'l_16': 'blocks.4.norm1',
                        'l_17': 'blocks.4.attn.qkv',
                        'l_18': 'blocks.4.attn.attn_drop',
                        'l_19': 'blocks.4.attn.proj',
                        'l_20': 'blocks.4.attn.proj_drop',
                        'l_21': 'blocks.4.drop_path',
                        'l_22': 'blocks.4.norm2',
                        'l_23': 'blocks.4.mlp.fc1',
                        'l_24': 'blocks.4.mlp.act',
                        'l_25': 'blocks.4.mlp.drop',
                        'l_26': 'blocks.4.mlp.fc2',
                        'l_27': 'blocks.4.mlp.drop',
                        'l_28': 'blocks.4.drop_path',
                        'l_29': 'blocks.5.norm1',
                        'l_30': 'blocks.5.attn.qkv',
                        'l_31': 'blocks.5.attn.attn_drop',
                        'l_32': 'blocks.5.attn.proj',
                        'l_33': 'blocks.5.attn.proj_drop',
                        'l_34': 'blocks.5.drop_path',
                        'l_35': 'blocks.5.norm2',
                        'l_36': 'blocks.5.mlp.fc1',
                        'l_37': 'blocks.5.mlp.act'}
        self.to(self.device)

    def forward(self, *args):
        # VisionTransformer/ModuleList[blocks]/Block[2]/Mlp[mlp]/Linear[fc2] <=> self.l_0
        # VisionTransformer/ModuleList[blocks]/Block[2]/Mlp[mlp]/Dropout[drop] <=> self.l_1
        # VisionTransformer/ModuleList[blocks]/Block[2]/Identity[drop_path] <=> self.l_2
        # VisionTransformer/ModuleList[blocks]/Block[3]/LayerNorm[norm1] <=> self.l_3
        # VisionTransformer/ModuleList[blocks]/Block[3]/Attention[attn]/Linear[qkv] <=> self.l_4
        # VisionTransformer/ModuleList[blocks]/Block[3]/Attention[attn]/Dropout[attn_drop] <=> self.l_5
        # VisionTransformer/ModuleList[blocks]/Block[3]/Attention[attn]/Linear[proj] <=> self.l_6
        # VisionTransformer/ModuleList[blocks]/Block[3]/Attention[attn]/Dropout[proj_drop] <=> self.l_7
        # VisionTransformer/ModuleList[blocks]/Block[3]/Identity[drop_path] <=> self.l_8
        # VisionTransformer/ModuleList[blocks]/Block[3]/LayerNorm[norm2] <=> self.l_9
        # VisionTransformer/ModuleList[blocks]/Block[3]/Mlp[mlp]/Linear[fc1] <=> self.l_10
        # VisionTransformer/ModuleList[blocks]/Block[3]/Mlp[mlp]/GELU[act] <=> self.l_11
        # VisionTransformer/ModuleList[blocks]/Block[3]/Mlp[mlp]/Dropout[drop] <=> self.l_12
        # VisionTransformer/ModuleList[blocks]/Block[3]/Mlp[mlp]/Linear[fc2] <=> self.l_13
        # VisionTransformer/ModuleList[blocks]/Block[3]/Mlp[mlp]/Dropout[drop] <=> self.l_14
        # VisionTransformer/ModuleList[blocks]/Block[3]/Identity[drop_path] <=> self.l_15
        # VisionTransformer/ModuleList[blocks]/Block[4]/LayerNorm[norm1] <=> self.l_16
        # VisionTransformer/ModuleList[blocks]/Block[4]/Attention[attn]/Linear[qkv] <=> self.l_17
        # VisionTransformer/ModuleList[blocks]/Block[4]/Attention[attn]/Dropout[attn_drop] <=> self.l_18
        # VisionTransformer/ModuleList[blocks]/Block[4]/Attention[attn]/Linear[proj] <=> self.l_19
        # VisionTransformer/ModuleList[blocks]/Block[4]/Attention[attn]/Dropout[proj_drop] <=> self.l_20
        # VisionTransformer/ModuleList[blocks]/Block[4]/Identity[drop_path] <=> self.l_21
        # VisionTransformer/ModuleList[blocks]/Block[4]/LayerNorm[norm2] <=> self.l_22
        # VisionTransformer/ModuleList[blocks]/Block[4]/Mlp[mlp]/Linear[fc1] <=> self.l_23
        # VisionTransformer/ModuleList[blocks]/Block[4]/Mlp[mlp]/GELU[act] <=> self.l_24
        # VisionTransformer/ModuleList[blocks]/Block[4]/Mlp[mlp]/Dropout[drop] <=> self.l_25
        # VisionTransformer/ModuleList[blocks]/Block[4]/Mlp[mlp]/Linear[fc2] <=> self.l_26
        # VisionTransformer/ModuleList[blocks]/Block[4]/Mlp[mlp]/Dropout[drop] <=> self.l_27
        # VisionTransformer/ModuleList[blocks]/Block[4]/Identity[drop_path] <=> self.l_28
        # VisionTransformer/ModuleList[blocks]/Block[5]/LayerNorm[norm1] <=> self.l_29
        # VisionTransformer/ModuleList[blocks]/Block[5]/Attention[attn]/Linear[qkv] <=> self.l_30
        # VisionTransformer/ModuleList[blocks]/Block[5]/Attention[attn]/Dropout[attn_drop] <=> self.l_31
        # VisionTransformer/ModuleList[blocks]/Block[5]/Attention[attn]/Linear[proj] <=> self.l_32
        # VisionTransformer/ModuleList[blocks]/Block[5]/Attention[attn]/Dropout[proj_drop] <=> self.l_33
        # VisionTransformer/ModuleList[blocks]/Block[5]/Identity[drop_path] <=> self.l_34
        # VisionTransformer/ModuleList[blocks]/Block[5]/LayerNorm[norm2] <=> self.l_35
        # VisionTransformer/ModuleList[blocks]/Block[5]/Mlp[mlp]/Linear[fc1] <=> self.l_36
        # VisionTransformer/ModuleList[blocks]/Block[5]/Mlp[mlp]/GELU[act] <=> self.l_37
        # VisionTransformer/ModuleList[blocks]/Block[2]/Tensor::__add___171 <=> x0
        # VisionTransformer/ModuleList[blocks]/Block[2]/Mlp[mlp]/Dropout[drop] <=> x1
...
class Partition2(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:2'):
        ...
        self.lookup = {'l_0': 'blocks.5.mlp.drop',
                        'l_1': 'blocks.5.mlp.fc2',
                        'l_2': 'blocks.5.mlp.drop',
                        'l_3': 'blocks.5.drop_path',
                        'l_4': 'blocks.6.norm1',
                        'l_5': 'blocks.6.attn.qkv',
                        'l_6': 'blocks.6.attn.attn_drop',
                        'l_7': 'blocks.6.attn.proj',
                        'l_8': 'blocks.6.attn.proj_drop',
                        'l_9': 'blocks.6.drop_path',
                        'l_10': 'blocks.6.norm2',
                        'l_11': 'blocks.6.mlp.fc1',
                        'l_12': 'blocks.6.mlp.act',
                        'l_13': 'blocks.6.mlp.drop',
                        'l_14': 'blocks.6.mlp.fc2',
                        'l_15': 'blocks.6.mlp.drop',
                        'l_16': 'blocks.6.drop_path',
                        'l_17': 'blocks.7.norm1',
                        'l_18': 'blocks.7.attn.qkv',
                        'l_19': 'blocks.7.attn.attn_drop',
                        'l_20': 'blocks.7.attn.proj',
                        'l_21': 'blocks.7.attn.proj_drop',
                        'l_22': 'blocks.7.drop_path',
                        'l_23': 'blocks.7.norm2',
                        'l_24': 'blocks.7.mlp.fc1',
                        'l_25': 'blocks.7.mlp.act',
                        'l_26': 'blocks.7.mlp.drop',
                        'l_27': 'blocks.7.mlp.fc2',
                        'l_28': 'blocks.7.mlp.drop',
                        'l_29': 'blocks.7.drop_path',
                        'l_30': 'blocks.8.norm1',
                        'l_31': 'blocks.8.attn.qkv',
                        'l_32': 'blocks.8.attn.attn_drop',
                        'l_33': 'blocks.8.attn.proj',
                        'l_34': 'blocks.8.attn.proj_drop',
                        'l_35': 'blocks.8.drop_path',
                        'l_36': 'blocks.8.norm2',
                        'l_37': 'blocks.8.mlp.fc1'}
        self.to(self.device)

    def forward(self, *args):
        # VisionTransformer/ModuleList[blocks]/Block[5]/Mlp[mlp]/Dropout[drop] <=> self.l_0
        # VisionTransformer/ModuleList[blocks]/Block[5]/Mlp[mlp]/Linear[fc2] <=> self.l_1
        # VisionTransformer/ModuleList[blocks]/Block[5]/Mlp[mlp]/Dropout[drop] <=> self.l_2
        # VisionTransformer/ModuleList[blocks]/Block[5]/Identity[drop_path] <=> self.l_3
        # VisionTransformer/ModuleList[blocks]/Block[6]/LayerNorm[norm1] <=> self.l_4
        # VisionTransformer/ModuleList[blocks]/Block[6]/Attention[attn]/Linear[qkv] <=> self.l_5
        # VisionTransformer/ModuleList[blocks]/Block[6]/Attention[attn]/Dropout[attn_drop] <=> self.l_6
        # VisionTransformer/ModuleList[blocks]/Block[6]/Attention[attn]/Linear[proj] <=> self.l_7
        # VisionTransformer/ModuleList[blocks]/Block[6]/Attention[attn]/Dropout[proj_drop] <=> self.l_8
        # VisionTransformer/ModuleList[blocks]/Block[6]/Identity[drop_path] <=> self.l_9
        # VisionTransformer/ModuleList[blocks]/Block[6]/LayerNorm[norm2] <=> self.l_10
        # VisionTransformer/ModuleList[blocks]/Block[6]/Mlp[mlp]/Linear[fc1] <=> self.l_11
        # VisionTransformer/ModuleList[blocks]/Block[6]/Mlp[mlp]/GELU[act] <=> self.l_12
        # VisionTransformer/ModuleList[blocks]/Block[6]/Mlp[mlp]/Dropout[drop] <=> self.l_13
        # VisionTransformer/ModuleList[blocks]/Block[6]/Mlp[mlp]/Linear[fc2] <=> self.l_14
        # VisionTransformer/ModuleList[blocks]/Block[6]/Mlp[mlp]/Dropout[drop] <=> self.l_15
        # VisionTransformer/ModuleList[blocks]/Block[6]/Identity[drop_path] <=> self.l_16
        # VisionTransformer/ModuleList[blocks]/Block[7]/LayerNorm[norm1] <=> self.l_17
        # VisionTransformer/ModuleList[blocks]/Block[7]/Attention[attn]/Linear[qkv] <=> self.l_18
        # VisionTransformer/ModuleList[blocks]/Block[7]/Attention[attn]/Dropout[attn_drop] <=> self.l_19
        # VisionTransformer/ModuleList[blocks]/Block[7]/Attention[attn]/Linear[proj] <=> self.l_20
        # VisionTransformer/ModuleList[blocks]/Block[7]/Attention[attn]/Dropout[proj_drop] <=> self.l_21
        # VisionTransformer/ModuleList[blocks]/Block[7]/Identity[drop_path] <=> self.l_22
        # VisionTransformer/ModuleList[blocks]/Block[7]/LayerNorm[norm2] <=> self.l_23
        # VisionTransformer/ModuleList[blocks]/Block[7]/Mlp[mlp]/Linear[fc1] <=> self.l_24
        # VisionTransformer/ModuleList[blocks]/Block[7]/Mlp[mlp]/GELU[act] <=> self.l_25
        # VisionTransformer/ModuleList[blocks]/Block[7]/Mlp[mlp]/Dropout[drop] <=> self.l_26
        # VisionTransformer/ModuleList[blocks]/Block[7]/Mlp[mlp]/Linear[fc2] <=> self.l_27
        # VisionTransformer/ModuleList[blocks]/Block[7]/Mlp[mlp]/Dropout[drop] <=> self.l_28
        # VisionTransformer/ModuleList[blocks]/Block[7]/Identity[drop_path] <=> self.l_29
        # VisionTransformer/ModuleList[blocks]/Block[8]/LayerNorm[norm1] <=> self.l_30
        # VisionTransformer/ModuleList[blocks]/Block[8]/Attention[attn]/Linear[qkv] <=> self.l_31
        # VisionTransformer/ModuleList[blocks]/Block[8]/Attention[attn]/Dropout[attn_drop] <=> self.l_32
        # VisionTransformer/ModuleList[blocks]/Block[8]/Attention[attn]/Linear[proj] <=> self.l_33
        # VisionTransformer/ModuleList[blocks]/Block[8]/Attention[attn]/Dropout[proj_drop] <=> self.l_34
        # VisionTransformer/ModuleList[blocks]/Block[8]/Identity[drop_path] <=> self.l_35
        # VisionTransformer/ModuleList[blocks]/Block[8]/LayerNorm[norm2] <=> self.l_36
        # VisionTransformer/ModuleList[blocks]/Block[8]/Mlp[mlp]/Linear[fc1] <=> self.l_37
        # VisionTransformer/ModuleList[blocks]/Block[5]/Tensor::__add___330 <=> x0
        # VisionTransformer/ModuleList[blocks]/Block[5]/Mlp[mlp]/GELU[act] <=> x1
        x0, x1 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x1)
        t_0 = self.l_1(t_0)
        t_0 = self.l_2(t_0)
...
class Partition3(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:3'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1]
        self.lookup = {'l_0': 'blocks.8.mlp.act',
                        'l_1': 'blocks.8.mlp.drop',
                        'l_2': 'blocks.8.mlp.fc2',
                        'l_3': 'blocks.8.mlp.drop',
                        'l_4': 'blocks.8.drop_path',
                        'l_5': 'blocks.9.norm1',
                        'l_6': 'blocks.9.attn.qkv',
                        'l_7': 'blocks.9.attn.attn_drop',
                        'l_8': 'blocks.9.attn.proj',
                        'l_9': 'blocks.9.attn.proj_drop',
                        'l_10': 'blocks.9.drop_path',
                        'l_11': 'blocks.9.norm2',
                        'l_12': 'blocks.9.mlp.fc1',
                        'l_13': 'blocks.9.mlp.act',
                        'l_14': 'blocks.9.mlp.drop',
                        'l_15': 'blocks.9.mlp.fc2',
                        'l_16': 'blocks.9.mlp.drop',
                        'l_17': 'blocks.9.drop_path',
                        'l_18': 'blocks.10.norm1',
                        'l_19': 'blocks.10.attn.qkv',
                        'l_20': 'blocks.10.attn.attn_drop',
                        'l_21': 'blocks.10.attn.proj',
                        'l_22': 'blocks.10.attn.proj_drop',
                        'l_23': 'blocks.10.drop_path',
                        'l_24': 'blocks.10.norm2',
                        'l_25': 'blocks.10.mlp.fc1',
                        'l_26': 'blocks.10.mlp.act',
                        'l_27': 'blocks.10.mlp.drop',
                        'l_28': 'blocks.10.mlp.fc2',
                        'l_29': 'blocks.10.mlp.drop',
                        'l_30': 'blocks.10.drop_path',
                        'l_31': 'blocks.11.norm1',
                        'l_32': 'blocks.11.attn.qkv',
                        'l_33': 'blocks.11.attn.attn_drop',
                        'l_34': 'blocks.11.attn.proj',
                        'l_35': 'blocks.11.attn.proj_drop',
                        'l_36': 'blocks.11.drop_path',
                        'l_37': 'blocks.11.norm2'}
        self.to(self.device)

    def forward(self, *args):
        # VisionTransformer/ModuleList[blocks]/Block[8]/Mlp[mlp]/GELU[act] <=> self.l_0
        # VisionTransformer/ModuleList[blocks]/Block[8]/Mlp[mlp]/Dropout[drop] <=> self.l_1
        # VisionTransformer/ModuleList[blocks]/Block[8]/Mlp[mlp]/Linear[fc2] <=> self.l_2
        # VisionTransformer/ModuleList[blocks]/Block[8]/Mlp[mlp]/Dropout[drop] <=> self.l_3
        # VisionTransformer/ModuleList[blocks]/Block[8]/Identity[drop_path] <=> self.l_4
        # VisionTransformer/ModuleList[blocks]/Block[9]/LayerNorm[norm1] <=> self.l_5
        # VisionTransformer/ModuleList[blocks]/Block[9]/Attention[attn]/Linear[qkv] <=> self.l_6
        # VisionTransformer/ModuleList[blocks]/Block[9]/Attention[attn]/Dropout[attn_drop] <=> self.l_7
        # VisionTransformer/ModuleList[blocks]/Block[9]/Attention[attn]/Linear[proj] <=> self.l_8
        # VisionTransformer/ModuleList[blocks]/Block[9]/Attention[attn]/Dropout[proj_drop] <=> self.l_9
        # VisionTransformer/ModuleList[blocks]/Block[9]/Identity[drop_path] <=> self.l_10
        # VisionTransformer/ModuleList[blocks]/Block[9]/LayerNorm[norm2] <=> self.l_11
        # VisionTransformer/ModuleList[blocks]/Block[9]/Mlp[mlp]/Linear[fc1] <=> self.l_12
        # VisionTransformer/ModuleList[blocks]/Block[9]/Mlp[mlp]/GELU[act] <=> self.l_13
        # VisionTransformer/ModuleList[blocks]/Block[9]/Mlp[mlp]/Dropout[drop] <=> self.l_14
        # VisionTransformer/ModuleList[blocks]/Block[9]/Mlp[mlp]/Linear[fc2] <=> self.l_15
        # VisionTransformer/ModuleList[blocks]/Block[9]/Mlp[mlp]/Dropout[drop] <=> self.l_16
        # VisionTransformer/ModuleList[blocks]/Block[9]/Identity[drop_path] <=> self.l_17
        # VisionTransformer/ModuleList[blocks]/Block[10]/LayerNorm[norm1] <=> self.l_18
        # VisionTransformer/ModuleList[blocks]/Block[10]/Attention[attn]/Linear[qkv] <=> self.l_19
        # VisionTransformer/ModuleList[blocks]/Block[10]/Attention[attn]/Dropout[attn_drop] <=> self.l_20
        # VisionTransformer/ModuleList[blocks]/Block[10]/Attention[attn]/Linear[proj] <=> self.l_21
        # VisionTransformer/ModuleList[blocks]/Block[10]/Attention[attn]/Dropout[proj_drop] <=> self.l_22
        # VisionTransformer/ModuleList[blocks]/Block[10]/Identity[drop_path] <=> self.l_23
        # VisionTransformer/ModuleList[blocks]/Block[10]/LayerNorm[norm2] <=> self.l_24
        # VisionTransformer/ModuleList[blocks]/Block[10]/Mlp[mlp]/Linear[fc1] <=> self.l_25
        # VisionTransformer/ModuleList[blocks]/Block[10]/Mlp[mlp]/GELU[act] <=> self.l_26
        # VisionTransformer/ModuleList[blocks]/Block[10]/Mlp[mlp]/Dropout[drop] <=> self.l_27
        # VisionTransformer/ModuleList[blocks]/Block[10]/Mlp[mlp]/Linear[fc2] <=> self.l_28
        # VisionTransformer/ModuleList[blocks]/Block[10]/Mlp[mlp]/Dropout[drop] <=> self.l_29
        # VisionTransformer/ModuleList[blocks]/Block[10]/Identity[drop_path] <=> self.l_30
        # VisionTransformer/ModuleList[blocks]/Block[11]/LayerNorm[norm1] <=> self.l_31
        # VisionTransformer/ModuleList[blocks]/Block[11]/Attention[attn]/Linear[qkv] <=> self.l_32
        # VisionTransformer/ModuleList[blocks]/Block[11]/Attention[attn]/Dropout[attn_drop] <=> self.l_33
        # VisionTransformer/ModuleList[blocks]/Block[11]/Attention[attn]/Linear[proj] <=> self.l_34
        # VisionTransformer/ModuleList[blocks]/Block[11]/Attention[attn]/Dropout[proj_drop] <=> self.l_35
        # VisionTransformer/ModuleList[blocks]/Block[11]/Identity[drop_path] <=> self.l_36
        # VisionTransformer/ModuleList[blocks]/Block[11]/LayerNorm[norm2] <=> self.l_37
        # VisionTransformer/ModuleList[blocks]/Block[8]/Tensor::__add___489 <=> x0
        # VisionTransformer/ModuleList[blocks]/Block[8]/Mlp[mlp]/Linear[fc1] <=> x1
        x0, x1 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x1)
        t_0 = self.l_1(t_0)
        t_0 = self.l_2(t_0)
...
class Partition4(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:4'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1]
        self.lookup = {'l_0': 'blocks.11.mlp.fc1',
                        'l_1': 'blocks.11.mlp.act',
                        'l_2': 'blocks.11.mlp.drop',
                        'l_3': 'blocks.11.mlp.fc2',
                        'l_4': 'blocks.11.mlp.drop',
                        'l_5': 'blocks.11.drop_path',
                        'l_6': 'blocks.12.norm1',
                        'l_7': 'blocks.12.attn.qkv',
                        'l_8': 'blocks.12.attn.attn_drop',
                        'l_9': 'blocks.12.attn.proj',
                        'l_10': 'blocks.12.attn.proj_drop',
                        'l_11': 'blocks.12.drop_path',
                        'l_12': 'blocks.12.norm2',
                        'l_13': 'blocks.12.mlp.fc1',
                        'l_14': 'blocks.12.mlp.act',
                        'l_15': 'blocks.12.mlp.drop',
                        'l_16': 'blocks.12.mlp.fc2',
                        'l_17': 'blocks.12.mlp.drop',
                        'l_18': 'blocks.12.drop_path',
                        'l_19': 'blocks.13.norm1',
                        'l_20': 'blocks.13.attn.qkv',
                        'l_21': 'blocks.13.attn.attn_drop',
                        'l_22': 'blocks.13.attn.proj',
                        'l_23': 'blocks.13.attn.proj_drop',
                        'l_24': 'blocks.13.drop_path',
                        'l_25': 'blocks.13.norm2',
                        'l_26': 'blocks.13.mlp.fc1',
                        'l_27': 'blocks.13.mlp.act',
                        'l_28': 'blocks.13.mlp.drop',
                        'l_29': 'blocks.13.mlp.fc2',
                        'l_30': 'blocks.13.mlp.drop',
                        'l_31': 'blocks.13.drop_path',
                        'l_32': 'blocks.14.norm1',
                        'l_33': 'blocks.14.attn.qkv',
                        'l_34': 'blocks.14.attn.attn_drop',
                        'l_35': 'blocks.14.attn.proj'}
        self.to(self.device)

    def forward(self, *args):
        # VisionTransformer/ModuleList[blocks]/Block[11]/Mlp[mlp]/Linear[fc1] <=> self.l_0
        # VisionTransformer/ModuleList[blocks]/Block[11]/Mlp[mlp]/GELU[act] <=> self.l_1
        # VisionTransformer/ModuleList[blocks]/Block[11]/Mlp[mlp]/Dropout[drop] <=> self.l_2
        # VisionTransformer/ModuleList[blocks]/Block[11]/Mlp[mlp]/Linear[fc2] <=> self.l_3
        # VisionTransformer/ModuleList[blocks]/Block[11]/Mlp[mlp]/Dropout[drop] <=> self.l_4
        # VisionTransformer/ModuleList[blocks]/Block[11]/Identity[drop_path] <=> self.l_5
        # VisionTransformer/ModuleList[blocks]/Block[12]/LayerNorm[norm1] <=> self.l_6
        # VisionTransformer/ModuleList[blocks]/Block[12]/Attention[attn]/Linear[qkv] <=> self.l_7
        # VisionTransformer/ModuleList[blocks]/Block[12]/Attention[attn]/Dropout[attn_drop] <=> self.l_8
        # VisionTransformer/ModuleList[blocks]/Block[12]/Attention[attn]/Linear[proj] <=> self.l_9
        # VisionTransformer/ModuleList[blocks]/Block[12]/Attention[attn]/Dropout[proj_drop] <=> self.l_10
        # VisionTransformer/ModuleList[blocks]/Block[12]/Identity[drop_path] <=> self.l_11
        # VisionTransformer/ModuleList[blocks]/Block[12]/LayerNorm[norm2] <=> self.l_12
        # VisionTransformer/ModuleList[blocks]/Block[12]/Mlp[mlp]/Linear[fc1] <=> self.l_13
        # VisionTransformer/ModuleList[blocks]/Block[12]/Mlp[mlp]/GELU[act] <=> self.l_14
        # VisionTransformer/ModuleList[blocks]/Block[12]/Mlp[mlp]/Dropout[drop] <=> self.l_15
        # VisionTransformer/ModuleList[blocks]/Block[12]/Mlp[mlp]/Linear[fc2] <=> self.l_16
        # VisionTransformer/ModuleList[blocks]/Block[12]/Mlp[mlp]/Dropout[drop] <=> self.l_17
        # VisionTransformer/ModuleList[blocks]/Block[12]/Identity[drop_path] <=> self.l_18
        # VisionTransformer/ModuleList[blocks]/Block[13]/LayerNorm[norm1] <=> self.l_19
        # VisionTransformer/ModuleList[blocks]/Block[13]/Attention[attn]/Linear[qkv] <=> self.l_20
        # VisionTransformer/ModuleList[blocks]/Block[13]/Attention[attn]/Dropout[attn_drop] <=> self.l_21
        # VisionTransformer/ModuleList[blocks]/Block[13]/Attention[attn]/Linear[proj] <=> self.l_22
        # VisionTransformer/ModuleList[blocks]/Block[13]/Attention[attn]/Dropout[proj_drop] <=> self.l_23
        # VisionTransformer/ModuleList[blocks]/Block[13]/Identity[drop_path] <=> self.l_24
        # VisionTransformer/ModuleList[blocks]/Block[13]/LayerNorm[norm2] <=> self.l_25
        # VisionTransformer/ModuleList[blocks]/Block[13]/Mlp[mlp]/Linear[fc1] <=> self.l_26
        # VisionTransformer/ModuleList[blocks]/Block[13]/Mlp[mlp]/GELU[act] <=> self.l_27
        # VisionTransformer/ModuleList[blocks]/Block[13]/Mlp[mlp]/Dropout[drop] <=> self.l_28
        # VisionTransformer/ModuleList[blocks]/Block[13]/Mlp[mlp]/Linear[fc2] <=> self.l_29
        # VisionTransformer/ModuleList[blocks]/Block[13]/Mlp[mlp]/Dropout[drop] <=> self.l_30
        # VisionTransformer/ModuleList[blocks]/Block[13]/Identity[drop_path] <=> self.l_31
        # VisionTransformer/ModuleList[blocks]/Block[14]/LayerNorm[norm1] <=> self.l_32
        # VisionTransformer/ModuleList[blocks]/Block[14]/Attention[attn]/Linear[qkv] <=> self.l_33
        # VisionTransformer/ModuleList[blocks]/Block[14]/Attention[attn]/Dropout[attn_drop] <=> self.l_34
        # VisionTransformer/ModuleList[blocks]/Block[14]/Attention[attn]/Linear[proj] <=> self.l_35
        # VisionTransformer/ModuleList[blocks]/Block[11]/Tensor::__add___648 <=> x0
        # VisionTransformer/ModuleList[blocks]/Block[11]/LayerNorm[norm2] <=> x1
        x0, x1 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x1)
        t_0 = self.l_1(t_0)
        t_0 = self.l_2(t_0)
...
class Partition5(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:5'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1]
        self.lookup = {'l_0': 'blocks.14.attn.proj_drop',
                        'l_1': 'blocks.14.drop_path',
                        'l_2': 'blocks.14.norm2',
                        'l_3': 'blocks.14.mlp.fc1',
                        'l_4': 'blocks.14.mlp.act',
                        'l_5': 'blocks.14.mlp.drop',
                        'l_6': 'blocks.14.mlp.fc2',
                        'l_7': 'blocks.14.mlp.drop',
                        'l_8': 'blocks.14.drop_path',
                        'l_9': 'blocks.15.norm1',
                        'l_10': 'blocks.15.attn.qkv',
                        'l_11': 'blocks.15.attn.attn_drop',
                        'l_12': 'blocks.15.attn.proj',
                        'l_13': 'blocks.15.attn.proj_drop',
                        'l_14': 'blocks.15.drop_path',
                        'l_15': 'blocks.15.norm2',
                        'l_16': 'blocks.15.mlp.fc1',
                        'l_17': 'blocks.15.mlp.act',
                        'l_18': 'blocks.15.mlp.drop',
                        'l_19': 'blocks.15.mlp.fc2',
                        'l_20': 'blocks.15.mlp.drop',
                        'l_21': 'blocks.15.drop_path',
                        'l_22': 'blocks.16.norm1',
                        'l_23': 'blocks.16.attn.qkv',
                        'l_24': 'blocks.16.attn.attn_drop',
                        'l_25': 'blocks.16.attn.proj',
                        'l_26': 'blocks.16.attn.proj_drop',
                        'l_27': 'blocks.16.drop_path',
                        'l_28': 'blocks.16.norm2',
                        'l_29': 'blocks.16.mlp.fc1',
                        'l_30': 'blocks.16.mlp.act',
                        'l_31': 'blocks.16.mlp.drop',
                        'l_32': 'blocks.16.mlp.fc2',
                        'l_33': 'blocks.16.mlp.drop',
                        'l_34': 'blocks.16.drop_path',
                        'l_35': 'blocks.17.norm1',
                        'l_36': 'blocks.17.attn.qkv',
                        'l_37': 'blocks.17.attn.attn_drop'}
        self.to(self.device)

    def forward(self, *args):
        # VisionTransformer/ModuleList[blocks]/Block[14]/Attention[attn]/Dropout[proj_drop] <=> self.l_0
        # VisionTransformer/ModuleList[blocks]/Block[14]/Identity[drop_path] <=> self.l_1
        # VisionTransformer/ModuleList[blocks]/Block[14]/LayerNorm[norm2] <=> self.l_2
        # VisionTransformer/ModuleList[blocks]/Block[14]/Mlp[mlp]/Linear[fc1] <=> self.l_3
        # VisionTransformer/ModuleList[blocks]/Block[14]/Mlp[mlp]/GELU[act] <=> self.l_4
        # VisionTransformer/ModuleList[blocks]/Block[14]/Mlp[mlp]/Dropout[drop] <=> self.l_5
        # VisionTransformer/ModuleList[blocks]/Block[14]/Mlp[mlp]/Linear[fc2] <=> self.l_6
        # VisionTransformer/ModuleList[blocks]/Block[14]/Mlp[mlp]/Dropout[drop] <=> self.l_7
        # VisionTransformer/ModuleList[blocks]/Block[14]/Identity[drop_path] <=> self.l_8
        # VisionTransformer/ModuleList[blocks]/Block[15]/LayerNorm[norm1] <=> self.l_9
        # VisionTransformer/ModuleList[blocks]/Block[15]/Attention[attn]/Linear[qkv] <=> self.l_10
        # VisionTransformer/ModuleList[blocks]/Block[15]/Attention[attn]/Dropout[attn_drop] <=> self.l_11
        # VisionTransformer/ModuleList[blocks]/Block[15]/Attention[attn]/Linear[proj] <=> self.l_12
        # VisionTransformer/ModuleList[blocks]/Block[15]/Attention[attn]/Dropout[proj_drop] <=> self.l_13
        # VisionTransformer/ModuleList[blocks]/Block[15]/Identity[drop_path] <=> self.l_14
        # VisionTransformer/ModuleList[blocks]/Block[15]/LayerNorm[norm2] <=> self.l_15
        # VisionTransformer/ModuleList[blocks]/Block[15]/Mlp[mlp]/Linear[fc1] <=> self.l_16
        # VisionTransformer/ModuleList[blocks]/Block[15]/Mlp[mlp]/GELU[act] <=> self.l_17
        # VisionTransformer/ModuleList[blocks]/Block[15]/Mlp[mlp]/Dropout[drop] <=> self.l_18
        # VisionTransformer/ModuleList[blocks]/Block[15]/Mlp[mlp]/Linear[fc2] <=> self.l_19
        # VisionTransformer/ModuleList[blocks]/Block[15]/Mlp[mlp]/Dropout[drop] <=> self.l_20
        # VisionTransformer/ModuleList[blocks]/Block[15]/Identity[drop_path] <=> self.l_21
        # VisionTransformer/ModuleList[blocks]/Block[16]/LayerNorm[norm1] <=> self.l_22
        # VisionTransformer/ModuleList[blocks]/Block[16]/Attention[attn]/Linear[qkv] <=> self.l_23
        # VisionTransformer/ModuleList[blocks]/Block[16]/Attention[attn]/Dropout[attn_drop] <=> self.l_24
        # VisionTransformer/ModuleList[blocks]/Block[16]/Attention[attn]/Linear[proj] <=> self.l_25
        # VisionTransformer/ModuleList[blocks]/Block[16]/Attention[attn]/Dropout[proj_drop] <=> self.l_26
        # VisionTransformer/ModuleList[blocks]/Block[16]/Identity[drop_path] <=> self.l_27
        # VisionTransformer/ModuleList[blocks]/Block[16]/LayerNorm[norm2] <=> self.l_28
        # VisionTransformer/ModuleList[blocks]/Block[16]/Mlp[mlp]/Linear[fc1] <=> self.l_29
        # VisionTransformer/ModuleList[blocks]/Block[16]/Mlp[mlp]/GELU[act] <=> self.l_30
        # VisionTransformer/ModuleList[blocks]/Block[16]/Mlp[mlp]/Dropout[drop] <=> self.l_31
        # VisionTransformer/ModuleList[blocks]/Block[16]/Mlp[mlp]/Linear[fc2] <=> self.l_32
        # VisionTransformer/ModuleList[blocks]/Block[16]/Mlp[mlp]/Dropout[drop] <=> self.l_33
        # VisionTransformer/ModuleList[blocks]/Block[16]/Identity[drop_path] <=> self.l_34
        # VisionTransformer/ModuleList[blocks]/Block[17]/LayerNorm[norm1] <=> self.l_35
        # VisionTransformer/ModuleList[blocks]/Block[17]/Attention[attn]/Linear[qkv] <=> self.l_36
        # VisionTransformer/ModuleList[blocks]/Block[17]/Attention[attn]/Dropout[attn_drop] <=> self.l_37
        # VisionTransformer/ModuleList[blocks]/Block[13]/Tensor::__add___762 <=> x0
        # VisionTransformer/ModuleList[blocks]/Block[14]/Attention[attn]/Linear[proj] <=> x1
        x0, x1 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x1)
        t_0 = self.l_1(t_0)
        t_0 = x0 + t_0
...
class Partition7(nn.Module):
    ...
    def forward(self, *args):
        ...
        # VisionTransformer/ModuleList[blocks]/Block[20]/Attention[attn]/Tensor::__getattribute___1083 <=> x1
        # VisionTransformer/ModuleList[blocks]/Block[20]/Attention[attn]/Linear[qkv] <=> x2
        x0, x1, x2 = unflatten(args,self.input_structure)
        t_0 = x1[0]
        t_1 = x1[1]
        t_2 = x1[2]
        t_3 = t_2 // 16
        t_3 = x2.reshape(t_0, t_1, 3, 16, t_3)
        ...
        t_2 = self.l_12(t_2)
        t_4 = t_0 // 16
        t_4 = t_2.reshape(t_3, t_5, 3, 16, t_4)
        ...
        t_0 = self.l_25(t_0)
        t_6 = t_5 // 16
        t_6 = t_0.reshape(t_3, t_4, 3, 16, t_6)
        t_6 = t_6.permute(2, 0, 3, 1, 4)
        t_0 = t_6[0]
        t_2 = t_6[1]
        t_6 = t_6[2]
        ...
        t_5 = self.l_38(t_5)
        t_2 = t_4 // 16
        t_2 = t_5.reshape(t_3, t_6, 3, 16, t_2)
...
forward {0: 179.86, 1: 177.32, 2: 177.63, 3: 146.27, 4: 159.23, 5: 156.61, 6: 168.97, 7: 187.27}
backward {0: 422.22, 1: 465.96, 2: 466.3, 3: 429.19, 4: 447.7, 5: 440.84, 6: 435.71, 7: 387.32}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'226.49 MB', recieve_time:'18.87 ms', out:'380.11 MB', send time:'31.68 ms'
1: input size:'380.11 MB', recieve_time:'31.68 ms', out:'380.11 MB', send time:'31.68 ms'
2: input size:'380.11 MB', recieve_time:'31.68 ms', out:'380.11 MB', send time:'31.68 ms'
3: input size:'380.11 MB', recieve_time:'31.68 ms', out:'152.04 MB', send time:'12.67 ms'
4: input size:'152.04 MB', recieve_time:'12.67 ms', out:'152.04 MB', send time:'12.67 ms'
...
7: input size:'304.09 MB', recieve_time:'25.34 ms', out:'0.51 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.82, 1: 0.82, 2: 0.82, 3: 0.91, 4: 0.92, 5: 0.92, 6: 0.85, 7: 1.0} 
backward {0: 0.96, 1: 0.93, 2: 0.93, 3: 0.93, 4: 0.97, 5: 0.97, 6: 0.97, 7: 0.93}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 602.08,
                                     1: 643.28,
                                     2: 643.94,
                                     3: 575.46,
                                     4: 606.93,
                                     ...
                                     7: 574.59,
                                     'worstcase': 643.94},
 'seq_no_comm_no_recomp': {0: 427.29,
                           1: 438.71,
                           2: 439.18,
                           3: 401.67,
                           4: 439.45,
...
forward {0: 0.79, 1: 0.78, 2: 0.78, 3: 0.71, 4: 0.78, 5: 0.77, 6: 0.77, 7: 1.0}
backward {0: 0.87, 1: 0.93, 2: 0.93, 3: 0.85, 4: 0.93, 5: 0.92, 6: 0.9, 7: 0.78}

worstcase: bwd: 466.302 fwd: 187.269
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.453
Expected speedup for 8 partitions is: 6.915
