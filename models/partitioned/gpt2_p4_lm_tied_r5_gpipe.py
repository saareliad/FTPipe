...
def create_pipeline_configuration(DEBUG=False):
    depth = 10000
    basic_blocks = (Dropout,StatelessEmbedding,Embedding,Conv1D,LayerNorm,StatelessLinear)
...
class Partition3(nn.Module):
    ...
    def __init__(self, layers, tensors):
        ...
        self.l_31 = layers['GPT2LMHeadModel/GPT2Model[transformer]/LayerNorm[ln_f]']
