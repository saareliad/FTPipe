...
# partition 5 {'inputs': {0, 'decoder_input_ids', 4, 'decoder_attention_mask', 'attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {6, 7}}
# partition 6 {'inputs': {5, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {7}}
# partition 7 {'inputs': {5, 'decoder_attention_mask', 6, 'lm_labels', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=32):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (T5LayerNorm,Linear,StatelessEmbedding,CrossEntropyLoss,T5Block,Dropout),
        'model_inputs': {
            'attention_mask': {
...
forward {0: 90.17, 1: 78.11, 2: 78.35, 3: 78.31, 4: 78.37, 5: 81.12, 6: 59.8, 7: 54.7}
backward {0: 225.37, 1: 224.25, 2: 224.04, 3: 224.23, 4: 224.3, 5: 250.79, 6: 174.78, 7: 163.02}
...
forward {0: 0.86, 1: 0.85, 2: 0.85, 3: 0.85, 4: 0.85, 5: 0.89, 6: 0.65, 7: 0.61}
backward {0: 0.9, 1: 0.88, 2: 0.88, 3: 0.88, 4: 0.88, 5: 0.95, 6: 0.7, 7: 0.65}

worstcase: bwd: 250.787 fwd: 90.166
Expected speedup for 8 partitions is: 6.635
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'156.65 MB', send time:'13.05 ms'
...
3: input size:'25.17 MB', recieve_time:'2.10 ms', out:'25.17 MB', send time:'2.10 ms'
4: input size:'25.17 MB', recieve_time:'2.10 ms', out:'25.17 MB', send time:'2.10 ms'
5: input size:'156.65 MB', recieve_time:'13.05 ms', out:'10.03 MB', send time:'0.84 ms'
6: input size:'10.03 MB', recieve_time:'0.84 ms', out:'10.03 MB', send time:'0.84 ms'
7: input size:'10.03 MB', recieve_time:'0.84 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.86, 1: 0.97, 2: 0.97, 3: 0.97, 4: 0.97, 5: 0.99, 6: 0.99, 7: 1.0} 
backward {0: 1.0, 1: 0.99, 2: 0.99, 3: 0.99, 4: 0.99, 5: 0.95, 6: 1.0, 7: 0.99}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 315.54,
                                     1: 302.36,
                                     2: 302.39,
                                     3: 302.54,
                                     4: 302.67,
                                     ...
                                     7: 217.72,
                                     'worstcase': 331.91},
 'seq_no_comm_no_recomp': {0: 225.75,
                           1: 222.91,
                           2: 222.87,
                           3: 222.81,
                           4: 222.61,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.957
Analysis max cuda memory used 6.48GB
"""
