"""AutoGenerated with:
python -m autopipe.partitiont5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 512 --answer_max_seq_length 4 --ct t5_3b_bb_trace -c t5_3b_bb_profiles --save_memory_mode --preset ftpipe --partitioning_method mpipe --dont_use_async_meta_alg --basic_blocks T5Block
"""
...
# partition 7 {'inputs': {0, 6, 'inverted_encoder_attention_mask', 'decoder_attention_mask', 'attention_mask'}, 'outputs': {8, 9, 10, 11, 12, 13, 14}}
...
# partition 11 {'inputs': {10, 'decoder_attention_mask', 'inverted_encoder_attention_mask', 7}, 'outputs': {12}}
# partition 12 {'inputs': {11, 'decoder_attention_mask', 'inverted_encoder_attention_mask', 7}, 'outputs': {13}}
# partition 13 {'inputs': {'decoder_attention_mask', 12, 'inverted_encoder_attention_mask', 7}, 'outputs': {14}}
# partition 14 {'inputs': {7, 13, 'lm_labels', 'inverted_encoder_attention_mask', 'decoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {14}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,T5Block,CrossEntropyLoss,T5LayerNorm,StatelessEmbedding,Dropout),
        'model_inputs': {
            'attention_mask': {
...
unique_stages_on_same_gpu: [{0, 14}, {1, 9}, {2, 13}, {3, 12}, {10, 4}, {11, 5}, {8, 6}, {7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 6, 1, 4, 5, 3, 2, 0],
...
forward {0: 112.47, 1: 99.75, 2: 99.97, 3: 100.09, 4: 99.52, 5: 99.82, 6: 99.41, 7: 87.92}
backward {0: 227.35, 1: 242.59, 2: 242.54, 3: 242.86, 4: 242.35, 5: 242.48, 6: 242.27, 7: 255.22}
...
forward {0: 0.8, 1: 0.78, 2: 0.78, 3: 0.78, 4: 0.77, 5: 0.78, 6: 0.77, 7: 0.77}
backward {0: 0.89, 1: 0.9, 2: 0.9, 3: 0.9, 4: 0.9, 5: 0.9, 6: 0.9, 7: 0.91}

worstcase: bwd: 255.224 fwd: 112.469
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 339.82,
                                     1: 342.34,
                                     2: 342.51,
                                     3: 342.94,
                                     4: 341.87,
                                     ...
                                     7: 343.15,
                                     'worstcase': 343.15},
 'seq_no_comm_no_recomp': {0: 205.42,
                           1: 197.14,
                           2: 196.99,
                           3: 197.44,
                           4: 197.42,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.099
