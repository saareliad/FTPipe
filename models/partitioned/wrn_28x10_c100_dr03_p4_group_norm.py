    ...
    return {
        ...
        "stages": {
            "0": {
                ...
                "stage_cls": "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition0",
                "devices": [
                    "cpu" if DEBUG else "cuda:0"
                ]
            },
            "1": {
                "inputs": {
                ...
                "stage_cls": "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition1",
                "devices": [
                    "cpu" if DEBUG else "cuda:1"
                ]
            },
            "2": {
                "inputs": {
                ...
                "stage_cls": "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition2",
                "devices": [
                    "cpu" if DEBUG else "cuda:2"
                ]
            },
            "3": {
                "inputs": {
                ...
                "stage_cls": "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition3",
                "devices": [
                    "cpu" if DEBUG else "cuda:3"
                ]
            }
        }
    }
...
class WideResNetPartition0(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1] was expected but not given'
        self.l_1 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]']
        assert isinstance(
            self.l_1, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_1)}'
        ...
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2] was expected but not given'
        self.l_4 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]']
        assert isinstance(
            self.l_4, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_4)}'
        ...
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1] was expected but not given'
        self.l_9 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]']
        assert isinstance(
            self.l_9, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_9)}'
        ...
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2] was expected but not given'
        self.l_12 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]']
        assert isinstance(
            self.l_12, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_12)}'
        ...
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1] was expected but not given'
        self.l_16 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]']
        assert isinstance(
            self.l_16, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_16)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/ReLU[relu1]
...
class WideResNetPartition1(nn.Module):
    def __init__(self, layers, tensors):
        ...
        self.l_0 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]']
        assert isinstance(
            self.l_0, Conv2d), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2] was expected but not given'
        self.l_1 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]']
        assert isinstance(
            self.l_1, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_1)}'
        ...
        self.l_2 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]']
        assert isinstance(
            self.l_2, ReLU), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_2)}'
        ...
        self.l_3 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]']
        assert isinstance(
            self.l_3, Dropout), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_3)}'
        ...
        self.l_4 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]']
        assert isinstance(
            self.l_4, Conv2d), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1] was expected but not given'
        self.l_5 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]']
        assert isinstance(
            self.l_5, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_5)}'
        ...
        self.l_6 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]']
        assert isinstance(
            self.l_6, ReLU), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_6)}'
        ...
        self.l_7 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]']
        assert isinstance(
            self.l_7, Conv2d), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_7)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2] was expected but not given'
        self.l_8 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]']
        assert isinstance(
            self.l_8, GroupNorm), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_8)}'
        ...
        self.l_9 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]']
        assert isinstance(
            self.l_9, ReLU), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_9)}'
        ...
        self.l_10 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]']
        assert isinstance(
            self.l_10, Dropout), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_10)}'
        ...
        self.l_11 = layers['WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]']
        assert isinstance(
            self.l_11, Conv2d), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_11)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1] was expected but not given'
        self.l_12 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]']
        assert isinstance(
            self.l_12, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_12)}'

        self.device = torch.device('cuda:1')
        self.lookup = {'l_0': 'block1.layer.2.conv1',
    ...
    def forward(self, x0, x1):
        ...
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2] <=> self.l_1
        ...
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1] <=> self.l_5
        ...
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2] <=> self.l_8
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1] <=> self.l_12
        ...
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/aten::add379
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]
        t_0 = torch.add(input=x0, other=self.l_4(
            self.l_3(self.l_2(self.l_1(self.l_0(x1))))))
        # returing:
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]
        return (self.l_12(torch.add(input=t_0, other=self.l_11(self.l_10(self.l_9(self.l_8(self.l_7(self.l_6(self.l_5(t_0))))))))),)
...
class WideResNetPartition2(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_1)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2] was expected but not given'
        self.l_2 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]']
        assert isinstance(
            self.l_2, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Dropout), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1] was expected but not given'
        self.l_7 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]']
        assert isinstance(
            self.l_7, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_9)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2] was expected but not given'
        self.l_10 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]']
        assert isinstance(
            self.l_10, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_11)}'
        ...
        assert isinstance(
            self.l_12, Dropout), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_13)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1] was expected but not given'
        self.l_14 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]']
        assert isinstance(
            self.l_14, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_14)}'
        ...
        assert isinstance(
            self.l_15, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_15)}'
        ...
        assert isinstance(
            self.l_16, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_16)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2] was expected but not given'
        self.l_17 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]']
        assert isinstance(
            self.l_17, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_17)}'
        ...
        assert isinstance(
            self.l_18, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_18)}'
        ...
        assert isinstance(
            self.l_19, Dropout), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_19)}'
        ...
        assert isinstance(
            self.l_20, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_20)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1] was expected but not given'
        self.l_21 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]']
        assert isinstance(
            self.l_21, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_21)}'
        ...
        assert isinstance(
            self.l_22, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_22)}'
        ...
        assert isinstance(
            self.l_23, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_23)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2] was expected but not given'
        self.l_24 = layers['WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]']
        assert isinstance(
            self.l_24, GroupNorm), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_24)}'
        ...
        assert isinstance(
            self.l_25, ReLU), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_25)}'
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]
        ...
        assert isinstance(
            self.l_26, Dropout), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_26)}'
    ...
    def forward(self, x0):
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2] <=> self.l_2
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1] <=> self.l_7
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2] <=> self.l_10
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1] <=> self.l_14
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2] <=> self.l_17
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1] <=> self.l_21
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2] <=> self.l_24
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1] <=> x0
        ...
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]
        t_1 = torch.add(input=self.l_6(t_0), other=self.l_5(
            self.l_4(self.l_3(self.l_2(self.l_1(t_0))))))
        # calling torch.add with arguments:
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/aten::add677
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]
        t_2 = torch.add(input=t_1, other=self.l_13(
            self.l_12(self.l_11(self.l_10(self.l_9(self.l_8(self.l_7(t_1))))))))
        # calling torch.add with arguments:
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/aten::add770
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]
        t_3 = torch.add(input=t_2, other=self.l_20(
            self.l_19(self.l_18(self.l_17(self.l_16(self.l_15(self.l_14(t_2))))))))
        # returing:
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/aten::add863
        # WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]
...
class WideResNetPartition3(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1] was expected but not given'
        self.l_1 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]']
        assert isinstance(
            self.l_1, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_3)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2] was expected but not given'
        self.l_4 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]']
        assert isinstance(
            self.l_4, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Dropout), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/Conv2d[convShortcut]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1] was expected but not given'
        self.l_9 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]']
        assert isinstance(
            self.l_9, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_11)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2] was expected but not given'
        self.l_12 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]']
        assert isinstance(
            self.l_12, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_13)}'
        ...
        assert isinstance(
            self.l_14, Dropout), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_14)}'
        ...
        assert isinstance(
            self.l_15, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_15)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1] was expected but not given'
        self.l_16 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]']
        assert isinstance(
            self.l_16, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_16)}'
        ...
        assert isinstance(
            self.l_17, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_17)}'
        ...
        assert isinstance(
            self.l_18, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_18)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2] was expected but not given'
        self.l_19 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]']
        assert isinstance(
            self.l_19, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_19)}'
        ...
        assert isinstance(
            self.l_20, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_20)}'
        ...
        assert isinstance(
            self.l_21, Dropout), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_21)}'
        ...
        assert isinstance(
            self.l_22, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_22)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1] was expected but not given'
        self.l_23 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]']
        assert isinstance(
            self.l_23, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_23)}'
        ...
        assert isinstance(
            self.l_24, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/ReLU[relu1]] is expected to be of type ReLU but was of type {type(self.l_24)}'
        ...
        assert isinstance(
            self.l_25, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_25)}'
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]
        assert 'WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]' in layers, 'layer WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2] was expected but not given'
        self.l_26 = layers['WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]']
        assert isinstance(
            self.l_26, GroupNorm), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_26)}'
        ...
        assert isinstance(
            self.l_27, ReLU), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/ReLU[relu2]] is expected to be of type ReLU but was of type {type(self.l_27)}'
        ...
        assert isinstance(
            self.l_28, Dropout), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Dropout[dropout]] is expected to be of type Dropout but was of type {type(self.l_28)}'
        ...
        assert isinstance(
            self.l_29, Conv2d), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_29)}'
        # WideResNet/GroupNorm[bn1]
        assert 'WideResNet/GroupNorm[bn1]' in layers, 'layer WideResNet/GroupNorm[bn1] was expected but not given'
        self.l_30 = layers['WideResNet/GroupNorm[bn1]']
        assert isinstance(
            self.l_30, GroupNorm), f'layers[WideResNet/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_30)}'
        ...
        assert isinstance(
            self.l_31, ReLU), f'layers[WideResNet/ReLU[relu]] is expected to be of type ReLU but was of type {type(self.l_31)}'
        ...
        assert isinstance(
            self.l_32, AvgPool2d), f'layers[WideResNet/AvgPool2d[avg_pool]] is expected to be of type AvgPool2d but was of type {type(self.l_32)}'
        # WideResNet/Linear[fc]
        ...
        assert isinstance(
            self.l_33, Linear), f'layers[WideResNet/Linear[fc]] is expected to be of type Linear but was of type {type(self.l_33)}'
    ...
    def forward(self, x0, x1):
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1] <=> self.l_1
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2] <=> self.l_4
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1] <=> self.l_9
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2] <=> self.l_12
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1] <=> self.l_16
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2] <=> self.l_19
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1] <=> self.l_23
        ...
        # WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2] <=> self.l_26
        ...
        # WideResNet/GroupNorm[bn1] <=> self.l_30
