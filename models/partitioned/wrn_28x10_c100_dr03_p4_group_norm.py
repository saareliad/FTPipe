...
def create_pipeline_configuration(DEBUG=False):
    return {
        ...
        "basic_blocks": [
            ...
            "torch.nn.GroupNorm", "torch.nn.modules.activation.ReLU"
        ],
        "model_inputs": {
            "input0": {
        ...
        "stages": {
            "0": {
                ...
                "stage_cls":
                "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition0",
            ...
            1: {
                ...
                "stage_cls":
                "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition1",
            ...
            2: {
                ...
                "stage_cls":
                "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition2",
            ...
            3: {
                ...
                "stage_cls":
                "models.partitioned.wrn_28x10_c100_dr03_p4_group_norm.WideResNetPartition3",
...
class WideResNetPartition0(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_1, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_4, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_9, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_12, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_16, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_16)}'
        # WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/ReLU[relu1]
...
class WideResNetPartition1(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_1, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_5, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_8, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block1]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_12, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_12)}'
...
class WideResNetPartition2(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_2, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_7, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_10, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_14, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_14)}'
        ...
        assert isinstance(
            self.l_17, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_17)}'
        ...
        assert isinstance(
            self.l_21, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_21)}'
        ...
        assert isinstance(
            self.l_24, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block2]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_24)}'
...
class WideResNetPartition3(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_1, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_4, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[0]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_9, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_12, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[1]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_16, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_16)}'
        ...
        assert isinstance(
            self.l_19, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[2]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_19)}'
        ...
        assert isinstance(
            self.l_23, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_23)}'
        ...
        assert isinstance(
            self.l_26, GroupNorm
        ), f'layers[WideResNet/NetworkBlock[block3]/Sequential[layer]/BasicBlock[3]/GroupNorm[bn2]] is expected to be of type GroupNorm but was of type {type(self.l_26)}'
        ...
        assert isinstance(
            self.l_30, GroupNorm
        ), f'layers[WideResNet/GroupNorm[bn1]] is expected to be of type GroupNorm but was of type {type(self.l_30)}'
