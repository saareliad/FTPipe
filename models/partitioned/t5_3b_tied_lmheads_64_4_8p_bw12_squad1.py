"""AutoGenerated with:
python partitioning_script.py t5 --t5_task squad1 --lmhead --n_iter 10 --n_partitions 8 --analysis_batch_size 32 --partitioning_batch_size 32 --precompute_masks --stateless_tied --model_name_or_path t5-3b --save_memory_mode --max_seq_length 64 --answer_max_seq_length 4 --basic_blocks T5Block --constraint memory --objective stage_time --profiles_cache_name t5_3b_64_4_cache
"""
...
# partition 3 {'inputs': {0, 2, 'attention_mask', 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {4, 5, 6, 7}}
# partition 4 {'inputs': {3, 'inverted_encoder_attention_mask', 'decoder_attention_mask'}, 'outputs': {5}}
# partition 5 {'inputs': {3, 'inverted_encoder_attention_mask', 4, 'decoder_attention_mask'}, 'outputs': {6}}
# partition 6 {'inputs': {3, 'inverted_encoder_attention_mask', 5, 'decoder_attention_mask'}, 'outputs': {7}}
# partition 7 {'inputs': {'lm_labels', 3, 6, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=32):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,CrossEntropyLoss,Dropout,StatelessEmbedding,T5LayerNorm,T5Block),
        'model_inputs': {
            'attention_mask': {
...
class Partition3(nn.Module):
    ...
    def forward(self, *args):
        ...
        attention_mask, decoder_attention_mask, inverted_encoder_attention_mask, x0, x1, x2 = unflatten(args,self.input_structure)
        t_0 = self.l_0(x1, attention_mask=attention_mask, position_bias=x0, encoder_hidden_states=None, encoder_attention_mask=None, encoder_decoder_position_bias=None)
        t_0 = self.l_1(t_0, attention_mask=attention_mask, position_bias=x0, encoder_hidden_states=None, encoder_attention_mask=None, encoder_decoder_position_bias=None)
        t_0 = self.l_2(t_0, attention_mask=attention_mask, position_bias=x0, encoder_hidden_states=None, encoder_attention_mask=None, encoder_decoder_position_bias=None)
        t_0 = self.l_3(t_0)
...
forward {0: 135.03, 1: 134.02, 2: 134.25, 3: 77.05, 4: 25.39, 5: 25.38, 6: 25.38, 7: 25.31}
backward {0: 385.42, 1: 385.13, 2: 385.6, 3: 225.38, 4: 71.97, 5: 71.71, 6: 71.83, 7: 74.31}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.03 MB', recieve_time:'0.00 ms', out:'25.69 MB', send time:'2.14 ms'
...
3: input size:'25.71 MB', recieve_time:'2.14 ms', out:'10.03 MB', send time:'0.84 ms'
4: input size:'10.04 MB', recieve_time:'0.84 ms', out:'10.03 MB', send time:'0.84 ms'
5: input size:'10.04 MB', recieve_time:'0.84 ms', out:'10.03 MB', send time:'0.84 ms'
6: input size:'10.04 MB', recieve_time:'0.84 ms', out:'10.03 MB', send time:'0.84 ms'
7: input size:'10.04 MB', recieve_time:'0.84 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.98, 1: 0.98, 2: 0.98, 3: 0.99, 4: 0.97, 5: 0.97, 6: 0.97, 7: 1.0} 
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 518.31,
                      ...
                      7: 98.78,
                      'worstcase': 518.31},
 'pipeline_vs_seq_no_comm': 3.26,
 'pipeline_with_non_parallel_comm': {0: 520.45,
                                     1: 519.15,
                                     2: 519.84,
                                     3: 302.43,
                                     4: 97.37,
                                     ...
                                     7: 99.62,
                                     'worstcase': 520.45},
 'seq_no_comm_no_recomp': {0: 391.02,
                           1: 387.81,
                           2: 387.92,
                           3: 224.87,
                           4: 73.25,
...
forward {0: 0.98, 1: 0.97, 2: 0.97, 3: 0.56, 4: 0.18, 5: 0.18, 6: 0.18, 7: 0.19}
backward {0: 1.0, 1: 0.99, 2: 0.99, 3: 0.57, 4: 0.19, 5: 0.19, 6: 0.19, 7: 0.19}

worstcase: bwd: 385.597 fwd: 135.030
expected_speedup_compared_to_seq_no_recomp_no_comm: 3.241
Expected speedup for 8 partitions is: 4.290
max cuda memory used 5.75GB
"""