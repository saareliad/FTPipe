"""AutoGenerated with:
python partition.py t5 --t5_task squad1 --lmhead --n_iter 10 --n_partitions 8 --analysis_batch_size 32 --partitioning_batch_size 32 --precompute_masks --stateless_tied --model_name_or_path t5-3b --save_memory_mode --max_seq_length 64 --answer_max_seq_length 4 --basic_blocks T5Block --constraint memory --objective stage_time --profiles_cache_name t5_3b_64_4_cache
"""
