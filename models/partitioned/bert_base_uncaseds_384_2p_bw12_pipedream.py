"""AutoGenerated with:
python /home/saareliad/workspace/FTPipe/autopipe/partition.py bert_squad --n_partitions 2 --partitioning_batch_size 1 --analysis_batch_size 1 --n_iter 10 --model_name_or_path bert-base-uncased --do_lower_case --train_file /home_local/saareliad/data/squad1/train-v1.1.json --max_seq_length 384 --doc_stride 128 --partitioning_method pipedream --preset pipedream
"""
...
def create_pipeline_configuration(DEBUG=False, batch_size=1):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Softmax,LayerNorm,Gelu,Dropout,Linear,Embedding,Tanh),
        'model_inputs': {
            'attention_mask': {
            ...
            0: {
                ...
                'outputs': {
                    'BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12': {
                        ...
                        'is_batched': True,
                        'used_by': [1]},
                    'BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertOutput[output]/Tensor::__add___620': {
                        'shape': torch.Size([1, 384, 768]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [1]}},
...
class Partition1(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:1'):
        ...
        self.lookup = {'l_0': 'bert.encoder.5.output.LayerNorm',
                        ...
                        'l_49': 'bert.encoder.9.intermediate.intermediate_act_fn',
                        'l_50': 'bert.encoder.9.output.dense',
                        'l_51': 'bert.encoder.9.output.dropout',
                        'l_52': 'bert.encoder.9.output.LayerNorm',
                        'l_53': 'bert.encoder.10.attention.self.query',
                        'l_54': 'bert.encoder.10.attention.self.key',
                        'l_55': 'bert.encoder.10.attention.self.value',
                        'l_56': 'bert.encoder.10.attention.self.softmax',
                        'l_57': 'bert.encoder.10.attention.self.dropout',
                        'l_58': 'bert.encoder.10.attention.output.dense',
                        'l_59': 'bert.encoder.10.attention.output.dropout',
                        'l_60': 'bert.encoder.10.attention.output.LayerNorm',
                        'l_61': 'bert.encoder.10.intermediate.dense',
                        'l_62': 'bert.encoder.10.intermediate.intermediate_act_fn',
                        'l_63': 'bert.encoder.10.output.dense',
                        'l_64': 'bert.encoder.10.output.dropout',
                        'l_65': 'bert.encoder.10.output.LayerNorm',
                        'l_66': 'bert.encoder.11.attention.self.query',
                        'l_67': 'bert.encoder.11.attention.self.key',
                        'l_68': 'bert.encoder.11.attention.self.value',
                        'l_69': 'bert.encoder.11.attention.self.softmax',
                        'l_70': 'bert.encoder.11.attention.self.dropout',
                        'l_71': 'bert.encoder.11.attention.output.dense',
                        'l_72': 'bert.encoder.11.attention.output.dropout',
                        'l_73': 'bert.encoder.11.attention.output.LayerNorm',
                        'l_74': 'bert.encoder.11.intermediate.dense',
                        'l_75': 'bert.encoder.11.intermediate.intermediate_act_fn',
                        'l_76': 'bert.encoder.11.output.dense',
                        'l_77': 'bert.encoder.11.output.dropout',
                        'l_78': 'bert.encoder.11.output.LayerNorm',
                        'l_79': 'bert.pooler.dense',
                        'l_80': 'bert.pooler.activation',
                        'l_81': 'qa_outputs'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_49
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/Linear[dense] <=> self.l_50
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/Dropout[dropout] <=> self.l_51
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[9]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_52
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_53
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_54
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_55
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_56
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_57
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_58
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_59
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_60
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_61
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_62
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/Linear[dense] <=> self.l_63
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/Dropout[dropout] <=> self.l_64
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[10]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_65
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[query] <=> self.l_66
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[key] <=> self.l_67
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Linear[value] <=> self.l_68
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Softmax[softmax] <=> self.l_69
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfAttention[self]/Dropout[dropout] <=> self.l_70
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Linear[dense] <=> self.l_71
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/Dropout[dropout] <=> self.l_72
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertAttention[attention]/BertSelfOutput[output]/LayerNorm[LayerNorm] <=> self.l_73
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertIntermediate[intermediate]/Linear[dense] <=> self.l_74
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertIntermediate[intermediate]/Gelu[intermediate_act_fn] <=> self.l_75
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/Linear[dense] <=> self.l_76
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/Dropout[dropout] <=> self.l_77
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[11]/BertOutput[output]/LayerNorm[LayerNorm] <=> self.l_78
        # BertForQuestionAnswering/BertModel[bert]/BertPooler[pooler]/Linear[dense] <=> self.l_79
        # BertForQuestionAnswering/BertModel[bert]/BertPooler[pooler]/Tanh[activation] <=> self.l_80
        # BertForQuestionAnswering/Linear[qa_outputs] <=> self.l_81
        # BertForQuestionAnswering/BertModel[bert]/Tensor::__mul___12 <=> x0
        # BertForQuestionAnswering/BertModel[bert]/BertEncoder[encoder]/BertLayer[5]/BertOutput[output]/Tensor::__add___620 <=> x1
...
forward {0: 10.13, 1: 10.94}
backward {0: 19.67, 1: 12.49}

Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'1.18 MB', send time:'0.10 ms'
1: input size:'1.18 MB', recieve_time:'0.10 ms', out:'0.00 MB', send time:'0.00 ms'
...
Analysis for T = fwd + bwd:
 {'expected_compute_utilization': {0: 1.0, 1: 0.79},
 'pipeline_no_comm': {0: 29.7, 1: 23.33, 'worstcase': 29.7},
 'pipeline_vs_seq_no_comm': 1.79,
 'pipeline_with_non_parallel_comm': {0: 29.8, 1: 23.43, 'worstcase': 29.8},
 'seq_no_comm_no_recomp': {0: 26.67, 1: 26.59}}
...
worstcase: bwd: 19.669 fwd: 10.937
expected_speedup_compared_to_seq_no_recomp_no_comm: 1.740
Expected speedup for 2 partitions is: 1.722
Analysis max cuda memory used 0.62GB
"""