    ...
    config = {
        ...
        "stages": {
            ...
            7: {
                ...
                "stage_cls":
                "models.partitioned.resnet50_imagenet_p8.ResNetPartition7",
...
class ResNetPartition0(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        ), f'layers[ResNet/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_2)}'
        ...
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        ...
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/Sequential[downsample]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        ...
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[0]/Sequential[downsample]/BatchNorm2d[1]] is expected to be of type BatchNorm2d but was of type {type(self.l_9)}'
    ...
    def forward(self, x0):
        ...
        t_0 = torch.max_pool2d(Tensor.relu(self.l_1(self.l_0(x0))),
                               kernel_size=[3, 3],
                               stride=[2, 2],
                               padding=[1, 1],
                               dilation=[1, 1],
        ...
        return (operator.iadd(
            self.l_7(
                self.l_6(
                    Tensor.relu(
                        self.l_5(self.l_4(Tensor.relu(self.l_3(
                            self.l_2(t_0)))))))), self.l_9(self.l_8(t_0))), )
...
class ResNetPartition1(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[1]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[1]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[2]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, Conv2d
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[2]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        ...
        ), f'layers[ResNet/Sequential[layer1]/Bottleneck[2]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
    ...
    def forward(self, x0):
        ...
        return (operator.iadd(
            self.l_11(
                self.l_10(
                    Tensor.relu(
                        self.l_9(self.l_8(Tensor.relu(self.l_7(
                            self.l_6(t_1)))))))), t_1), )
...
class ResNetPartition2(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/Sequential[downsample]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[0]/Sequential[downsample]/BatchNorm2d[1]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
                    ...
                    self.l_4(
                        Tensor.relu(
                            self.l_3(
                                self.l_2(Tensor.relu(self.l_1(
                                    self.l_0(t_0)))))))),
                self.l_7(self.l_6(t_0))))
        # returing:
        # ResNet/Sequential[layer2]/Bottleneck[0]/aten::relu4193
        # ResNet/Sequential[layer2]/Bottleneck[1]/aten::relu4259
        return (t_1,
                Tensor.relu(
                    self.l_11(self.l_10(Tensor.relu(self.l_9(
                        self.l_8(t_1)))))))
...
class ResNetPartition3(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[1]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[1]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[2]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[2]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[2]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[3]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[3]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
        ...
        assert isinstance(
            self.l_12, Conv2d
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[3]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_12)}'
        ...
        ), f'layers[ResNet/Sequential[layer2]/Bottleneck[3]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_13)}'
        ...
        return (operator.iadd(
            self.l_13(
                self.l_12(
                    Tensor.relu(
                        self.l_11(
                            self.l_10(Tensor.relu(self.l_9(
                                self.l_8(t_1)))))))), t_1), )
...
class ResNetPartition4(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/Sequential[downsample]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[0]/Sequential[downsample]/BatchNorm2d[1]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
        ...
        assert isinstance(
            self.l_12, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[1]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[1]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_13)}'
...
class ResNetPartition5(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[2]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[2]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[2]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[3]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[3]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[3]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[3]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[3]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[3]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_11)}'
        ...
        assert isinstance(
            self.l_12, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[4]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[4]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_13)}'
        # ResNet/Sequential[layer3]/Bottleneck[4]/Conv2d[conv2]
        ...
        assert isinstance(
            self.l_14, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[4]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_14)}'
...
class ResNetPartition6(nn.Module):
    def __init__(self, layers, tensors):
        ...
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[4]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[4]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_1)}'
        ...
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[4]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[5]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_3)}'
        ...
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[5]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[5]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_5)}'
        ...
        self.l_6 = layers[
            'ResNet/Sequential[layer3]/Bottleneck[5]/BatchNorm2d[bn2]']
        assert isinstance(
            self.l_6, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[5]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, Conv2d
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[5]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_7)}'
        ...
        ), f'layers[ResNet/Sequential[layer3]/Bottleneck[5]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_9)}'
        ...
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_11)}'
        ...
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_12)}'
        # ResNet/Sequential[layer4]/Bottleneck[0]/Sequential[downsample]/Conv2d[0]
        ...
        assert isinstance(
            self.l_13, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/Sequential[downsample]/Conv2d[0]] is expected to be of type Conv2d but was of type {type(self.l_13)}'
    ...
    def forward(self, x0, x1):
        ...
        t_0 = Tensor.relu(
            operator.iadd(self.l_2(self.l_1(Tensor.relu(self.l_0(x1)))), x0))
        # calling torch.relu with arguments:
            ...
            operator.iadd(
                self.l_8(
                    self.l_7(
                        Tensor.relu(
                            self.l_6(
                                self.l_5(Tensor.relu(self.l_4(
                                    self.l_3(t_0)))))))), t_0))
        # returing:
        # ResNet/Sequential[layer4]/Bottleneck[0]/Sequential[downsample]/Conv2d[0]
        # ResNet/Sequential[layer4]/Bottleneck[0]/aten::relu5183
        return (self.l_13(t_1),
                Tensor.relu(
                    self.l_12(self.l_11(Tensor.relu(self.l_10(
                        self.l_9(t_1)))))))
...
class ResNetPartition7(nn.Module):
    def __init__(self, layers, tensors):
        ...
        assert isinstance(
            self.l_0, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_0)}'
        ...
        assert isinstance(
            self.l_1, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_1)}'
        ...
        assert isinstance(
            self.l_2, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[0]/Sequential[downsample]/BatchNorm2d[1]] is expected to be of type BatchNorm2d but was of type {type(self.l_2)}'
        ...
        assert isinstance(
            self.l_3, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[1]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_3)}'
        ...
        assert isinstance(
            self.l_4, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[1]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_4)}'
        ...
        assert isinstance(
            self.l_5, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[1]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_5)}'
        ...
        assert isinstance(
            self.l_6, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[1]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_6)}'
        ...
        assert isinstance(
            self.l_7, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[1]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_7)}'
        ...
        assert isinstance(
            self.l_8, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[1]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_8)}'
        ...
        assert isinstance(
            self.l_9, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[2]/Conv2d[conv1]] is expected to be of type Conv2d but was of type {type(self.l_9)}'
        ...
        assert isinstance(
            self.l_10, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[2]/BatchNorm2d[bn1]] is expected to be of type BatchNorm2d but was of type {type(self.l_10)}'
        ...
        assert isinstance(
            self.l_11, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[2]/Conv2d[conv2]] is expected to be of type Conv2d but was of type {type(self.l_11)}'
        ...
        assert isinstance(
            self.l_12, BatchNorm2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[2]/BatchNorm2d[bn2]] is expected to be of type BatchNorm2d but was of type {type(self.l_12)}'
        ...
        assert isinstance(
            self.l_13, Conv2d
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[2]/Conv2d[conv3]] is expected to be of type Conv2d but was of type {type(self.l_13)}'
        ...
        ), f'layers[ResNet/Sequential[layer4]/Bottleneck[2]/BatchNorm2d[bn3]] is expected to be of type BatchNorm2d but was of type {type(self.l_14)}'
        # ResNet/Linear[fc]
        assert 'ResNet/Linear[fc]' in layers, 'layer ResNet/Linear[fc] was expected but not given'
        self.l_15 = layers['ResNet/Linear[fc]']
        assert isinstance(
            self.l_15, Linear
        ), f'layers[ResNet/Linear[fc]] is expected to be of type Linear but was of type {type(self.l_15)}'
            ...
            operator.iadd(
                self.l_14(
                    self.l_13(
                        Tensor.relu(
                            self.l_12(
                                self.l_11(Tensor.relu(self.l_10(
                                    self.l_9(t_1)))))))), t_1))
