"""AutoGenerated with:
python -m autopipe.partition new_t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --ct new_trace_cache_t53b_512_4_op --cp new_prof_cache_t53b_512_4_op_ftpipe --stateless_tied --lmhead --n_partitions 8 --L 8 16 24 --max_seq_length 512 --answer_max_seq_length 4 --partitioning_method mpipe --preset ftpipe --dont_use_async_meta_alg --save_memory_mode --special_blocks T5Block --output_file op_
"""
...
# partition adjacency
# model inputs {0, 8, 15}
# partition 0 {'inputs': {'decoder_attention_mask', 'input_ids', 'decoder_input_ids', 'attention_mask'}, 'outputs': {8, 1}}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (StatelessEmbedding,T5LayerNorm,Dropout,Embedding,Linear),
        'model_inputs': {
            'attention_mask': {
...
class Partition7(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:7'):
        ...
        self.lookup = {'l_0': 'encoder.block.21.layer.0.layer_norm',
                        ...
                        'l_35': 'decoder.block.21.layer.1.EncDecAttention.k'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_35
...
class Partition14(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:14'):
        ...
        self.lookup = {'l_0': 'decoder.block.18.layer.0.layer_norm',
                        ...
                        'l_51': 'decoder.block.21.layer.0.layer_norm',
                        'l_52': 'decoder.block.21.layer.0.SelfAttention.q',
                        'l_53': 'decoder.block.21.layer.0.SelfAttention.k',
                        'l_54': 'decoder.block.21.layer.0.SelfAttention.v'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_53
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_54
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k]
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v]
        return list(flatten((x0, t_6, t_12, t_5, t_10, t_3, t_4, t_1)))
...
class Partition15(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:15'):
        ...
        self.lookup = {'l_0': 'decoder.block.21.layer.0.SelfAttention.o',
                        'l_1': 'decoder.block.21.layer.0.dropout',
                        'l_2': 'decoder.block.21.layer.1.layer_norm',
                        'l_3': 'decoder.block.21.layer.1.EncDecAttention.q',
                        'l_4': 'decoder.block.21.layer.1.EncDecAttention.v',
                        'l_5': 'decoder.block.21.layer.1.EncDecAttention.o',
                        'l_6': 'decoder.block.21.layer.1.dropout',
                        'l_7': 'decoder.block.21.layer.2.layer_norm',
                        'l_8': 'decoder.block.21.layer.2.DenseReluDense.wi',
                        'l_9': 'decoder.block.21.layer.2.DenseReluDense.dropout',
                        'l_10': 'decoder.block.21.layer.2.DenseReluDense.wo',
                        'l_11': 'decoder.block.21.layer.2.dropout',
                        'l_12': 'decoder.block.22.layer.0.layer_norm',
                        'l_13': 'decoder.block.22.layer.0.SelfAttention.q',
                        'l_14': 'decoder.block.22.layer.0.SelfAttention.k',
                        'l_15': 'decoder.block.22.layer.0.SelfAttention.v',
                        'l_16': 'decoder.block.22.layer.0.SelfAttention.o',
                        'l_17': 'decoder.block.22.layer.0.dropout',
                        'l_18': 'decoder.block.22.layer.1.layer_norm',
                        'l_19': 'decoder.block.22.layer.1.EncDecAttention.q',
                        'l_20': 'decoder.block.22.layer.1.EncDecAttention.k',
                        'l_21': 'decoder.block.22.layer.1.EncDecAttention.v',
                        'l_22': 'decoder.block.22.layer.1.EncDecAttention.o',
                        'l_23': 'decoder.block.22.layer.1.dropout',
                        'l_24': 'decoder.block.22.layer.2.layer_norm',
                        'l_25': 'decoder.block.22.layer.2.DenseReluDense.wi',
                        'l_26': 'decoder.block.22.layer.2.DenseReluDense.dropout',
                        'l_27': 'decoder.block.22.layer.2.DenseReluDense.wo',
                        'l_28': 'decoder.block.22.layer.2.dropout',
                        'l_29': 'decoder.block.23.layer.0.layer_norm',
                        'l_30': 'decoder.block.23.layer.0.SelfAttention.q',
                        'l_31': 'decoder.block.23.layer.0.SelfAttention.k',
                        'l_32': 'decoder.block.23.layer.0.SelfAttention.v',
                        'l_33': 'decoder.block.23.layer.0.SelfAttention.o',
                        'l_34': 'decoder.block.23.layer.0.dropout',
                        'l_35': 'decoder.block.23.layer.1.layer_norm',
                        'l_36': 'decoder.block.23.layer.1.EncDecAttention.q',
                        'l_37': 'decoder.block.23.layer.1.EncDecAttention.k',
                        'l_38': 'decoder.block.23.layer.1.EncDecAttention.v',
                        'l_39': 'decoder.block.23.layer.1.EncDecAttention.o',
                        'l_40': 'decoder.block.23.layer.1.dropout',
                        'l_41': 'decoder.block.23.layer.2.layer_norm',
                        'l_42': 'decoder.block.23.layer.2.DenseReluDense.wi',
                        'l_43': 'decoder.block.23.layer.2.DenseReluDense.dropout',
                        'l_44': 'decoder.block.23.layer.2.DenseReluDense.wo',
                        'l_45': 'decoder.block.23.layer.2.dropout',
                        'l_46': 'decoder.final_layer_norm',
                        'l_47': 'decoder.dropout',
                        'l_48': 'lm_head'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[22]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[23]/ModuleList[layer]/T5LayerFF[2]/Dropout[dropout] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/T5LayerNorm[final_layer_norm] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/Dropout[dropout] <=> self.l_47
        # T5ForConditionalGeneration/Linear[lm_head] <=> self.l_48
        # input4 <=> labels
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> x3
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___5684 <=> x4
        # T5ForConditionalGeneration/T5Stack[decoder]/tuple::__getitem___5686 <=> x5
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> x6
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> x7
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[21]/ModuleList[layer]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> x8
        labels, x0, x1, x2, x3, x4, x5, x6, x7, x8 = unflatten(args, self.input_structure)
        t_0 = self.l_4(x0)
        t_1 = self.l_20(x0)
        t_2 = self.l_21(x0)
        t_3 = self.l_37(x0)
        ...
        t_5 = t_5[slice(None, 2, None)]
        t_5 = t_5[0]
        t_6 = x6.view(t_5, -1, 32, 128)
        t_6 = t_6.transpose(1, 2)
        t_7 = x7.view(t_5, -1, 32, 128)
        t_7 = t_7.transpose(1, 2)
        t_8 = x8.view(t_5, -1, 32, 128)
        t_8 = t_8.transpose(1, 2)
...
unique_stages_on_same_gpu: [{0, 15}, {1, 13}, {2, 14}, {3, 12}, {8, 4}, {10, 5}, {9, 6}, {11, 7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 4, 6, 5, 7, 3, 1, 2, 0],
...
forward {0: 110.38, 1: 98.63, 2: 98.55, 3: 98.48, 4: 98.44, 5: 98.75, 6: 98.79, 7: 92.16}
backward {0: 230.34, 1: 241.96, 2: 244.83, 3: 243.89, 4: 256.2, 5: 244.27, 6: 242.24, 7: 246.98}
...
forward {0: 0.79, 1: 0.78, 2: 0.77, 3: 0.78, 4: 0.78, 5: 0.78, 6: 0.78, 7: 0.79}
backward {0: 0.89, 1: 0.89, 2: 0.91, 3: 0.9, 4: 0.91, 5: 0.9, 6: 0.9, 7: 0.91}

worstcase: bwd: 256.204 fwd: 110.381
Expected speedup for 8 partitions is: 6.895
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'43.92 MB', recieve_time:'3.66 ms', out:'274.09 MB', send time:'22.84 ms'
1: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
2: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.97 MB', send time:'12.75 ms'
3: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
4: input size:'282.48 MB', recieve_time:'23.54 ms', out:'152.12 MB', send time:'12.68 ms'
...
7: input size:'152.12 MB', recieve_time:'12.68 ms', out:'51.45 MB', send time:'4.29 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.79, 1: 0.87, 2: 0.87, 3: 0.87, 4: 0.87, 5: 0.87, 6: 0.87, 7: 0.95} 
backward {0: 0.98, 1: 0.95, 2: 0.95, 3: 0.95, 4: 0.91, 5: 0.95, 6: 0.95, 7: 0.95}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 314.22,
                      ...
                      7: 322.17,
                      'worstcase': 322.17},
 'pipeline_vs_seq_no_comm': 5.86,
 'pipeline_with_non_parallel_comm': {0: 340.72,
                                     1: 340.6,
                                     2: 343.38,
                                     3: 342.36,
                                     4: 354.65,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.153
Analysis max cuda memory used 4.15GB
"""