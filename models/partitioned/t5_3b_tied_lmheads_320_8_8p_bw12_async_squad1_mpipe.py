"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 320 --answer_max_seq_length 8 --ct t5_3b_bb_trace --save_memory_mode --preset ftpipe --partitioning_method mpipe --dont_use_async_meta_alg --basic_blocks T5Block
"""
import math
...
# partition 0 {'inputs': {'input_ids', 'decoder_input_ids', 'attention_mask'}, 'outputs': {1, 2, 3, 4, 5, 6, 7, 8}}
...
# partition 7 {'inputs': {0, 'attention_mask', 6}, 'outputs': {8, 9, 10, 11, 12, 13, 14, 15}}
# partition 8 {'inputs': {0, 'decoder_attention_mask', 7, 'inverted_encoder_attention_mask'}, 'outputs': {9, 10, 11, 12, 13, 14, 15}}
# partition 9 {'inputs': {8, 'decoder_attention_mask', 7, 'inverted_encoder_attention_mask'}, 'outputs': {10}}
# partition 10 {'inputs': {'decoder_attention_mask', 7, 8, 9, 'inverted_encoder_attention_mask'}, 'outputs': {11}}
# partition 11 {'inputs': {'decoder_attention_mask', 7, 8, 10, 'inverted_encoder_attention_mask'}, 'outputs': {12}}
# partition 12 {'inputs': {'decoder_attention_mask', 7, 8, 11, 'inverted_encoder_attention_mask'}, 'outputs': {13}}
# partition 13 {'inputs': {'decoder_attention_mask', 7, 8, 'inverted_encoder_attention_mask', 12}, 'outputs': {14}}
# partition 14 {'inputs': {'decoder_attention_mask', 7, 8, 'inverted_encoder_attention_mask', 13}, 'outputs': {15}}
# partition 15 {'inputs': {'decoder_attention_mask', 7, 8, 'inverted_encoder_attention_mask', 14, 'lm_labels'}, 'outputs': {'output'}}
# model outputs {15}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,T5Block,Dropout,CrossEntropyLoss,T5LayerNorm,StatelessEmbedding),
        'model_inputs': {
            'attention_mask': {
...
unique_stages_on_same_gpu: [{0, 8}, {1, 11}, {9, 2}, {3, 12}, {10, 4}, {13, 5}, {6, 14}, {15, 7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 0, 2, 4, 1, 3, 5, 6, 7],
...
forward {0: 61.94, 1: 58.29, 2: 58.42, 3: 57.32, 4: 57.82, 5: 58.37, 6: 57.74, 7: 53.98}
backward {0: 147.3, 1: 146.02, 2: 146.15, 3: 145.97, 4: 145.73, 5: 146.37, 6: 146.56, 7: 143.08}
...
forward {0: 0.91, 1: 0.85, 2: 0.85, 3: 0.84, 4: 0.84, 5: 0.85, 6: 0.84, 7: 0.86}
backward {0: 1.0, 1: 0.95, 2: 0.95, 3: 0.95, 4: 0.95, 5: 0.95, 6: 0.96, 7: 0.93}

worstcase: bwd: 147.296 fwd: 61.941
Expected speedup for 8 partitions is: 7.414
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'5.24 MB', recieve_time:'0.44 ms', out:'64.39 MB', send time:'5.37 ms'
1: input size:'64.39 MB', recieve_time:'5.37 ms', out:'64.39 MB', send time:'5.37 ms'
2: input size:'64.39 MB', recieve_time:'5.37 ms', out:'64.39 MB', send time:'5.37 ms'
3: input size:'64.39 MB', recieve_time:'5.37 ms', out:'64.39 MB', send time:'5.37 ms'
4: input size:'64.39 MB', recieve_time:'5.37 ms', out:'64.39 MB', send time:'5.37 ms'
5: input size:'64.39 MB', recieve_time:'5.37 ms', out:'64.39 MB', send time:'5.37 ms'
6: input size:'64.39 MB', recieve_time:'5.37 ms', out:'64.39 MB', send time:'5.37 ms'
7: input size:'64.39 MB', recieve_time:'5.37 ms', out:'5.24 MB', send time:'0.44 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.91, 1: 0.91, 2: 0.91, 3: 0.91, 4: 0.91, 5: 0.91, 6: 0.91, 7: 0.99} 
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 203.43,
                      ...
                      7: 191.26,
                      'worstcase': 203.43},
 'pipeline_vs_seq_no_comm': 5.73,
 'pipeline_with_non_parallel_comm': {0: 209.24,
                                     1: 204.31,
                                     2: 204.57,
                                     3: 203.29,
                                     4: 203.55,
                                     ...
                                     7: 197.06,
                                     'worstcase': 209.24},
 'seq_no_comm_no_recomp': {0: 121.85,
                           1: 116.87,
                           2: 116.63,
                           3: 116.89,
                           4: 116.63,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.573
Analysis max cuda memory used 2.57GB
"""