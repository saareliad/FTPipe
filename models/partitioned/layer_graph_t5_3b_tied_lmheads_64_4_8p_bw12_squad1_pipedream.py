            ...
            5: {
                ...
                'outputs': {
                    'T5ForConditionalGeneration/T5Stack[encoder]/Tensor::__mul___19_6': {
                        ...
                        'is_batched': True,
                        'used_by': [6]},
                    'T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___364': {
                        'shape': torch.Size([64, 64, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
                        'used_by': [6]},
                    'T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___366': {
                        'shape': torch.Size([64, 32, 64, 64]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
...
class Partition5(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/Tensor::__mul___19 <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___319 <=> x1
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___321 <=> x2
        x0, x1, x2 = unflatten(args, self.input_structure)
        t_0 = self.l_0(x1, attention_mask=x0, position_bias=x2, encoder_hidden_states=None, encoder_attention_mask=None, encoder_decoder_position_bias=None, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, use_cache=False, output_attentions=False)
        t_1 = t_0[slice(None, 2, None)]
        t_1 = t_1[0]
...
class Partition6(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:6'):
        ...
        self.lookup = {'l_0': 'encoder.block.23',
    ...
    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/ModuleList[block]/T5Block[23] <=> self.l_0
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[4] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/ModuleList[block]/T5Block[5] <=> self.l_10
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___364 <=> x3
        # T5ForConditionalGeneration/T5Stack[encoder]/tuple::__getitem___366 <=> x4
        ...
        t_2 = self.l_5(t_2, attention_mask=t_5, position_bias=None, encoder_attention_mask=t_4, encoder_decoder_position_bias=None, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_3 = t_2[slice(None, 2, None)]
        t_3 = t_3[0]
        t_6 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_6(t_3, attention_mask=t_5, position_bias=t_6, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_6 = t_2[slice(None, 2, None)]
        t_6 = t_6[0]
        t_3 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_7(t_6, attention_mask=t_5, position_bias=t_3, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_3 = t_2[slice(None, 2, None)]
        t_3 = t_3[0]
        t_6 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_8(t_3, attention_mask=t_5, position_bias=t_6, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_6 = t_2[slice(None, 2, None)]
        t_6 = t_6[0]
        t_3 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_9(t_6, attention_mask=t_5, position_bias=t_3, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_3 = t_2[slice(None, 2, None)]
        t_3 = t_3[0]
        t_6 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_10(t_3, attention_mask=t_5, position_bias=t_6, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_6 = t_2[slice(None, 2, None)]
        t_6 = t_6[0]
        t_3 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_11(t_6, attention_mask=t_5, position_bias=t_3, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_3 = t_2[slice(None, 2, None)]
        t_3 = t_3[0]
        t_6 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_12(t_3, attention_mask=t_5, position_bias=t_6, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_6 = t_2[slice(None, 2, None)]
        t_6 = t_6[0]
        t_3 = t_2[2]
        t_2 = t_2[3]
        t_2 = self.l_13(t_6, attention_mask=t_5, position_bias=t_3, encoder_attention_mask=t_4, encoder_decoder_position_bias=t_2, layer_head_mask=None, encoder_layer_head_mask=None, past_key_value=None, output_attentions=False, use_cache=False, encoder_hidden_states=t_1)
        t_3 = t_2[slice(None, 2, None)]
        t_3 = t_3[0]
        t_6 = t_2[2]
        t_2 = t_2[3]
...
5: input size:'50.35 MB', recieve_time:'4.20 ms', out:'50.35 MB', send time:'4.20 ms'
6: input size:'181.83 MB', recieve_time:'15.15 ms', out:'20.07 MB', send time:'1.67 ms'
7: input size:'20.07 MB', recieve_time:'1.67 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.91, 1: 0.97, 2: 0.97, 3: 0.97, 4: 0.97, 5: 0.96, 6: 0.99, 7: 1.0} 
backward {0: 1.0, 1: 0.99, 2: 0.99, 3: 0.99, 4: 0.99, 5: 0.99, 6: 0.96, 7: 0.99}
