"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 512 --answer_max_seq_length 4 --basic_blocks T5Block --save_memory_mode --partitioning_method pipedream --disable_op_profiling
"""
...
# partition 5 {'inputs': {0, 4, 'attention_mask', 'decoder_attention_mask', 'decoder_input_ids', 'inverted_encoder_attention_mask'}, 'outputs': {6, 7}}
# partition 6 {'inputs': {'inverted_encoder_attention_mask', 'decoder_attention_mask', 5}, 'outputs': {7}}
# partition 7 {'inputs': {5, 6, 'decoder_attention_mask', 'lm_labels', 'inverted_encoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,Dropout,CrossEntropyLoss,T5Block,StatelessEmbedding,T5LayerNorm),
        'model_inputs': {
            'attention_mask': {
...
forward {0: 126.72, 1: 111.91, 2: 111.82, 3: 111.95, 4: 111.75, 5: 105.15, 6: 48.19, 7: 44.23}
backward {0: 271.52, 1: 276.27, 2: 276.71, 3: 276.19, 4: 275.86, 5: 301.24, 6: 137.74, 7: 127.95}
...
backward {0: 0.9, 1: 0.88, 2: 0.88, 3: 0.88, 4: 0.88, 5: 0.92, 6: 0.46, 7: 0.42}

worstcase: bwd: 301.236 fwd: 126.716
Expected speedup for 8 partitions is: 5.991
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 375.4,
                      ...
                      'worstcase': 382.75,
                      'worstcase_std': 1.23},
 'pipeline_vs_seq_no_comm': 4.88,
 'pipeline_with_non_parallel_comm': {0: 398.24,
                                     1: 388.18,
                                     2: 388.53,
                                     3: 388.14,
                                     4: 387.61,
                                     ...
                                     7: 172.18,
                                     'worstcase': 406.38},
 'seq_no_comm_no_recomp': {0: 273.96,
                           1: 263.41,
                           2: 264.03,
                           3: 263.15,
                           4: 262.84,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.366
