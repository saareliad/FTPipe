"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --ct trace_cache_t53b_512_4_lg --cp prof_cache_t53b_512_4_lg --precompute_masks --stateless_tied --lmhead --n_partitions 8 --max_seq_length 512 --answer_max_seq_length 4 --partitioning_method pipedream --preset pipedream --disable_op_profiling --dont_use_async_meta_alg --save_memory_mode --special_blocks T5Block --basic_blocks T5Block
"""
...
# partition 5 {'inputs': {0, 4, 'attention_mask', 'inverted_encoder_attention_mask', 'decoder_input_ids', 'decoder_attention_mask'}, 'outputs': {6, 7}}
# partition 6 {'inputs': {'inverted_encoder_attention_mask', 'decoder_attention_mask', 5}, 'outputs': {7}}
# partition 7 {'inputs': {5, 6, 'inverted_encoder_attention_mask', 'lm_labels', 'decoder_attention_mask'}, 'outputs': {'output'}}
# model outputs {7}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (T5Block,Linear,T5LayerNorm,CrossEntropyLoss,Dropout,StatelessEmbedding),
        'model_inputs': {
            'attention_mask': {
...
forward {0: 126.59, 1: 111.44, 2: 111.61, 3: 111.26, 4: 111.75, 5: 105.05, 6: 48.64, 7: 44.36}
backward {0: 271.58, 1: 274.91, 2: 275.47, 3: 275.11, 4: 275.83, 5: 300.64, 6: 137.97, 7: 85.21}
...
forward {0: 0.82, 1: 0.79, 2: 0.79, 3: 0.79, 4: 0.79, 5: 0.82, 6: 0.37, 7: 0.35}
backward {0: 0.9, 1: 0.87, 2: 0.88, 3: 0.88, 4: 0.88, 5: 0.92, 6: 0.46, 7: 0.28}

worstcase: bwd: 300.640 fwd: 126.586
Expected speedup for 8 partitions is: 5.896
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'274.09 MB', send time:'22.84 ms'
...
5: input size:'274.09 MB', recieve_time:'22.84 ms', out:'9.51 MB', send time:'0.79 ms'
6: input size:'9.51 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
7: input size:'9.51 MB', recieve_time:'0.79 ms', out:'0.00 MB', send time:'0.00 ms'
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 375.33,
                      ...
                      'worstcase': 382.06,
                      'worstcase_std': 1.21},
 'pipeline_vs_seq_no_comm': 4.9,
 'pipeline_with_non_parallel_comm': {0: 398.17,
                                     1: 386.35,
                                     2: 387.09,
                                     3: 386.37,
                                     4: 387.58,
                                     ...
                                     7: 129.57,
                                     'worstcase': 405.69},
 'seq_no_comm_no_recomp': {0: 273.77,
                           1: 263.44,
                           2: 263.55,
                           3: 263.52,
                           4: 263.49,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.378
